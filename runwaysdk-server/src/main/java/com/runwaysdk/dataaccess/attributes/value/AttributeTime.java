...
public class AttributeTime extends AttributeMoment
{
   ...
   *
   */
  private static final long serialVersionUID = 5543800914597495716L;
   ...
   */
  protected AttributeTime(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
   ...
   */
  public MdAttributeTimeDAOIF getMdAttribute()
  {
    return (MdAttributeTimeDAOIF)this.mdAttributeIF;
  }
