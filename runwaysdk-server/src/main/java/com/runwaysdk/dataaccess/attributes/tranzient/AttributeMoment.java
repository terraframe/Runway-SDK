...
public abstract class AttributeMoment extends Attribute
{
   ...
   * 
   */
  private static final long serialVersionUID = -2751462847148545326L;
   ...
   */
  protected AttributeMoment(String name, String mdAttributeKey, String definingTransientType)
  {
   ...
   */
  protected AttributeMoment(String name, String mdAttributeKey, String definingTransientType, String value)
  {
   ...
   * 
   * @return MdAttributeMomentDAOIF that defines the this attribute
   */
  public MdAttributeMomentDAOIF getMdAttributeConcrete()
  {
    return (MdAttributeMomentDAOIF)super.getMdAttributeConcrete();
  }
