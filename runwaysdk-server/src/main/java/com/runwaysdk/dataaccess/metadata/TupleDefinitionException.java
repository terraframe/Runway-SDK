...
public class TupleDefinitionException extends InvalidDefinitionException
{
  ...
  /**
   *  The TypeTuple containing the invalid definition 
   */
  protected TypeTupleDAOIF typeTuple;
   ...
   */
  public TupleDefinitionException(String devMessage, TypeTupleDAOIF typeTuple)
  {
    super(devMessage);
   ...
   *          Metadata containing the invalid definition.
   */
  public TupleDefinitionException(String devMessage, Throwable cause, TypeTupleDAOIF typeTuple)
  {
   ...
   *          Metadata containing the invalid definition.
   */
  public TupleDefinitionException(Throwable cause, TypeTupleDAOIF typeTuple)
  {
    super(cause);
    this.typeTuple = typeTuple;
  }
