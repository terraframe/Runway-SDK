...
public class ValueQueryDTOToBasicJSON extends ComponentQueryDTOToBasicJSON
{
  ...
  protected ValueQueryDTOToBasicJSON(ValueQueryDTO queryDTO, boolean typeSafe)
  {
    super(queryDTO);
  }
  ...
  protected void addResultSet() throws JSONException
  {
    ...
    {
      ValueObjectDTOToBasicJSON valueObjectDTOToJSON = new ValueObjectDTOToBasicJSON(valueObjectDTO);
