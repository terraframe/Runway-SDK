...
public class DocToInformationDTO extends DocToMessageDTO
{

  public DocToInformationDTO(ClientRequestIF clientRequest, Element rootElement)
  {
  ...
  /**
   * Instantiates the proper InformationDTO class (not type safe)
   * @param type
   * @param attributeMap
   * @param newInstance
   * @param readable
   * @param writable
   * @param modified
   * @return proper InformationDTO class (not type safe)
   */
  @Override
  protected InformationDTO factoryMethod(String type, Map<String, AttributeDTO> attributeMap,
      boolean newInstance, boolean readable, boolean writable, boolean modified)
  {
    try
    {
      ...
      return ComponentDTOFacade.buildInformationDTO(this.clientRequest, type, attributeMap,
