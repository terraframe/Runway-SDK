...
public class AttributePolygon extends AttributeGeometry implements AttributePolygonIF
{
   ...
   * @param polygon the polygon of the attribute
   ...
   */
  protected AttributePolygon(String name, Polygon polygon, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
