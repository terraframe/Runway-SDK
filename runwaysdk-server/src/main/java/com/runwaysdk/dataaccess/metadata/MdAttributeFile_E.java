...
public class MdAttributeFile_E extends MdAttributeConcrete_E
{
  /**
   * 
   */
  private static final long serialVersionUID = 6701480506422911569L;

  /**
   * @param mdAttribute
   */
  public MdAttributeFile_E(MdAttributeConcreteDAO mdAttribute)
  {
    super(mdAttribute);
  } 
