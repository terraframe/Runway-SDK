...
public class DoubleCondition extends BasicCondition
{
  private Double value;
  
  public DoubleCondition(DoubleConditionMd fMd)
  {
    super(fMd);
  }
  
  @Override
  public DoubleConditionMd getConditionMd()
  {
    return (DoubleConditionMd) super.getConditionMd();
  }
