...
public abstract class MdGraphClassHandler extends TagHandler implements TagHandlerIF, HandlerFactoryIF
{
  public MdGraphClassHandler(ImportManager manager)
  {
    super(manager);
  }
   ...
   * @return
   */
  protected MdGraphClassDAO getMdEntityDAO(TagContext context)
  {
    return (MdGraphClassDAO) context.getObject(MdTypeInfo.CLASS);
  }
