...
@com.runwaysdk.business.ClassSignature(hash = 103840118)
public abstract class MdWebNumberDTOBase extends com.runwaysdk.system.metadata.MdWebPrimitiveDTO
{
  public final static String CLASS = "com.runwaysdk.system.metadata.MdWebNumber";
  private static final long serialVersionUID = 103840118;
  
  protected MdWebNumberDTOBase(com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
    super(clientRequest);
  }
  ...
  */
  protected MdWebNumberDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  {
    return (com.runwaysdk.system.metadata.MdWebNumberQueryDTO) clientRequest.getAllInstances(com.runwaysdk.system.metadata.MdWebNumberDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
