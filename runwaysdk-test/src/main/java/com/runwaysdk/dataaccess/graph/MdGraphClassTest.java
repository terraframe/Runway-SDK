...
public class MdGraphClassTest
{
  ...
  public void testCreateMdVertex()
  {
    ...
    // Heads up: clean up
    // AttributeEnumerationIF attrEnum =
    // (AttributeEnumerationIF)mdVertexDAO.definesAttribute(ComponentInfo.OID).getAttributeIF((MdAttributeCharacterInfo.INDEX_TYPE));
    //
