...
public class MdAttributeTextDAO extends MdAttributePrimitiveDAO implements MdAttributeTextDAOIF
{
  ...
  protected static int maxLength = 65535;
  ...
  /**
   * Returns the maximum number of characters an attribute of type MdAttributeText can have.
   * @return maximum number of characters an attribute of type MdAttributeText can have.
   */
  ...
  /**
   * Returns a new {@link MdAttributeTextDAO}.
