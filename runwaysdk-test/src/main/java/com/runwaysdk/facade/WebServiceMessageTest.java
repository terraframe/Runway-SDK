...
public class WebServiceMessageTest extends MessageTest
{
  public static void main(String[] args)
  {
    junit.textui.TestRunner.run(WebServiceMessageTest.suite());
  }

  public static Test suite()
  {
    TestSuiteTF suite = new TestSuiteTF();
    suite.addTestSuite(WebServiceMessageTest.class);
