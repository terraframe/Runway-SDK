...
public class XMLTermExporter
{
  ...
  /**
   *  Exports all children of the given parent term to Runway's XML metadata syntax. If includeParent is set to true it will also export the parent node.
   * 
   * @param term
   */
...
//    try {
//      for (Term t : descends) {
//        OIterator<? extends Relationship> parentRels = t.getParentRelationships(rel);
//        try {
