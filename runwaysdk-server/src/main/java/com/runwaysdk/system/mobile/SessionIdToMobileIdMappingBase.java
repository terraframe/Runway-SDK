...
@com.runwaysdk.business.ClassSignature(hash = -1988000942)
/**
 ...
 */
public abstract class SessionIdToMobileIdMappingBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  public final static String CLASS = "com.runwaysdk.system.mobile.SessionIdToMobileIdMapping";
  ...
  private static final long serialVersionUID = -1988000942;
  ...
  public static SessionIdToMobileIdMappingQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    SessionIdToMobileIdMappingQuery query = new SessionIdToMobileIdMappingQuery(new com.runwaysdk.query.QueryFactory());
