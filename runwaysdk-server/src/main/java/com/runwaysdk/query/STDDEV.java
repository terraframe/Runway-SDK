...
public class STDDEV extends AggregateFunction implements SelectableDouble
{
  /**
   *
   * @param selectable Attribute that is a parameter to the function.
   */
  protected STDDEV(EntityQuery entityQuery)
  {
   ...
   */
  protected STDDEV(EntityQuery entityQuery, String userDefinedAlias, String userDefinedDisplayLabel)
  {
   ...
   * @param selectable
   */
  protected STDDEV(Selectable selectable)
  {
   ...
   * @param userDefinedDisplayLabel
   */
  protected STDDEV(Selectable selectable, String userDefinedAlias, String userDefinedDisplayLabel)
  {
  ...
  {
    return Database.stdDevFunction();
  }
}
