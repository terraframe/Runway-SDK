 ...
 * License along with Runway SDK(tm).  If not, see <http://www.gnu.org/licenses/>.
 ******************************************************************************/
public class AttributeTextParseException extends AttributeParseException
{
   ...
   * @param invalidValue
   */
  public AttributeTextParseException(String devMessage, String attributeDisplayLabel, String invalidValue)
  {
    super(devMessage, attributeDisplayLabel, invalidValue);
  }

  /**
   * Constructs a new <code>AttributeTextParseException</code> with the specified detail message and
   * cause.
   * <p>
   ...
   * @param invalidValue
   */
  public AttributeTextParseException(String devMessage, Throwable cause, String attributeDisplayLabel, String invalidValue)
  {
    super(devMessage, cause, attributeDisplayLabel, invalidValue);
  }

  /**
   * Constructs a new <code>AttributeTextParseException</code> with the specified cause and a
   ...
   * @param invalidValue
   */
  public AttributeTextParseException(Throwable cause, String attributeDisplayLabel, String invalidValue)
  {
  ...
  { 
    return CommonExceptionMessageLocalizer.textParseException(this.getLocale(), this.getAttributeDisplayLabel(), this.getInvalidValue());
  }
