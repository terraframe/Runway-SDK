...
public class AttributeFloat extends AttributeNumber
{
   ...
   *
   */
  private static final long serialVersionUID = -108658755855539284L;
   ...
   */
  protected AttributeFloat(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
