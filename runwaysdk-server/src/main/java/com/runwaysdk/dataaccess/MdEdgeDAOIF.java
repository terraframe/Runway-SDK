...
public interface MdEdgeDAOIF extends MdGraphClassDAOIF
{
  ...
  /**
   * Returns the {@link MdEdgeDAOIF} that is the root of the hierarchy that this type belongs to.
   * returns a reference to itself if it is the root.
   *
   * @return {@link MdEdgeDAOIF} that is the root of the hierarchy that this type belongs to.
   * returns a reference to itself if it is the root.
   */
  public abstract MdEdgeDAOIF getRootMdClassDAO();
  
  /**
   * Returns an array of {@link MdEdgeDAOIF} that defines immediate subclasses of this class.
   * @return an array of {@link MdEdgeDAOIF} that defines immediate subclasses of this class.
   */
  public List<? extends MdEdgeDAOIF> getSubClasses();
  
  /**
   * Returns a list of {@link MdEdgeDAOIF} objects that are subclasses of the given
   * entity. Only non abstract entities are returned (i.e. entities that can be
   * instantiated)
   * 
   * @return list of {@link MdEdgeDAOIF} objects that are subclasses of the given entity.
  ...
  /**
   * Returns a list of {@link MdEdgeDAOIF} objects that represent entities 
   * that are subclasses of the given entity, including all recursive entities.
   *
   * @return list of {@link MdEdgeDAOIF} objects that represent entities 
   * that are subclasses of the given entity, including all recursive entities.
   */
  public List<? extends MdEdgeDAOIF> getAllSubClasses();
  
  /**
   * Returns an {@link MdEdgeDAOIF} representing the super class of this class, or null if
   * it does not have one.
   * 
   * @return an {@link MdEdgeDAOIF} representing the super class of this class, or null if
   * it does not have one.
   */
  public MdEdgeDAOIF getSuperClass();
  
  /**
   * Returns a list of {@link MdEdgeDAOIF} instances representing every
   * parent of this {@link MdEdgeDAOIF} partaking in an inheritance relationship.
   * 
   * @return a list of {@link MdEdgeDAOIF} instances that are parents of this class.
   */
