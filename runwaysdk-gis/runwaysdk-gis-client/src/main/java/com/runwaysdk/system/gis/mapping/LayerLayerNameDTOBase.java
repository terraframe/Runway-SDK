...
@com.runwaysdk.business.ClassSignature(hash = -125151569)
public abstract class LayerLayerNameDTOBase extends com.runwaysdk.business.LocalStructDTO
{
  public final static String CLASS = "com.runwaysdk.system.gis.mapping.LayerLayerName";
  private static final long serialVersionUID = -125151569;
  
  protected LayerLayerNameDTOBase(com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
    super(clientRequest);
  }
  ...
  */
  protected LayerLayerNameDTOBase(com.runwaysdk.business.LocalStructDTO structDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  {
    return (com.runwaysdk.system.gis.mapping.LayerLayerNameQueryDTO) clientRequest.getAllInstances(com.runwaysdk.system.gis.mapping.LayerLayerNameDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
