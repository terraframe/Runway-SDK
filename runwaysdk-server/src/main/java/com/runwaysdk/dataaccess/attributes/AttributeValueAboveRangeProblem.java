 ...
 * @author William Rose
 */
public class AttributeValueAboveRangeProblem extends AttributeValueProblem
{
   ...
   */
  public AttributeValueAboveRangeProblem(String componentId, MdClassDAOIF mdClassIF, MdAttributeDAOIF mdAttributeIF, String developerMessage, AttributeIF attribute, String value, String limit)
  {
  ...
  {
    return ServerExceptionMessageLocalizer.attributeValueAboveRangeException(this.getLocale(), this.attribute, this.getValue(), this.getLimit());
  }
}
