...
public class GrantAttributeStatePermissionException extends PermissionException
{
  /**
   *
   */
  private static final long serialVersionUID = -980691780643373225L;
  ...
  {
    return ServerExceptionMessageLocalizer.grantAttributeStatePermissionException(this.getLocale(), this.getMdClass(), this.mdAttributeIF, this.stateMasterIF);
  }
}
