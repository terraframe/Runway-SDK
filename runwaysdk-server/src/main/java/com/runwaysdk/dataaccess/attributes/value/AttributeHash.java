...
public class AttributeHash extends AttributeEncryption implements AttributeHashIF
{
   ...
   *
   */
  private static final long serialVersionUID = -2644213202123777612L;
   ...
   */
  protected AttributeHash(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
  ...
  {
    return (MdAttributeHashDAOIF)this.mdAttributeIF;
  }
