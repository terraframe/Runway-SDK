...
public class SubSelectFunctionConditionLtEq extends SubSelectFunctionCondition
{
  /**
   ...
   */
  public SubSelectFunctionConditionLtEq(Selectable attributeLeft, SelectableAggregate selectableAggregate)
  {
   ...
   */
  public SubSelectFunctionConditionLtEq(Selectable attributeLeft, SelectableAggregate selectableAggregate, boolean ignoreCase)
  {
