...
public class UtilDTOBaseGenerator extends SessionDTOBaseGenerator
{

  /**
   * @param mdEntity
   */
  public UtilDTOBaseGenerator(MdUtilDAOIF mdUtilIF)
  {
    super(mdUtilIF);  
  }
  ...
  private void writeGet()
  {
    ...
    getWriter().writeLine(UtilDTOInfo.CLASS + " dto = ("+UtilDTOInfo.CLASS+")clientRequest.get(oid);");
    getWriter().writeLine("");    
