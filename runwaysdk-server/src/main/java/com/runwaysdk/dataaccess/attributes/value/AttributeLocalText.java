...
public class AttributeLocalText extends AttributeLocal implements AttributeLocalTextIF
{
   ...
   *
   */
  private static final long serialVersionUID = 6619352766948293172L;
   ...
   */
  protected AttributeLocalText(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
