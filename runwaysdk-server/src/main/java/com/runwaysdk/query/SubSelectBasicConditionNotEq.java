...
public class SubSelectBasicConditionNotEq extends SubSelectBasicCondition
{  

  public SubSelectBasicConditionNotEq(Selectable attribute1, Selectable attribute2)
  {
    super(attribute1, attribute2);
  }
  
  public SubSelectBasicConditionNotEq(Selectable attribute1, Selectable attribute2, boolean ignoreCase)
  {
  ...
  {
    // This is not a type.  This comparison is wrapped in a NOT IN clause to attain the desired effect.
    return "=";
  }
