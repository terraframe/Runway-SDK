...
public class WebCharacter extends WebPrimitive
{
  public WebCharacter(WebCharacterMd fMd)
  {
    super(fMd);
  }
  
  @Override
  public WebCharacterMd getFieldMd()
  {
    return (WebCharacterMd) super.getFieldMd();
  }
