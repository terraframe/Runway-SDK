...
public class PostgresAllPathsStrategy extends PostgresAllPathsStrategyBase
{
  ...
  /* (non-Javadoc)
   * @see com.runwaysdk.business.ontology.OntologyStrategyIF#copyTerm(com.runwaysdk.business.ontology.Term, com.runwaysdk.business.ontology.Term, java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.runwaysdk.business.ontology.OntologyStrategyIF#isLeaf(com.runwaysdk.business.ontology.Term, java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.runwaysdk.business.ontology.OntologyStrategyIF#getAllAncestors(com.runwaysdk.business.ontology.Term, java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.runwaysdk.business.ontology.OntologyStrategyIF#getAllDescendants(com.runwaysdk.business.ontology.Term, java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.runwaysdk.business.ontology.OntologyStrategyIF#getDirectAncestors(com.runwaysdk.business.ontology.Term, java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.runwaysdk.business.ontology.OntologyStrategyIF#getDirectDescendants(com.runwaysdk.business.ontology.Term, java.lang.String)
   */
  @Override
...
//
//    String[] metadataColumns = new String[] { id, siteMaster, key, type, domain, lastUpdateDate, sequence, createdBy, lockedBy, createDate, owner, lastUpdatedBy, parentTerm, parentType, childTerm, childType };
//
...
//    sql += "  SELECT " + RelationshipDAOIF.CHILD_ID_COLUMN + " AS " + originalChild + ", " + RelationshipDAOIF.PARENT_ID_COLUMN + NL;
...
//    sql += "  INNER JOIN " + view + " ON (l." + RelationshipDAOIF.CHILD_ID_COLUMN + " = " + view + "." + RelationshipDAOIF.PARENT_ID_COLUMN + ")" + NL;
//    sql += ")" + NL;
//
...
//    sql += "(SELECT " + originalChild + ", " + RelationshipInfo.PARENT_ID + " FROM " + view + " UNION SELECT " + id + "," + id + " FROM " + domainTable + " ) AS paths" + NL;
//
//    sql += "WHERE p." + id + " = paths." + RelationshipInfo.PARENT_ID + " AND c." + id + " = paths." + originalChild + ";" + NL;
//
...
//    // String type = getColumn(termAllPaths, MetadataInfo.TYPE);
//    // String domain = getColumn(termAllPaths, MetadataInfo.DOMAIN);
//    // String lastUpdateDate = getColumn(termAllPaths,
//    // MetadataInfo.LAST_UPDATE_DATE);
//    // String sequence = getColumn(termAllPaths, MetadataInfo.SEQUENCE);
//    // String lockedBy = getColumn(termAllPaths, MetadataInfo.LOCKED_BY);
//    // String createDate = getColumn(termAllPaths, MetadataInfo.CREATE_DATE);
//    // String owner = getColumn(termAllPaths, MetadataInfo.OWNER);
//    // String lastUpdatedBy = getColumn(termAllPaths,
//    // MetadataInfo.LAST_UPDATED_BY);
//    // String parentTerm = getColumn(termAllPaths,
//    // this.provider.getAllPathsParentTerm());
//    // String parentType = getColumn(termAllPaths,
//    // this.provider.getAllPathsParentType());
//    // String childTerm = getColumn(termAllPaths,
//    // this.provider.getAllPathsChildTerm());
//    // String childType = getColumn(termAllPaths,
//    // this.provider.getAllPathsChildType());
//    //
//    // // non-term values
//    // Timestamp transactionDate = new Timestamp(new Date().getTime());
//    //
//    // String[] metadataColumns = new String[] { id, siteMaster, key, type,
//    // domain, lastUpdateDate,
//    // sequence, createdBy, lockedBy, createDate, owner, lastUpdatedBy,
//    // parentTerm, parentType,
//    // childTerm, childType };
//    //
//    // String insertColumns = StringUtils.join(metadataColumns, "," + NL);
//    // sql += "INSERT INTO " + allpathsTable + " (" + insertColumns + ") " + NL;
...
//    //
//    // String sql = "DELETE FROM " + table + " WHERE " + getColumn(allpaths,
//    // childTerm) + " = ?";
//    //
...
//    //
//    // AttributeReference childTerm =
//    // pathsQ.aReference(this.provider.getAllPathsChildTerm());
//    // AttributeReference parentTerm =
//    // pathsQ.aReference(this.provider.getAllPathsParentTerm());
//    //
...
//    //
//    // BusinessQuery b =
//    // f.businessQuery(this.provider.getTermDomain().definesType());
//    // RelationshipQuery r =
//    // f.relationshipQuery(this.provider.getTermRelationship().definesType());
//    //
