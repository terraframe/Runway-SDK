...
//    query.ORDER_BY_ASC(query.getLocaleLabel());
  ...
  /**
   * Localizes the given key to the user's current locale. If the key cannot be localized null is returned.
   * 
  ...
  /**
   * Localizes the given key to the given locale. If the key cannot be localized null is returned.
   */
  ...
  /**
   * Returns all localized keys for the user's current locale. Returns null if the keys cannot be fetched.
   * 
  ...
  /**
   * Returns all localized keys for the given locale. Returns null if the keys cannot be fetched.
   * 
   * @param locale
   * @return
   */
   ...
   * @param defautValue
   *          The error message in English, which will be used if the key cannot be localized.
   * @param params
  ...
  public static String getMessage(Locale locale, String key, String defaultValue, String... params)
  {
    ...
    String template = localizer.localize(key, locale);
