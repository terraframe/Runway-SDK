...
@com.runwaysdk.business.ClassSignature(hash = -267388629)
public abstract class JobDTOBase extends com.runwaysdk.business.BusinessDTO
{
  ...
  private static final long serialVersionUID = -267388629;
  ...
  */
  protected JobDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  public com.runwaysdk.system.scheduler.JobDisplayLabelDTO getDisplayLabel()
  {
    return (com.runwaysdk.system.scheduler.JobDisplayLabelDTO) this.getAttributeStructDTO(DISPLAYLABEL).getStructDTO();
  }
  ...
  public final void cancel()
  {
    ...
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwaysdk.system.scheduler.JobDTO.CLASS, "cancel", _declaredTypes);
  ...
  public final void pause()
  {
    String[] _declaredTypes = new String[]{};
    Object[] _parameters = new Object[]{};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwaysdk.system.scheduler.JobDTO.CLASS, "pause", _declaredTypes);
    getRequest().invokeMethod(_metadata, this, _parameters);
  }
  ...
  public final void resume()
  {
    String[] _declaredTypes = new String[]{};
    Object[] _parameters = new Object[]{};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwaysdk.system.scheduler.JobDTO.CLASS, "resume", _declaredTypes);
    getRequest().invokeMethod(_metadata, this, _parameters);
  }
  ...
  public final void start()
  {
    String[] _declaredTypes = new String[]{};
    Object[] _parameters = new Object[]{};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwaysdk.system.scheduler.JobDTO.CLASS, "start", _declaredTypes);
    getRequest().invokeMethod(_metadata, this, _parameters);
  }
  ...
  public static com.runwaysdk.system.scheduler.JobDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
    com.runwaysdk.business.EntityDTO dto = (com.runwaysdk.business.EntityDTO)clientRequest.get(id);
    
    return (com.runwaysdk.system.scheduler.JobDTO) dto;
  }
  ...
  public static com.runwaysdk.system.scheduler.JobQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (com.runwaysdk.system.scheduler.JobQueryDTO) clientRequest.getAllInstances(com.runwaysdk.system.scheduler.JobDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static com.runwaysdk.system.scheduler.JobDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwaysdk.system.scheduler.JobDTO.CLASS, "lock", _declaredTypes);
    return (com.runwaysdk.system.scheduler.JobDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static com.runwaysdk.system.scheduler.JobDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwaysdk.system.scheduler.JobDTO.CLASS, "unlock", _declaredTypes);
    return (com.runwaysdk.system.scheduler.JobDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
