...
public class AttributeBooleanParseException extends AttributeParseException
{
   ...
   * 
   */
  private static final long serialVersionUID = 2741964908863409780L;

  /**
   * Constructs a new <code>AttributeBooleanParseException</code> with the specified developer message
   ...
   * @param invalidValue
   */
  public AttributeBooleanParseException(String devMessage, String attributeDisplayLabel, String invalidValue)
  {
    super(devMessage, attributeDisplayLabel, invalidValue);
  }

  /**
   * Constructs a new <code>AttributeBooleanParseException</code> with the specified detail message and
   * cause.
   * <p>
   ...
   * @param invalidValue
   */
  public AttributeBooleanParseException(String devMessage, Throwable cause, String attributeDisplayLabel, String invalidValue)
  {
    super(devMessage, cause, attributeDisplayLabel, invalidValue);
  }

  /**
   * Constructs a new <code>AttributeBooleanParseException</code> with the specified cause and a
  ...
  { 
    return CommonExceptionMessageLocalizer.booleanParseException(this.getLocale(), this.getAttributeDisplayLabel(), this.getInvalidValue());
  }
}
