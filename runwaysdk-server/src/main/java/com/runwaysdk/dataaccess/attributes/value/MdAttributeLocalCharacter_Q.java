...
public class MdAttributeLocalCharacter_Q extends MdAttributeLocal_Q implements MdAttributeLocalCharacterDAOIF
{

  /**
   * 
   */
  private static final long serialVersionUID = 1829283775463835436L;
   ...
   */
  public MdAttributeLocalCharacter_Q(MdAttributeStructDAOIF mdAttributeIF)
  {
    super(mdAttributeIF);
  }
