...
import com.runwaysdk.query.sql.MdAttributeDate_SQL;

public class SelectableSQLDate extends SelectableSQLMoment
{

  protected SelectableSQLDate(boolean isAggregate, ValueQuery rootQuery, String attributeName, String sql)
  {
    super(isAggregate, rootQuery, attributeName, sql);
    this.init(attributeName, null);
  }

  protected SelectableSQLDate(boolean isAggregate, ValueQuery rootQuery, String attributeName, String sql, String userDefinedAlias, String userDefinedDisplayLabel)
  {
  ...
  private void init(String attributeName, String userDefinedDisplayLabel)
  {
    ...
    this.mdAttributeConcrete_SQL = new MdAttributeDate_SQL(attributeName, displayLabel);
  }
  ...
  /**
   * Validates and formats the given string into a date format for the current
   * database.
   *
   * @param statement
   * @return
