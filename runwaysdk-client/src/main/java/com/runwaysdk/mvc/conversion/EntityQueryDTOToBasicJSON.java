...
public abstract class EntityQueryDTOToBasicJSON extends ClassQueryDTOToBasicJSON
{
  protected EntityQueryDTOToBasicJSON(EntityQueryDTO queryDTO, JsonConfiguration configuration)
  {
