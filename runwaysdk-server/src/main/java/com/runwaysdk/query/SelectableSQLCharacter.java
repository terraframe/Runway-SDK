...
public class SelectableSQLCharacter extends SelectableSQLChar
{
  protected SelectableSQLCharacter(boolean isAggregate, ValueQuery rootQuery, String attributeName, String sql)
  {
    super(isAggregate, rootQuery, attributeName, sql);
    this.init(attributeName, null);
  }

  protected SelectableSQLCharacter(boolean isAggregate, ValueQuery rootQuery, String attributeName, String sql, String userDefinedAlias, String userDefinedDisplayLabel)
  {
  ...
  {
    String formattedValue = Database.formatJavaToSQL(statement, MdAttributeCharacterInfo.CLASS, false);
