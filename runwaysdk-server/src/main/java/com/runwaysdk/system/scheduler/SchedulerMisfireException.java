 ...
 * @author rrowlands
 */
public class SchedulerMisfireException extends RunwayException
{
  private static final long serialVersionUID = 5666276123316988247L;

  public SchedulerMisfireException()
  {
    super("");
  }
  
  /**
   * Constructs a new SchedulerMisfireException with the specified developer message and a default
   ...
   */
  public SchedulerMisfireException(String devMessage)
  {
    super(devMessage);
  }

  /**
   * Constructs a new SchedulerMisfireException with the specified detail message and cause.
   * <p>
   * Note that the detail message associated with <code>cause</code> is <i>not</i>
   * automatically incorporated in this SchedulerMisfireException detail message.
   * 
   * @param devMessage
   *          The non-localized developer error message. Contains specific data access
   *          layer information useful for application debugging. The developer message is
   ...
   */
  public SchedulerMisfireException(String devMessage, Throwable cause)
  {
    super(devMessage, cause);
  }

  /**
   * Constructs a new SchedulerMisfireException with the specified cause and a developer message
   * taken from the cause. This constructor is useful if the SchedulerMisfireException is a wrapper
   ...
   *          is nonexistent or unknown.)
   */
  public SchedulerMisfireException(Throwable cause)
  {
    super(cause);
  }
