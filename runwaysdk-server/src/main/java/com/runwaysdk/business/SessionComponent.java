...
public abstract class SessionComponent implements Transient, Ownable, Serializable
{
   ...
   * {@link Transient#setTransientDAO(TransientDAO)} to correclty initialize the entity.
   */
  SessionComponent()
  {
   ...
   * parameter.
   *
   * @param type The type of the DAO that this Session object will represent
   */
  ...
  /**
   * Instantiates a Business using reflection to invoke the empty constructor in the
  ...
  /**
   * Sets the owner of the SessionComponent to the given actor.  This is used
   * to assign permissions to view instances on an individual basis.
   * @param owner
   */
  ...
  /**
   * Returns a BusinessDAO representing the attribute metadata of the attribute with
   *  the given name.
   *
   ...
   * @return BusinessDAO representing the attribute metadata of the attribute with
   *  the given name
   */
  ...
  /**
   *Returns a LinkedList of BusinessDAOs representing metadata for each attribute
  ...
  {
    this.transientDAO.deleteAllItems(name);
  }
  ...
  /**
   * Object is applied (put into a ready state) but is not persisted to the user's session.
   */
  ...
  /**
   * Returns the SessionComponent object with the given id, if it has been persisted to the
   * user's session.
   * @param id
