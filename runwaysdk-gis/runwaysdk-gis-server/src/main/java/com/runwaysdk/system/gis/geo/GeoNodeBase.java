...
@com.runwaysdk.business.ClassSignature(hash = -127053261)
/**
 ...
 */
public abstract class GeoNodeBase extends com.runwaysdk.business.Business
{
  ...
  private static final long serialVersionUID = -127053261;
  ...
  public com.runwaysdk.system.metadata.MdAttributeReference getGeoEntityAttribute()
  {
    if (getValue(GEOENTITYATTRIBUTE).trim().equals(""))
    {
      return null;
    }
    else
    {
      return com.runwaysdk.system.metadata.MdAttributeReference.get(getValue(GEOENTITYATTRIBUTE));
    }
  }
  ...
  public void validateGeoEntityAttribute()
  {
    this.validateAttribute(GEOENTITYATTRIBUTE);
  }
  
  public static com.runwaysdk.dataaccess.MdAttributeReferenceDAOIF getGeoEntityAttributeMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(com.runwaysdk.system.gis.geo.GeoNode.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeReferenceDAOIF)mdClassIF.definesAttribute(GEOENTITYATTRIBUTE);
  }
  
  public void setGeoEntityAttribute(com.runwaysdk.system.metadata.MdAttributeReference value)
  {
    if(value == null)
    {
