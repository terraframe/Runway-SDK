 ...
 ******************************************************************************/
public class AttributeMultiReference extends AttributeRef implements SelectableMultiReference, HasAttributeFactory
{
  private static Map<String, AttributeMultiReference.PluginIF> pluginMap = new ConcurrentHashMap<String, AttributeMultiReference.PluginIF>();

  public static void registerPlugin(AttributeMultiReference.PluginIF pluginFactory)
  {
    pluginMap.put(pluginFactory.getModuleIdentifier(), pluginFactory);
  }

  protected String mdMultiReferenceTableName;

  protected AttributeMultiReference(MdAttributeMultiReferenceDAOIF mdAttributeIF, String attributeNameSpace, String definingTableName, String definingTableAlias, String mdMultiReferenceTableName, MdBusinessDAOIF referenceMdBusinessIF, String referenceTableAlias, ComponentQuery rootQuery, Set<Join> tableJoinSet, String userDefinedAlias, String userDefinedDisplayLabel)
  {
    this(mdAttributeIF, attributeNameSpace, definingTableName, definingTableAlias, mdMultiReferenceTableName, referenceMdBusinessIF, referenceTableAlias, rootQuery, tableJoinSet, userDefinedAlias, userDefinedDisplayLabel, null);
  }
  ...
  {
    super(mdAttributeIF, attributeNameSpace, definingTableName, definingTableAlias, referenceMdBusinessIF, referenceTableAlias, rootQuery, tableJoinSet, userDefinedAlias, userDefinedDisplayLabel, mdAttributeStructIF);

    this.mdMultiReferenceTableName = mdMultiReferenceTableName;
  }
  ...
  public AttributeMultiReference aMultiReference(String name, String userDefinedAlias, String userDefinedDisplayLabel)
  {
    ...
    return (AttributeMultiReference) this.internalAttributeFactory(name, mdAttributeIF, definingMdEntity, userDefinedAlias, userDefinedDisplayLabel);
  }
  ...
  private Attribute internalAttributeFactory(String name, MdAttributeConcreteDAOIF mdAttributeIF, MdEntityDAOIF definingMdEntity, String userDefinedAlias, String userDefinedDisplayLabel)
  {
    ...
    else if (mdAttributeIF instanceof MdAttributeMultiReferenceDAOIF)
    {
      ...
      String mdMultiReferenceTableName = mdAttributeMultiReferenceIF.getTableName();

      MdBusinessDAOIF referencedMdBusinessIF = mdAttributeMultiReferenceIF.getReferenceMdBusinessDAO();
      String masterListTalbeAlias = this.rootQuery.getTableAlias(this.attributeNamespace, referencedMdBusinessIF.getTableName());

      attribute = this.multiReferenceFactory(mdAttributeMultiReferenceIF, refAttributeNameSpace, parameterTableName, parameterTableAlias, mdMultiReferenceTableName, referencedMdBusinessIF, masterListTalbeAlias, this.rootQuery, this.tableJoinSet, userDefinedAlias, userDefinedDisplayLabel);
    }
    ...
    if (attribute == null)
    {
      for (AttributeMultiReference.PluginIF plugin : pluginMap.values())
      {
  ...
  public Condition containsAny(String... enumIds)
  {
    ...
    {
      String formattedValue = Database.formatJavaToSQL(enumIds[i], MdAttributeMultiReferenceInfo.CLASS, false);
  ...
  {
    return new MultiReferenceNotContainsAny(this.subFactory(this.attributeNamespace), new MultiReferenceSubSelectNotContainsAny(this.columnName, this.definingTableAlias, this.mdMultiReferenceTableName, enumIds));
  }
  ...
  /**
   * Constructs the appropriate AttributeMultiReference_Sub object, depending if
   * this attribute is a part of the stub or not.
   * 
   * @param attributeNameSpace
   * @param userDefinedAlias
   * @return appropriate AttributeMultiReference_Sub object, depending if this
   *         attribute is a part of the stub or not.
   */
  private AttributeMultiReference_Sub subFactory(String attributeNameSpace)
  {
  ...
  class MultiReferenceNotContainsAny extends AttributeCondition
  {
    ...
    public MultiReferenceNotContainsAny(AttributeMultiReference_Sub attributeLeft, MultiReferenceSubSelectNotContainsAny statement)
    {
      super(attributeLeft);
    ...
    {
      return ( (AttributeMultiReference_Sub) this.selectableLeft ).getSQL2() + " NOT IN \n" + statement.getSQL();
    }
  ...
  class MultiReferenceSubSelectNotContainsAny extends Condition
  {
    ...
    public MultiReferenceSubSelectNotContainsAny(String columnName, String definingTableAlias, String mdMultiReferenceTableName, String... enumIds)
    {
  ...
  class MultiReferenceCountSubSelect extends Condition
  {
    ...
    public MultiReferenceCountSubSelect(String columnName, String definingTableAlias, String mdMultiReferenceTableName)
    {
      this.columnName = columnName;
      this.definingTableAlias = definingTableAlias;
      this.mdMultiReferenceTableName = mdMultiReferenceTableName;
    ...
    public String getSQL()
    {
      return "(SELECT COUNT(*) FROM " + this.mdMultiReferenceTableName + " WHERE " + MdEnumerationDAOIF.SET_ID_COLUMN + " = " + this.definingTableAlias + "." + this.columnName + ")";
    }
  ...
  class AttributeMultiReference_Sub extends Attribute
  {
    ...
    private String mdMultiReferenceTableAlias;

    private Join   enumMappingTableJoin;

    protected AttributeMultiReference_Sub(MdAttributeMultiReferenceDAOIF mdAttributeIF, String attributeNameSpace, String definingTableName, String definingTableAlias, String mdMultiReferenceTableName, String mdMultiReferenceTableAlias, ComponentQuery rootQuery, Set<Join> tableJoinSet)
    {
      super(mdAttributeIF, attributeNameSpace, definingTableName, definingTableAlias, rootQuery, tableJoinSet, null, null);

      this.mdMultiReferenceTableName = mdMultiReferenceTableName;
      this.mdMultiReferenceTableAlias = mdMultiReferenceTableAlias;

      this.enumMappingTableJoin = new InnerJoinEq(this.columnName, this.definingTableName, this.definingTableAlias, MdEnumerationDAOIF.SET_ID_COLUMN, this.mdMultiReferenceTableName, this.mdMultiReferenceTableAlias);
    ...
    public String getSQL()
    {
      return this.mdMultiReferenceTableAlias + "." + MdEnumerationInfo.ITEM_ID;
    }
