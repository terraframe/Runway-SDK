...
public class DocToUtilDTO extends DocToSessionComponentDTO
{
   ...
   */
  public DocToUtilDTO(ClientRequestIF clientRequest, Element rootElement)
  {
  ...
  /**
   * Instantiates the proper utilDTO class (not type safe)
   * @param type
   * @param attributeMap
   * @param newInstance
   * @param readable
   * @param writable
   * @param modified
   * @return proper utilDTO class (not type safe)
   */
  protected UtilDTO factoryMethod(String type, Map<String, AttributeDTO> attributeMap,
      boolean newInstance, boolean readable, boolean writable, boolean modified)
  {
    try
    {
      ...
      return ComponentDTOFacade.buildUtilDTO(this.clientRequest, type, attributeMap,
