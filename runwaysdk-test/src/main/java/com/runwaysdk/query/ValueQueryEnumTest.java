...
public class ValueQueryEnumTest extends TestCase
{
  @Override
  ...
  {
    junit.textui.TestRunner.run(new QueryMasterSetup(ValueQueryEnumTest.suite(), QueryMasterSetup.parentQueryInfo.getType(), QueryMasterSetup.parentRefQueryInfo.getType()));
  }

  public static Test suite()
  {
    TestSuite suite = new TestSuite();
    suite.addTestSuite(ValueQueryEnumTest.class);
