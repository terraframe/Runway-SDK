...
public class AttributeText extends AttributeChar
{
   ...
   *
   */
  private static final long serialVersionUID = 4993824410469801871L;
   ...
   */
  protected AttributeText(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
    super(name, value, definingEntityType, mdAttributeIF, entityMdAttributeIFset);
  }

  /**
   * Returns the {@link MdAttributeTextDAOIF} that defines the this attribute.
   *
   * <br>
   ...
   */
  public MdAttributeTextDAOIF getMdAttribute()
  {
    return (MdAttributeTextDAOIF)super.getMdAttribute();
  }
}
