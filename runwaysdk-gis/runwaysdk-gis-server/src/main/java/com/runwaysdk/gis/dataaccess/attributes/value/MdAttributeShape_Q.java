...
public class MdAttributeShape_Q extends MdAttributeGeometry_Q implements MdAttributeShapeDAOIF
{
  /**
   *
   */
   ...
   */
  public MdAttributeShape_Q(MdAttributeShapeDAOIF mdAttributeConcreteIF)
  {
