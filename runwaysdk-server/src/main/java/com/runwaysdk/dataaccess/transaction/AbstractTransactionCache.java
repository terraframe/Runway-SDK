...
public abstract class AbstractTransactionCache implements TransactionCacheIF
{
  ...
  /**
   *Contains all {@link EntityDAO}s that were added or modified during a transaction where
   * the key is the type plus the keyname of the entity.  The value is the id of the {@link EntityDAO}
   ...
   * <br/><b>invariant</b> updatedEntityNameCacheStrategyMap != null
   */
...
//  protected List<TransactionItemEntityDAOAction> updatedEntityTransactionItemList_UpdateCaches;
  ...
  /**
   * Contains a reference to all {@link MdClass} objects that were modified during this transaction.
   * The key is the name of the class.  Used to allow sets of classes to be defined within a
   * transaction. The value is the id of the {@link MdClass}.
   * <br/><b>invariant</b> updatedMdClassDefinedTypeMap != null
   */
  protected Map<String, String> updatedMdClassDefinedTypeMap;
  /**
   * Contains a reference to all {@link MdClass}. objects that were modified during this transaction.
   * The key is the root id of the class. The value is the id of the {@link MdClass}.
   *
   * <br/><b>invariant</b> updatedMdClassRootIdMap != null
   */
  protected Map<String, String> updatedMdClassRootIdMap;
  /**
   *Contains a reference to all {@link RoleDAOIF} that were modified during this transaction.
   * The key is the name of the role.  The value is the id of the {@link RoleDAOIF}.
   * Used to allow sets of roles to be defined and assigned to users and actors within a transaction.
   * <br/><b>invariant</b> updatedRoleIFMap != null
   */
  protected Map<String, String> updatedRoleIFMap;
  /**
   *Contains a reference to all {@link MdFacadeDAO} objects that were modified during this transaction.
   * The key is the name of the class.  Used to allow sets of classes to be defined within a
   * transaction.  The value is the id of the {@link MdFacadeDAO}.
   ...
   * Value: Id of {@link StateMasterDAO}
   ...
   * Key: State Master type
   * Value: Id of {@link TransitionDAO}
   * <br/><b>invariant</b> updatedTransitionMap != null
   */
  protected Map<String, Set<String>> updatedTransitionMap;
  /**
   *Contains a reference to all {@link MdAttributeDAO} objects that were created during this transaction.
   ...
   *
   * <br/><b>invariant</b> newMdAttributeSet_CodeGeneration != null
   */
  protected Set<String> newMdAttributeSet_CodeGeneration;
  /**
   * Contains a reference to {@link MdAttributeDAO} objects that were added during this transaction.
   * The key is the key of the object.  The value is the id of the{@link MdAttributeDAO} object.
   */
  protected Map<String, String> addedMdAttrubiteKeyMap;
  /**
   *Contains a reference to all {@link MdAttributeDAOIF} objects that were deleted during this transaction.
   * The value is the id of the {@link MdAttributeDAOIF} 
   * Used to determine MdEntities (the defining entity)
   * that need to have Java classes generated or regenerated.
   *
   * <br/><b>invariant</b> deletedMdAttributeSet_CodeGeneration != null
   */
  protected Set<String> deletedMdAttributeSet_CodeGeneration;
  /**
   *Contains a reference to all {@link MdRelationshipDAO} objects that were created during this transaction.
   * The key is the id of the {@link MdRelationshipDAO} object.  Used to determine MdBusiness (parent or child class)
   * that need to have Java classes generated or regenerated.
   *
   * <br/><b>invariant</b> newMdRelationshipSet_CodeGeneration != null
   */
  protected Set<String> newMdRelationshipSet_CodeGeneration;
  /**
   *Contains a reference to all {@link MdRelationshipDAOIF}  objects that were deleted during this transaction.
   * The key is the id of the {@link MdRelationshipDAOIF} object.  Used to determine MdBusiness (parent or child class)
   * that need to have Java classes generated or regenerated.
   *
   * <br/><b>invariant</b> deletedMdRelationshipSet_CodeGeneration != null
   */
  protected Set<String> deletedMdRelationshipSet_CodeGeneration;
  /**
   *Contains a reference to all {@link EnumerationAttributeItem} objects that were
   * created during this transaction. The key is the id of the {@link EnumerationAttributeItem} object. Used to
   * determine MdEnumeration objects that need to have Java classes generated or regenerated.
   *
   * <br/><b>invariant</b> newEnumerationAttributeItemSet_CodeGeneration != null
   */
  protected Set<String> newEnumerationAttributeItemSet_CodeGeneration;
  /**
   *Contains a reference to all {@link EnumerationAttributeItem} objects that were
   * deleted during this transaction. The key is the id of the {@link EnumerationAttributeItem} object.  Used to
   * determine {@link MdEnumerationDAO} objects that need to have Java classes generated or regenerated.
   *
   * <br/><b>invariant</b> deletedEnumerationAttributeItemSet_CodeGeneration != null
   */
  protected Set<String> deletedEnumerationAttributeItemSet_CodeGeneration;
  /**
   *Contains a reference to all {@link MdMethodDAO} objects that were
   * created, updated, or deleted during this transaction. The key is the id of the object.  Used to
   * determine {@link MdEntityDAO} or {@link MdFacadeDAO} objects that need to have Java classes generated or regenerated.
   *
   * <br/><b>invariant</b> updatedMdMethod_CodeGeneration != null
   */
  protected Set<String> updatedMdMethod_CodeGeneration;
  /**
   *Contains a reference to all {@link MdActionDAO} objects that were
   * created, updated, or deleted during this transaction. The key is the id of the object.  Used to
   * determine {@link MdControllerDAO} objects that need to have Java classes generated or regenerated.
   *
  ...
  /**
   *Contains a reference to all {@link MdType} objects that were created during this transaction.
   * The key is the id of the object.  Used to determine {@link MdType}  objects that need to have Java classes
   * generated.
   *
   * <br/><b>invariant</b> updatedMdTypeSet_CodeGeneration != null
   */
  protected Set<String> updatedMdTypeSet_CodeGeneration;
  /**
   *Contains a reference to all {@link MdType} objects that were deleted during this transaction.
   * The key is the type defined by the {@link MdType} object.  Used to determine {@link MdType}  objects that need to have Java classes
  ...
  /**
   *Contains a reference to all {@link EnumerationItemDAO} objects that were modified during this transaction.
   * The key is the id of the object.  Used to determine {@link MdEnumerationDAO}s that need to be regenerated,
   * as their corresponding Java enumerations contain the values as strings within the class definition.
   *
   * <br/><b>invariant</b> updatedEnumerationItemSet_CodeGeneration != null
   */
  protected Set<String> updatedEnumerationItemSet_CodeGeneration;
  /**
   *Contains a reference to all {@link MdEnumerationDAOIF} objects that were created or deleted during this transaction.
   * The key is the id of the object.  The value is the id of the {@link MdEnumerationDAOIF} object.
   * Used to determine the enumeration master list classes that need to be regenerated.
   *
   * <br/><b>invariant</b> updatedEnumerationItemMap != null
   */
  protected Map<String, String> updatedMdEnumerationMap_CodeGeneration;
  /**
   *Contains a reference to all {@link MdEnumerationDAO} objects that were modified during this transaction.
   * The key is the name of the enumeration type.  The value is the id of the {@link MdEnumerationDAO}object. 
   * Used to allow sets of classes to be defined within a transaction.
   * <br/><b>invariant</b> updatedMdEnumerationMap != null
   */
  protected Map<String, String> updatedMdEnumerationMap;
  /**
   *Contains a reference to all {@link MdIndexDAO} objects that were modified during this transaction.
   * The key is the name of the index.  The value is the id of the {@link MdIndexDAO} object.
   * Used to allow sets of classes to be defined within a transaction.
   * <br/><b>invariant</b> updatedMdIndexMap != null
   */
  protected Map<String, String> updatedMdIndexMap;
  /**
   *Contains a reference to all {@link MdAttributeConcreteDAO} objects that were modified during this transaction.
   * The key is the name of the index.  The value is the id of the {@link MdAttributeConcreteDAO} object.
   * Used to allow sets of classes to be defined within a transaction.
   * <br/><b>invariant</b> indexNameMap != null
   */
  protected Map<String, String> indexNameMap;
  /**
   * Map of {@link MdFacadeDAOIF} to deploy.
   * Key: defined type 
   * Value: id of {@link MdFacadeDAOIF}
   */
  protected Map<String, String> webServiceMdFacadeMapDeploy;
  /**
   * Map of {@link MdFacadeDAOIF} to undeploy.
   * Key: defined type 
   * Value: id of {@link MdFacadeDAOIF}
   */
  ...
  /**
   * Contains instances of {@link RelationshipCacheAllStrategy} to record relationships that
   * have been added during this transaction.  {@link RelationshipCacheAllStrategy} keeps track
  ...
  /**
   * Contains instances of {@link RelationshipCacheAllStrategy} to record relationships that
   * have been removed during this transaction.  {@link RelationshipCacheAllStrategy} keeps track
...
//    this.updatedEntityTransactionItemList_UpdateCaches = new LinkedList<TransactionItemEntityDAOAction>();
    ...
    this.addedMdAttrubiteKeyMap = new HashMap<String, String>();
...
//      this.updatedEntityDAOIdMap.put(entityDAO.getId(), transactionCacheItem);
  ...
  /**
   * @see com.runwaysdk.dataaccess.transaction.TransactionCacheIF#deleteEntityDAOCollection(java.lang.String, com.runwaysdk.dataaccess.cache.CacheStrategy)
   */
  public void deleteEntityDAOCollection(String type, CacheStrategy entityDAOCollection)
  {
    ...
    try
    {
      TransactionItemStrategyAction transactionCacheItem =
        new TransactionItemStrategyAction(ActionEnumDAO.DELETE, entityDAOCollection);
...
//        relationshipCollection.updateCacheInTransactionCache(relationshipDAO);
  ...
  /**
   * @see com.runwaysdk.dataaccess.transaction.TransactionCacheIF#hasAddedChildren(java.lang.String, java.lang.String)
   */
...
//      }
  ...
  /**
   * @see com.runwaysdk.dataaccess.transaction.TransactionCacheIF#hasRemovedChildren(java.lang.String, java.lang.String)
   */
...
//      }
  ...
  /**
   * @see com.runwaysdk.dataaccess.transaction.TransactionCacheIF#hasAddedParents(java.lang.String, java.lang.String)
   */
...
//      }
  ...
  /**
   * @see com.runwaysdk.dataaccess.transaction.TransactionCacheIF#hasRemovedParents(java.lang.String, java.lang.String)
   */
...
//      }
  ...
  public MdAttributeDAOIF getAddedMdAttribute(String mdAttributeKey)
  {
    ...
    try
    {
      return (MdAttributeDAOIF)this.internalGetEntityDAO(this.addedMdAttrubiteKeyMap.get(mdAttributeKey));
    }
    finally
    {
      this.transactionStateLock.unlock();
  ...
  public Map<String, MdAttributeDAO> getAddedMdAttributes()
  {
    ...
    try
    {
      ...
      for (String mdAttributeDAOkey : this.addedMdAttrubiteKeyMap.keySet())
      {
        String mdAttributeDAOid = this.addedMdAttrubiteKeyMap.get(mdAttributeDAOkey);
        
        mdAttributeDAOmap.put(mdAttributeDAOkey, (MdAttributeDAO)this.internalGetEntityDAO(mdAttributeDAOid));
      }
...
//  }
  ...
  /**
   * Used internally by this hierarchy.  It differers from the public method
   * in that it will check the global cache for objects not in the transaction cache.
   * 
   * @param id
   * @return Null if the id is null.
   * @throws {@link DataNotFoundException} if id != null and the object does not exist
   * in the transaction cache or the ObjectCache.
   */
...
//  }
  ...
  /**
   * @see com.runwaysdk.dataaccess.transaction.TransactionCacheIF#getEntityDAO(java.lang.String, java.lang.String)
   */
    ...
    try
    {
      ...
      else
      {
        ...
        if ((mdAttribute.hasAttribute(MdAttributeConcreteInfo.SETTER_VISIBILITY) &&
            ...
            mdAttribute.getAttribute(MdAttributeConcreteInfo.NAME).isModified())
        {
          this.deletedMdAttributeSet_CodeGeneration.add(mdAttribute.getId());
          this.storeTransactionEntityDAO(mdAttribute);
...
//      this.updatedEntityDAOIdMap.put(entityDAO.getId(), transactionCacheItem);
  ...
  /**
   * @see com.runwaysdk.dataaccess.transaction.TransactionCacheIF#updateEntityDAOCollection(java.lang.String, com.runwaysdk.dataaccess.cache.CacheStrategy)
   */
  public void updateEntityDAOCollection(String type, CacheStrategy entityDAOCollectoin)
  {
    ...
    {
      TransactionItemStrategyAction transactionCacheItem =
        new TransactionItemStrategyAction(ActionEnumDAO.UPDATE, entityDAOCollectoin);
  ...
  protected void addMdTypeToMapForGen(MdTypeDAOIF mdTypeDAOIF, Map<String, MdTypeDAOIF> mdTypeMap)
  {
    ...
    {
      // Some types are generated as a result of the modification of other types.  These types
      // need to have their sequence number incremented, need to be logged, and need to be updated
      // in the cache.
...
//        this.updatedEntityDAOIdMap.put(mdTypeDAOIF.getId(), transactionCacheItem);
      ...
      {
        // Make sure we add the one to the list that is from the transaction cache, as this object was fetched
        // from in the control flow of the TransactionManagement around advice and it may not be this
  ...
  /**
   * Adds the updated item to the list that records updated entities that are then updated in the global cache.
   *
