...
public class AttributeTime extends AttributeMoment
{
   ...
   * @param definingEntityType Name of the entity that defines this attribute.
   */
  ...
  public static String formatSQLToJavaTime(String value)
  {
    ...
    // Some databases (like Oracle) will store the full date and time.  Consequently, the
    // database will return the full date and time.  We need to strip off the date and
    // only store the time.
    if (returnValue != null &&
  ...
  public static boolean isValid(String value)
  {
    ...
    if( !value.trim().equals("") &&
        (!timePattern.matcher(value).matches() ||
        !AttributeMoment.checkTimeBounds(value)))
    {
      return false;
    }
    return true;
