...
public abstract class AttributeChar extends AttributePrimitive implements SelectableChar
{

  protected AttributeChar(MdAttributePrimitiveDAOIF mdAttributeIF, String attributeNamespace,
