...
public abstract class MdMethodDTOBase extends com.runwaysdk.system.metadata.MetadataDTO
{
  ...
  */
  ...
  {
    return (java.util.List<? extends com.runwaysdk.system.MethodActorDTO>) getRequest().getChildren(this.getId(), com.runwaysdk.system.metadata.MdMethodMethodActorDTO.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public static java.util.List<? extends com.runwaysdk.system.MethodActorDTO> getAllMethodActor(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String id)
  {
    return (java.util.List<? extends com.runwaysdk.system.MethodActorDTO>) clientRequestIF.getChildren(id, com.runwaysdk.system.metadata.MdMethodMethodActorDTO.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public java.util.List<? extends com.runwaysdk.system.metadata.MdMethodMethodActorDTO> getAllMethodActorRelationships()
  {
    return (java.util.List<? extends com.runwaysdk.system.metadata.MdMethodMethodActorDTO>) getRequest().getChildRelationships(this.getId(), com.runwaysdk.system.metadata.MdMethodMethodActorDTO.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public static java.util.List<? extends com.runwaysdk.system.metadata.MdMethodMethodActorDTO> getAllMethodActorRelationships(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String id)
  {
    return (java.util.List<? extends com.runwaysdk.system.metadata.MdMethodMethodActorDTO>) clientRequestIF.getChildRelationships(id, com.runwaysdk.system.metadata.MdMethodMethodActorDTO.CLASS);
  }
  
  public com.runwaysdk.system.metadata.MdMethodMethodActorDTO addMethodActor(com.runwaysdk.system.MethodActorDTO child)
  {
    return (com.runwaysdk.system.metadata.MdMethodMethodActorDTO) getRequest().addChild(this.getId(), child.getId(), com.runwaysdk.system.metadata.MdMethodMethodActorDTO.CLASS);
  }
  
  public static com.runwaysdk.system.metadata.MdMethodMethodActorDTO addMethodActor(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String id, com.runwaysdk.system.MethodActorDTO child)
  {
    return (com.runwaysdk.system.metadata.MdMethodMethodActorDTO) clientRequestIF.addChild(id, child.getId(), com.runwaysdk.system.metadata.MdMethodMethodActorDTO.CLASS);
  }
  ...
  {
    getRequest().deleteChildren(this.getId(), com.runwaysdk.system.metadata.MdMethodMethodActorDTO.CLASS);
  }
  
  public static void removeAllMethodActor(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String id)
  {
    clientRequestIF.deleteChildren(id, com.runwaysdk.system.metadata.MdMethodMethodActorDTO.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public java.util.List<? extends com.runwaysdk.system.metadata.MdTypeDTO> getAllMdType()
  {
    return (java.util.List<? extends com.runwaysdk.system.metadata.MdTypeDTO>) getRequest().getParents(this.getId(), com.runwaysdk.system.metadata.TypeMethodDTO.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public static java.util.List<? extends com.runwaysdk.system.metadata.MdTypeDTO> getAllMdType(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String id)
  {
    return (java.util.List<? extends com.runwaysdk.system.metadata.MdTypeDTO>) clientRequestIF.getParents(id, com.runwaysdk.system.metadata.TypeMethodDTO.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public java.util.List<? extends com.runwaysdk.system.metadata.TypeMethodDTO> getAllMdTypeRelationships()
  {
    return (java.util.List<? extends com.runwaysdk.system.metadata.TypeMethodDTO>) getRequest().getParentRelationships(this.getId(), com.runwaysdk.system.metadata.TypeMethodDTO.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public static java.util.List<? extends com.runwaysdk.system.metadata.TypeMethodDTO> getAllMdTypeRelationships(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String id)
  {
    return (java.util.List<? extends com.runwaysdk.system.metadata.TypeMethodDTO>) clientRequestIF.getParentRelationships(id, com.runwaysdk.system.metadata.TypeMethodDTO.CLASS);
  }
  
  public com.runwaysdk.system.metadata.TypeMethodDTO addMdType(com.runwaysdk.system.metadata.MdTypeDTO parent)
  {
    return (com.runwaysdk.system.metadata.TypeMethodDTO) getRequest().addParent(parent.getId(), this.getId(), com.runwaysdk.system.metadata.TypeMethodDTO.CLASS);
  }
  
  public static com.runwaysdk.system.metadata.TypeMethodDTO addMdType(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String id, com.runwaysdk.system.metadata.MdTypeDTO parent)
  {
    return (com.runwaysdk.system.metadata.TypeMethodDTO) clientRequestIF.addParent(parent.getId(), id, com.runwaysdk.system.metadata.TypeMethodDTO.CLASS);
  }
  ...
  {
    getRequest().deleteParents(this.getId(), com.runwaysdk.system.metadata.TypeMethodDTO.CLASS);
  }
  
  public static void removeAllMdType(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String id)
  {
    clientRequestIF.deleteParents(id, com.runwaysdk.system.metadata.TypeMethodDTO.CLASS);
  }
  
  public static com.runwaysdk.system.metadata.MdMethodDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
  ...
  public static com.runwaysdk.system.metadata.MdMethodDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
  ...
  public static com.runwaysdk.system.metadata.MdMethodDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
