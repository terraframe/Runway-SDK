...
@com.runwaysdk.business.ClassSignature(hash = 1742006684)
/**
 ...
 */
public  class BusinessInheritanceQuery extends com.runwaysdk.system.metadata.ClassInheritanceQuery
{

  public BusinessInheritanceQuery(com.runwaysdk.query.QueryFactory componentQueryFactory)
  {
  ...
  public BusinessInheritanceQuery(com.runwaysdk.query.ValueQuery valueQuery)
  {
    super(valueQuery);
    if (this.getComponentQuery() == null)
    {
  ...
  {
    return com.runwaysdk.system.metadata.BusinessInheritance.CLASS;
  }
  /**
   ...
   */
   public com.runwaysdk.query.Condition hasChild(com.runwaysdk.system.metadata.MdBusinessQuery mdBusinessQuery)
   {
     return this.getRelationshipQuery().hasChild(mdBusinessQuery);
   }
  /**
   * Restricts the query to include objects that are children in this relationship.
   * @param mdBusinessQuery
   * @return Condition restricting objects that are children in this relationship.
   */
   public com.runwaysdk.query.Condition doesNotHaveChild(com.runwaysdk.system.metadata.MdBusinessQuery mdBusinessQuery)
   {
     return this.getRelationshipQuery().doesNotHaveChild(mdBusinessQuery);
   }
  /**
   ...
   * on this query object.
   */
  public com.runwaysdk.query.OIterator<? extends BusinessInheritance> getIterator()
  {
    ...
    return new com.runwaysdk.business.RelationshipIterator<BusinessInheritance>(this.getComponentQuery().getMdEntityIF(), this.getRelationshipQuery(), columnInfoMap, results);
  }
