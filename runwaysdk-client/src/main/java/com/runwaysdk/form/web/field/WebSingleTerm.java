...
public class WebSingleTerm extends WebAttribute
{

  public WebSingleTerm(WebSingleTermMd fMd)
  {
    super(fMd);
  }
  ...
  @Override
  public WebSingleTermMd getFieldMd()
  {
    return (WebSingleTermMd) super.getFieldMd();
  }
