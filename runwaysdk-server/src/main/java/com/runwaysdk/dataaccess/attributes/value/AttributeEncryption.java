...
public abstract class AttributeEncryption extends Attribute implements AttributeEncryptionIF
{
   ...
   * 
   */
  private static final long serialVersionUID = 264747364631491644L;
   ...
   */
  protected AttributeEncryption(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
  ...
  {
    return (MdAttributeEncryptionDAOIF)this.mdAttributeIF;
  }
