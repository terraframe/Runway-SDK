...
public class AttributeUUID extends Attribute implements AttributeUUIDIF
{
   ...
   */
  protected AttributeUUID(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
   ...
   */
  public MdAttributeUUIDDAOIF getMdAttribute()
  {
    return (MdAttributeUUIDDAOIF)this.mdAttributeIF;
  }
}
