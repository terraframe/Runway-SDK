...
public class MdAttributeLocalText_Q extends MdAttributeLocal_Q
{

  /**
   * 
   */
  private static final long serialVersionUID = -6726112529437799447L;
   ...
   */
  public MdAttributeLocalText_Q(MdAttributeStructDAOIF mdAttributeIF)
  {
    super(mdAttributeIF);
  }
