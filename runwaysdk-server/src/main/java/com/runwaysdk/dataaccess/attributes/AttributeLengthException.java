...
/**
 * Thrown when an attribute exceeds the amount of space available - too many characters,
 * bytes, etc.
 * 
 * @author Eric Grunzke
 */
public abstract class AttributeLengthException extends AttributeException
{
  /**
   * Generated by Eclipse
   */
  private static final long serialVersionUID = 8061338980771842755L;
   ...
   */
  public AttributeLengthException(String devMessage, AttributeIF attribute, Integer maxLength)
  {
    super(devMessage);
   ...
   *          Maximum allowable length.
   */
  public AttributeLengthException(String devMessage, Throwable cause, AttributeIF attribute, Integer maxLength)
  {
   ...
   *          Maximum allowable length.
   */
  public AttributeLengthException(Throwable cause, AttributeIF attribute, Integer maxLength)
  {
    super(cause);
    this.attribute = attribute;
    this.maxLength = maxLength;
