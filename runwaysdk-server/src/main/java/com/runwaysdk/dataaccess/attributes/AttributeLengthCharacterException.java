...
public class AttributeLengthCharacterException extends AttributeLengthException
{
  /**
   * 
   */
  private static final long serialVersionUID = 6157461568712693545L;
   ...
   */
  public AttributeLengthCharacterException(String devMessage, AttributeIF attribute, Integer maxLength)
  {
   ...
   *          Maximum allowable length.
   */
  public AttributeLengthCharacterException(String devMessage, Throwable cause, AttributeIF attribute, Integer maxLength)
  {
   ...
   *          Maximum allowable length.
   */
  public AttributeLengthCharacterException(Throwable cause, AttributeIF attribute, Integer maxLength)
  {
  ...
  {
    return ServerExceptionMessageLocalizer.attributeLengthCharacterException(this.getLocale(), this.attribute, this.maxLength);
  }
}
