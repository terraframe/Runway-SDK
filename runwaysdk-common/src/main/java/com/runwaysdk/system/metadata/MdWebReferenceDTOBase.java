...
@com.runwaysdk.business.ClassSignature(hash = -165540949)
public abstract class MdWebReferenceDTOBase extends com.runwaysdk.system.metadata.MdWebAttributeDTO
{
  public final static String CLASS = "com.runwaysdk.system.metadata.MdWebReference";
  private static final long serialVersionUID = -165540949;
  
  protected MdWebReferenceDTOBase(com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
    super(clientRequest);
  }
  ...
  */
  protected MdWebReferenceDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  {
    return (com.runwaysdk.system.metadata.MdWebReferenceQueryDTO) clientRequest.getAllInstances(com.runwaysdk.system.metadata.MdWebReferenceDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
