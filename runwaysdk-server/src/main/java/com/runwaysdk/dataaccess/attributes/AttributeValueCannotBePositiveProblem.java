 ...
 * @author William Rose
 */
public class AttributeValueCannotBePositiveProblem extends AttributeValueProblem
{
   ...
   */
  public AttributeValueCannotBePositiveProblem(String componentId, MdClassDAOIF mdClassIF, MdAttributeDAOIF mdAttributeIF, String developerMessage, AttributeIF attribute, String value)
  {
  ...
  {
    return ServerExceptionMessageLocalizer.attributeValueCannotBePositiveException(this.getLocale(), this.getAttribute(), this.getValue());
  }
}
