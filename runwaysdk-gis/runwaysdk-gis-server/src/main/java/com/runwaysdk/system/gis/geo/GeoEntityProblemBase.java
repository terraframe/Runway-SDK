...
@com.runwaysdk.business.ClassSignature(hash = -2085950273)
/**
 ...
 */
public abstract class GeoEntityProblemBase extends com.runwaysdk.business.Business
{
  ...
  private static final long serialVersionUID = -2085950273;
  
  public GeoEntityProblemBase()
  {
    super();
  }
  ...
  public java.util.List<com.runwaysdk.system.gis.geo.GeoEntityProblemType> getProblemType()
  {
    return (java.util.List<com.runwaysdk.system.gis.geo.GeoEntityProblemType>) getEnumValues(PROBLEMTYPE);
  }
  
  public void addProblemType(com.runwaysdk.system.gis.geo.GeoEntityProblemType value)
  {
    if(value != null)
    {
  ...
  public void removeProblemType(com.runwaysdk.system.gis.geo.GeoEntityProblemType value)
  {
    if(value != null)
    {
