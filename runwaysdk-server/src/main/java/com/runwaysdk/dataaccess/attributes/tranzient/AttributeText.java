...
public class AttributeText extends AttributeChar
{
   ...
   */
  protected AttributeText(String name, String mdAttributeKey, String definingTransientType)
  {
   ...
   */
  protected AttributeText(String name, String mdAttributeKey, String definingTransientType, String value)
  {
