...
public class ListTagSupport extends SimpleTagSupport
{
  /**
  ...
  /**
   * List of {@link MutableDTO}s to iterate over.
   */
  protected List<MutableDTO> items;
  ...
  /**
   * Current {@link MutableDTO} being iterated over.
   */
  private MutableDTO         current;
  ...
  public List<MutableDTO> getItems()
  {
    return items;
  }

  public void setItems(List<MutableDTO> items)
  {
    this.items = items;
  }
