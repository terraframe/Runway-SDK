...
public abstract class TransactionRecordDTOBase extends com.runwaysdk.business.BusinessDTO
{
  ...
  */
  protected TransactionRecordDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  public final static java.lang.String EXPORTSEQUENCE = "exportSequence";
  ...
  public boolean isExportSequenceWritable()
  {
    return isWritable(EXPORTSEQUENCE);
  }
  
  public boolean isExportSequenceReadable()
  {
    return isReadable(EXPORTSEQUENCE);
  }
  
  public boolean isExportSequenceModified()
  {
    return isModified(EXPORTSEQUENCE);
  }
  
  public final com.runwaysdk.transport.metadata.AttributeNumberMdDTO getExportSequenceMd()
  {
    return (com.runwaysdk.transport.metadata.AttributeNumberMdDTO) getAttributeDTO(EXPORTSEQUENCE).getAttributeMdDTO();
  }
  ...
  {
    return (com.runwaysdk.system.transaction.TransactionRecordQueryDTO) clientRequest.getAllInstances(com.runwaysdk.system.transaction.TransactionRecordDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
