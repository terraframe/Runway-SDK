...
public abstract class LocalizableStubGenerator extends TransientStubGenerator
{
  public LocalizableStubGenerator(MdLocalizableDAOIF mdLocalizable)
  {
    super(mdLocalizable);
  }
  ...
  protected void addConstructor()
  {
    ...
    getWriter().writeLine("public " + typeName+ "(java.lang.String developerMessage)");
    getWriter().openBracket();
