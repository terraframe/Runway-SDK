...
public class JSONWebServiceAdapterGenerator extends AbstractJSONAdapterGenerator
{

  public JSONWebServiceAdapterGenerator(MdFacadeDAOIF mdFacade)
  {
  ...
  {
    return this.getSerialVersionUID("JSON_WS_ADAPTOR", this.getSignature());
  }
  ...
  {
    return "JSONWebService" + mdFacade.getValue(MdFacadeInfo.NAME) + "Adapter";
  }
