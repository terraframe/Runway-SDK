...
public class InvokeMethodTestBase extends TestCase
{
  ...
  private static String getMethodStub()
  {
    String[] collectionStubSource = { "package " + pack + ";", "public class Collection extends Collection" + TypeGeneratorInfo.BASE_SUFFIX + Reloadable.IMPLEMENTS, "{", "  public Collection()", "  {", "    super();", "  }", "  public static Collection get(String id)", "  {", "    return (Collection) " + Business.class.getName() + ".get(id);", "  }", "  public void testMethod(" + pack + ".Collection collection)", "  {", "     if(collection instanceof " + pack + ".Bag)", "     {",
        ...
        "  public static " + collectionQueryClass + " getCollectionQueryRestrictRows()", "  {", "     " + QueryFactory.class.getName() + " f = new " + QueryFactory.class.getName() + "();", "     " + collectionQueryClass + " query = new " + collectionQueryClass + "(f);", "     ", "     query.restrictRows(10, 1);", "     return query;", "  }", "  public static " + viewQueryClass + " getViewQueryRestrictRows()", "  {",
        "     " + QueryFactory.class.getName() + " f = new " + QueryFactory.class.getName() + "();", "     " + viewQueryClass + " query = new " + viewQueryClass + "(f);", "     ", "     query.restrictRows(10, 1);", "     return query;", "  }", "  public " + pack + ".AllStates[] returnStates(" + pack + ".AllStates[] states)", "  {", "    return states;", "  }", "  public static " + Integer.class.getName() + " getCollectionObjectCount()", "  {",
