...
@com.runwaysdk.business.ClassSignature(hash = -811256529)
/**
...
public abstract class LayerLayerNameBase extends com.runwaysdk.business.LocalStruct
{
  ...
  public LayerLayerNameBase(com.runwaysdk.business.MutableWithStructs component, String structName)
  {
    super(component, structName);
  }
  
  public static LayerLayerName get(String oid)
  {
    return (LayerLayerName) com.runwaysdk.business.Struct.get(oid);
  }
  
  public static LayerLayerName getByKey(String key)
  {
    return (LayerLayerName) com.runwaysdk.business.Struct.get(CLASS, key);
  }
