 ...
 * extend this class, so use OntologyStrategyIF to refer to a generic strategy. If you are trying to create
 * a new strategy (with state) then create a new Runway class that extends this or a sibling (DatabaseAllPathsStrategy).
 */
