...
/**
 * Encapsulates errors that arise from state machines.
 * 
 * @author Eric Grunzke
 */
public abstract class StateException extends BusinessException
{
   ...
   */
  private static final long serialVersionUID = 1119144539300949466L;
   ...
   */
  public StateException(String devMessage)
  {
    super(devMessage);
  }
   ...
   */
  public StateException(String devMessage, Throwable cause)
  {
  ...
  {
    return ServerExceptionMessageLocalizer.stateException(this.getLocale());
  }
}
