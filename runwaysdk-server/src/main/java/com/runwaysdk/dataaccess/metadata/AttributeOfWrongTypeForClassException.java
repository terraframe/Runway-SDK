...
public class AttributeOfWrongTypeForClassException extends AttributeDefinitionException
{
  /**
   * 
   */
  private static final long serialVersionUID = -5669281225017479551L;
   ...
   */
  public AttributeOfWrongTypeForClassException(String devMessage, MdAttributeConcreteDAOIF mdAttribute, MdClassDAOIF mdClassIF)
  {
  ...
  public String getLocalizedMessage()
  {
    ...
    return ServerExceptionMessageLocalizer.attributeOfWrongTypeForClassException(this.getLocale(), this.getMdAttribute(), this.getMdAttribute().getMdClassDAO(), this.mdClassIF);
  }
}
