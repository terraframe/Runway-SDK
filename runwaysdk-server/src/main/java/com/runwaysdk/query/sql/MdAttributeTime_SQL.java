...
public class MdAttributeTime_SQL extends MdAttributeMoment_SQL implements MdAttributeTimeDAOIF
{

  /**
   *
   */
  private static final long serialVersionUID = -643670529867960501L;
   ...
   * @param displayLabel
   */
  public MdAttributeTime_SQL(String attributeName, String displayLabel)
  {
