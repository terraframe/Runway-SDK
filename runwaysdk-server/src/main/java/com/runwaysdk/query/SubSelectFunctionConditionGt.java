...
public class SubSelectFunctionConditionGt extends SubSelectFunctionCondition
{
  /**
   ...
   */
  public SubSelectFunctionConditionGt(Selectable attributeLeft, SelectableAggregate selectableAggregate)
  {
   ...
   */
  public SubSelectFunctionConditionGt(Selectable attributeLeft, SelectableAggregate selectableAggregate, boolean ignoreCase)
  {
