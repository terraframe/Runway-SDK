...
public class AttributeLong extends AttributeNumber
{
   ...
   *
   */
  private static final long serialVersionUID = -6048816215743785469L;
   ...
   */
  protected AttributeLong(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
