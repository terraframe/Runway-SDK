...
public class IndicatorAdapterTest implements DoNotWeave
{
  ...
  public void testIndicatorValueDTO()
  {
    ...
    Assert.assertEquals("The query count should have returned a count of three.", (Double) 3.0, (Double) resultDouble);
  }
