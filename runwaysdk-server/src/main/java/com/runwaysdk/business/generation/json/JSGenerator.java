...
public abstract class JSGenerator
{
  ...
  public static class Writer
  {
    ...
    public void write(String line)
    {
      ...
      builder.append(pad.toString() + line);
    }
  ...
  /**
   * Returns the class name to be used as the name of the javascript class.
   * 
   * @return
   */
  ...
  /**
   * Returns the type prepended with the javascript namespace as specified by
   * JSONProperties.RUNWAY.getLable().
   * 
   * @param type
   * @return
   */
