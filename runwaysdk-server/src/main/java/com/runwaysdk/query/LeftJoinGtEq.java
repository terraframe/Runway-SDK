...
public class LeftJoinGtEq extends LeftJoin
{
  /**
   ...
   */
  protected LeftJoinGtEq(String columnName1, String tableName1, String tableAlias1, String columnName2, String tableName2, String tableAlias2)
  {
   ...
   */
  protected LeftJoinGtEq(Selectable selectable1, Selectable... selectableArray2)
  {
   ...
   * @param selectable2
   */
  protected LeftJoinGtEq(Selectable selectable1, Selectable selectable2)
  {
