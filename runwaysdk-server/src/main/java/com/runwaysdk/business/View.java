...
/**
 * The root class of the presentation model. View is the parent of all generated java classes for the presentation model.
 * 
 * @author Nathan McEachen
 */
public class View extends SessionComponent
{
  ...
  /**
   * Blank constructor can be used for new or existing instances. It is <b>critical</b> that subclasses call {@link View#setTransientDAO(TransientDAO)} to correclty initialize the entity.
   */
  public View()
  {
    super();
