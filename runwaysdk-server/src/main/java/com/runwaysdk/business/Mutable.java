...
{  
  ...
  /**
   * Returns true if the object has an attribute with the
   * given name, false otherwise.  It is case sensitive.
   * 
   * @param name name of the attribute.
   * @return true if the object has an attribute with the
   * given name, false otherwise.  It is case sensitive.
   */
  ...
  /**
   * Returns if an attribute of the Mutable has been modified from 
   ...
   * <code><b>new</b></code> instances of Entity are <i>not</i>
  ...
  /**
   * Deletes this object.  If it is an entity then it is also removed from the database. 
   * Any attempt to {@link Entity#apply()} this entity will throw an exception, so it
