...
public abstract class AttributeChar extends Attribute
{
   ...
   * 
   */
  private static final long serialVersionUID = 5166687779852075735L;
   ...
   */
  protected AttributeChar(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
