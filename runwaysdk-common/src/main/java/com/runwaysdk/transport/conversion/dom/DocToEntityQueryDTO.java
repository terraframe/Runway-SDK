...
public abstract class DocToEntityQueryDTO extends DocToClassQueryDTO
{
   ...
   * @param queryDTO
   */
  public DocToEntityQueryDTO(ClientRequestIF clientRequest, Element rootElement, EntityQueryDTO queryDTO)
  {
    super(clientRequest, rootElement, queryDTO);
  }

  @Override
  public EntityQueryDTO populate()
  {
