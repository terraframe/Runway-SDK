...
@com.runwaysdk.business.ClassSignature(hash = -1195285424)
/**
 ...
 */
public abstract class DownstreamJobRelationshipBase extends com.runwaysdk.business.Relationship
{
  ...
  private static final long serialVersionUID = -1195285424;
  ...
  public com.runwaysdk.system.scheduler.ExecutableJob getChild()
  {
  ...
  {
    return (DownstreamJobRelationship) com.runwaysdk.business.Relationship.get(CLASS, key);
  }
  
  public static com.runwaysdk.query.ValueQuery searchByValueQuery(java.lang.String value)
  {
    String msg = "This method should never be invoked.  It should be overwritten in com.runwaysdk.system.scheduler.DownstreamJobRelationship.java";
