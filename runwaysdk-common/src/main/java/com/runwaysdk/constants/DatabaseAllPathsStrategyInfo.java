 ...
 * License along with Runway SDK(tm).  If not, see <http://www.gnu.org/licenses/>.
 ******************************************************************************/
public interface DatabaseAllPathsStrategyInfo extends OntologyStrategyInfo
{
  /**
   ...
   */
  public static final String CLASS = Constants.ONTOLOGY_PACKAGE+".DatabaseAllPathsStrategy";
}
