...
public class AttributeDateParseException extends AttributeMomentParseException
{  
  /**
   * 
   */
  private static final long serialVersionUID = 3501787737960017107L;
   ...
   */
  public AttributeDateParseException(String devMessage, String attributeDisplayLabel, String invalidValue, String format)
  {
   ...
   * @param format date format string
   */
  public AttributeDateParseException(String devMessage, Throwable cause, String attributeDisplayLabel, String invalidValue, String format)
  {
   ...
   * @param format date format string
   */
  public AttributeDateParseException(Throwable cause, String attributeDisplayLabel, String invalidValue, String format)
  {
  ...
  { 
    return CommonExceptionMessageLocalizer.dateParseException(this.getLocale(), this.getAttributeDisplayLabel(), this.getInvalidValue(), this.getFormat());
  }
}
