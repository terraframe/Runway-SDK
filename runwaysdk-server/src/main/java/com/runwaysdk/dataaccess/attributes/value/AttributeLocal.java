...
public abstract class AttributeLocal extends AttributeStruct implements AttributeLocalIF
{
   ...
   * 
   */
  private static final long serialVersionUID = 8560147135314761977L;
   ...
   */
  protected AttributeLocal(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
