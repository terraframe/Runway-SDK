...
public interface EntityDTOInfo
{
  /**
   ...
   * classes (which do have database counterparts), but EntityDTO.java
   * exists only as part of the bridge between layers.
   */
  public static final String CLASS = Constants.SYSTEM_BUSINESS_PACKAGE+".EntityDTO";
