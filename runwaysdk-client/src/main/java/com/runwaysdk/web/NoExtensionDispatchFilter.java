...
public class NoExtensionDispatchFilter implements Filter
{
  ...
  private static ServletDispatcher dispatcher;
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException,
      ServletException
  {
    // Creating the ServletDispatcher will read the urlmap.xml file. If there's a problem in urlmap.xml we want that exception to be thrown, so keep this out of the try/catch.
    ...
    // This regex matches all urls with no extension. (Test it @ http://regex101.com/)
