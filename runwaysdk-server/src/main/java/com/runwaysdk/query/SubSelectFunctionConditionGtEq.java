...
public class SubSelectFunctionConditionGtEq extends SubSelectFunctionCondition
{
  /**
   ...
   */
  public SubSelectFunctionConditionGtEq(Selectable attributeLeft, SelectableAggregate selectableAggregate)
  {
   ...
   */
  public SubSelectFunctionConditionGtEq(Selectable attributeLeft, SelectableAggregate selectableAggregate, boolean ignoreCase)
  {
