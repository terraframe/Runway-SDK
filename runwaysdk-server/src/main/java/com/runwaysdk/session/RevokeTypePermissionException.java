...
public class RevokeTypePermissionException extends PermissionException
{
   ...
   */
  public RevokeTypePermissionException(String devMessage, MdTypeDAOIF mdTypeIF, UserDAOIF user)
  {
   ...
   *          The user attempting the operation.
   */
  public RevokeTypePermissionException(String devMessage, Throwable cause, MdTypeDAOIF mdTypeIF, UserDAOIF user)
  {
   ...
   *          The user attempting the operation.
   */
  public RevokeTypePermissionException(Throwable cause, MdTypeDAOIF mdTypeIF, UserDAOIF user)
  {
