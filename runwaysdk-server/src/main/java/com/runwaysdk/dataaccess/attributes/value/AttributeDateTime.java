...
public class AttributeDateTime extends AttributeMoment
{
   ...
   *
   */
  private static final long serialVersionUID = 4548650748333642856L;
   ...
   */
  protected AttributeDateTime(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
   ...
   */
  public MdAttributeDateTimeDAOIF getMdAttribute()
  {
    return (MdAttributeDateTimeDAOIF)this.mdAttributeIF;
  }
