...
public class DuplicateStateDefinitionException extends StateException
{
  
  /**
   * 
   */
  private static final long serialVersionUID = -3789208211784074673L;
  ...
  /**
   * Thrown when a state with an identical name already exists for a type.
   ...
   *          Type that has a state machine.
   */
  public DuplicateStateDefinitionException(String devMessage, String newState, String type)
  {
    super(devMessage);
   ...
   *          Type that has a state machine.
   */
  public DuplicateStateDefinitionException(String devMessage, Throwable cause, String newState, String type)
  {
   ...
   *          Type that has a state machine.
   */
  public DuplicateStateDefinitionException(Throwable cause, String newState, String type)
  {
    super(cause);
    this.newState = newState;
    this.type = type;
  ...
  {
    return ServerExceptionMessageLocalizer.duplicateStateDefinitionException(this.getLocale(), this.newState, this.type);
  }
}
