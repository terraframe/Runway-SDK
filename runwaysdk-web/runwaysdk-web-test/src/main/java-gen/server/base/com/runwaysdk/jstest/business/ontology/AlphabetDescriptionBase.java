...
@com.runwaysdk.business.ClassSignature(hash = -625684119)
/**
 ...
 */
public abstract class AlphabetDescriptionBase extends com.runwaysdk.business.LocalStruct implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  public AlphabetDescriptionBase()
  {
    super();
  }
  
  public AlphabetDescriptionBase(com.runwaysdk.business.MutableWithStructs component, String structName)
  {
  ...
  public static AlphabetDescriptionQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    AlphabetDescriptionQuery query = new AlphabetDescriptionQuery(new com.runwaysdk.query.QueryFactory());
