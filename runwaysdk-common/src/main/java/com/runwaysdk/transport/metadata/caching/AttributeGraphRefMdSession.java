...
public class AttributeGraphRefMdSession extends AttributeMdSession
{
  /**
   * The referenced MdVertex.
   */
  private String referenceMdVertexType;

  public AttributeGraphRefMdSession(String referenceMdVertexType)
  {
