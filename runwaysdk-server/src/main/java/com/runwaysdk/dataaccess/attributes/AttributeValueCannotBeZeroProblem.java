 ...
 * @author William Rose
 */
public class AttributeValueCannotBeZeroProblem extends AttributeValueProblem
{
   ...
   */
  public AttributeValueCannotBeZeroProblem(String componentId, MdClassDAOIF mdClassIF, MdAttributeDAOIF mdAttributeIF, String developerMessage, AttributeIF attribute, String value)
  {
  ...
  {
    return ServerExceptionMessageLocalizer.attributeValueCannotBeZeroException(this.getLocale(), this.getAttribute(), this.getValue());
  }
}
