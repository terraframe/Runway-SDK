...
//    if (localName.equals(XMLTags.ENUMERATION_MASTER_TAG) || localName.equals(XMLTags.MD_BUSINESS_TAG) || localName.equals(XMLTags.MD_TERM_TAG))
//    {
//      return new MdBusinessHandler(attributes, reader, prev, manager, localName);
//    }
//    else if (localName.equals(XMLTags.MD_STRUCT_TAG))
//    {
//      return new MdStructHandler(attributes, reader, prev, manager, localName);
//    }
//    else if (localName.equals(XMLTags.MD_LOCAL_STRUCT_TAG))
//    {
//      return new MdLocalStructHandler(attributes, reader, prev, manager, localName);
//    }
//    else if (localName.equals(XMLTags.MD_RELATIONSHIP_TAG) || localName.equals(XMLTags.MD_TREE_TAG) || localName.equals(XMLTags.MD_GRAPH_TAG) || localName.equals(XMLTags.MD_TERM_RELATIONSHIP_TAG))
//    {
//      return new MdRelationshipHandlerWithCaching(attributes, reader, prev, manager, localName);
//    }
//    else if (localName.equals(XMLTags.OBJECT_TAG))
//    {
//      return new ObjectHandler(attributes, reader, prev, manager);
//    }
//    else if (localName.equals(XMLTags.RELATIONSHIP_TAG))
//    {
//      return new RelationshipHandler(attributes, reader, prev, manager);
//    }
//    else if (localName.equals(XMLTags.MD_ENUMERATION_TAG))
//    {
//      return new MdEnumerationHandler(attributes, reader, prev, manager);
//
//    }
//    else if (localName.equals(XMLTags.MD_FACADE_TAG))
//    {
//      return new MdFacadeHandler(attributes, reader, prev, manager);
//    }
//    else if (localName.equals(XMLTags.MD_EXCEPTION_TAG))
//    {
//      return new MdExceptionHandler(attributes, reader, prev, manager);
//    }
//    else if (localName.equals(XMLTags.MD_PROBLEM_TAG))
//    {
//      return new MdProblemHandler(attributes, reader, prev, manager);
//    }
//    else if (localName.equals(XMLTags.MD_INFORMATION_TAG))
//    {
//      return new MdInformationHandler(attributes, reader, prev, manager);
//    }
//    else if (localName.equals(XMLTags.MD_WARNING_TAG))
//    {
//      return new MdWarningHandler(attributes, reader, prev, manager);
//    }
//    else if (localName.equals(XMLTags.MD_VIEW_TAG))
//    {
//      return new MdViewHandler(attributes, reader, prev, manager);
//    }
//    else if (localName.equals(XMLTags.MD_UTIL_TAG))
//    {
//      return new MdUtilHandler(attributes, reader, prev, manager);
//    }
//    else if (localName.equals(XMLTags.MD_CONTROLLER_TAG))
//    {
//      return new MdControllerHandler(attributes, reader, prev, manager);
//    }
//    else if (localName.equals(XMLTags.MD_WEB_FORM_TAG))
//    {
//      return new MdWebFormHandler(attributes, reader, prev, manager);
//    }
//
//    return null;
//  }
