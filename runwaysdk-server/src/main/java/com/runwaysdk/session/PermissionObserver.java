...
/**
 * PermissionManager is a Singleton Class that acts as a bridge
 * between MethodActors, which are used to set and remove
 * permissions for MdMethods, and Methods, which are used for 
...
public class PermissionObserver
{
  ...
  /**
   * Returns the singleton manager if one exists.  If not
   * then it creates a manager and then returns it.
   * 
   * @return
   */
  private static PermissionObserver getManager()
  {
    if(manager == null)
    {
  ...
  /**
   * Notifys all listeners which reference the Actor which modified
   * that a change in Permissions has occured.
   * 
   * @param actor The Actor that was modified
   */
  ...
  /**
   * Notifys all listeners which reference the singleActor which modified
   * that a change in Permissions has occured.
   * 
   * @param singleActorIF The singleActor that was modified
   */
  ...
  /**
   * Returns the size of the listeners array.  This method exists
