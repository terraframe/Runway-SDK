...
public interface MdAttributeReferenceInfo extends MdAttributeConcreteInfo
{

  /**
   * Class.
   */
  public static final String CLASS                        = Constants.METADATA_PACKAGE+".MdAttributeReference";
