...
public class ReadPermissionException extends PermissionException
{
   ...
   *
   */
  private static final long serialVersionUID = 3002247262190805900L;
   ...
   * @param componentIF
   *          The componentIF that was being read
   * @param user
  ...
  {
    return ServerExceptionMessageLocalizer.readPermissionException(this.getLocale(), this.getComponentIF());
  }
}
