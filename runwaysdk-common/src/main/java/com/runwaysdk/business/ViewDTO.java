...
public class ViewDTO extends SessionDTO
{
  
  public static final String CLASS = ViewDTOInfo.CLASS;
  
  /**
   * 
   */
  private static final long serialVersionUID = 8560308954131940376L;

  /**
   * Constructor used when the object is instantiated on the front-end.
   */
  protected ViewDTO(ClientRequestIF clientRequest, String type)
  {
   ...
   * Constructor used when the object is instantiated on the front-end.
   */
  protected ViewDTO(ClientRequestIF clientRequest)
  {
    super(clientRequest);
    ...
    // only get default values if a subclass of BusinessDTO is requested.
    if(!_type.equals(ViewDTO.CLASS) && clientRequest != null)
    {      
      MutableDTO dto = clientRequest.newGenericMutable(_type);
   ...
   */
  protected ViewDTO(ClientRequestIF clientRequest, String type, Map<String, AttributeDTO> attributeMap)
  {
   ...
   * If the clientRequest is null, then it is instantiated on the front-end, otherwise on the back-end.
   */
  protected ViewDTO(ClientRequestIF clientRequest, Map<String, AttributeDTO> attributeMap)
  {
