...
public class AttributeReference extends Attribute implements AttributeReferenceIF
{
   ...
   *
   */
  private static final long serialVersionUID = 8664329249722480518L;
   ...
   */
  protected AttributeReference(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
  ...
  {
    MdAttributeReferenceDAOIF mdAttribute = this.getMdAttribute();
