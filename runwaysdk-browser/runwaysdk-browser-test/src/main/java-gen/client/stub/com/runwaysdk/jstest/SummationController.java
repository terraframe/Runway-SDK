...
public class SummationController extends SummationControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    com.runwaysdk.jstest.SummationDTO dto = com.runwaysdk.jstest.SummationDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    req.setAttribute("item", com.runwaysdk.jstest.SummationDTO.get(clientRequest, id));
