...
public class AttributeDate extends AttributeMoment
{
   ...
   *
   */
  private static final long serialVersionUID = -488516691201940056L;
   ...
   */
  protected AttributeDate(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
   ...
   */
  public MdAttributeDateDAOIF getMdAttribute()
  {
    return (MdAttributeDateDAOIF)this.mdAttributeIF;
  }
