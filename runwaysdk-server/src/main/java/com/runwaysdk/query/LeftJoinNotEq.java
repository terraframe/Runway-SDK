...
public class LeftJoinNotEq extends LeftJoin
{
  /**
   ...
   */
  protected LeftJoinNotEq(String columnName1, String tableName1, String tableAlias1, String columnName2, String tableName2, String tableAlias2)
  {
   ...
   */
  protected LeftJoinNotEq(Selectable selectable1, Selectable... selectableArray2)
  {
   ...
   * @param selectable2
   */
  protected LeftJoinNotEq(Selectable selectable1, Selectable selectable2)
  {
