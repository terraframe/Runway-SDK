...
public class PrimitiveRuleController extends PrimitiveRuleControllerBase
{
  public static final String JSP_DIR = "/WEB-INF/com/runwaysdk/system/gis/mapping/PrimitiveRule/";
  public static final String LAYOUT = "WEB-INF/templates/layout.jsp";
  
  public PrimitiveRuleController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  {
    com.runwaysdk.system.gis.mapping.PrimitiveRuleDTO dto = com.runwaysdk.system.gis.mapping.PrimitiveRuleDTO.lock(super.getClientRequest(), id);
    req.setAttribute("_ruleStyle", com.runwaysdk.system.gis.mapping.LayerStyleDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    req.setAttribute("_ruleStyle", com.runwaysdk.system.gis.mapping.LayerStyleDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", com.runwaysdk.system.gis.mapping.PrimitiveRuleDTO.get(clientRequest, id));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.gis.mapping.PrimitiveRuleQueryDTO query = com.runwaysdk.system.gis.mapping.PrimitiveRuleDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.gis.mapping.PrimitiveRuleQueryDTO query = com.runwaysdk.system.gis.mapping.PrimitiveRuleDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
