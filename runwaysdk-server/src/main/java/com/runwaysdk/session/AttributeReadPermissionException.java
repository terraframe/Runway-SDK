...
public class AttributeReadPermissionException extends PermissionException
{
   ...
   *
   */
  private static final long serialVersionUID = 4661888209826270900L;
  /**
  ...
  /**
   * Returns null, as this exception does not always have access
   * to the component.
   *
   * @return null, as this exception does not always have access
   * to the component.
   */
  protected ComponentIF getComponentIF()
  {
    return super.getComponentIF();
  }
  ...
  {
    MdClassDAOIF mdClassDAOIF = this.mdAttribute.definedByClass();

    String attributeDislayLabel = this.mdAttribute.getDisplayLabel(Session.getCurrentLocale());
    String classDisplayLabel = mdClassDAOIF.getDisplayLabel(Session.getCurrentLocale());

    return CommonExceptionMessageLocalizer.attributeReadPermissionException(this.getLocale(), attributeDislayLabel, classDisplayLabel);
  }
}
