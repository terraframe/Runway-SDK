...
public abstract class Util extends SessionComponent
{
  /**
   * 
   */
   ...
   * {@link Util#setTransientDAO(TransientDAO)} to correclty initialize the entity.
   */
  public Util()
  {
    super();
  ...
  /**
   * Returns the Util object with the given id, if it has been persisted to the
   * user's session.
   * @param id
