...
public  class GeoEntityProblemTypeMasterDescriptionQuery extends com.runwaysdk.query.GeneratedStructQuery
{
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getComponentQuery().get(com.runwaysdk.system.gis.geo.GeoEntityProblemTypeMasterDescription.OID, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getOid(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getComponentQuery().get(com.runwaysdk.system.gis.geo.GeoEntityProblemTypeMasterDescription.OID, alias, displayLabel);
 ...
 **/
  ...
  public com.runwaysdk.query.SelectableChar getOid(String alias)
  {
    return (com.runwaysdk.query.SelectableChar)this.get(com.runwaysdk.system.gis.geo.GeoEntityProblemTypeMasterDescription.OID, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getOid(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.get(com.runwaysdk.system.gis.geo.GeoEntityProblemTypeMasterDescription.OID, alias, displayLabel);
