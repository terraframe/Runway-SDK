...
public class MdAttributeEmbedded_G extends MdAttributeConcrete_G
{
  ...
  protected void createDbAttribute()
  {
    ...
    GraphDDLCommandAction doItAction = GraphDBService.getInstance().createEmbeddedAttribute(graphRequest, graphDDLRequest, GraphEmbeddedFieldProperties.build(dbClassName, dbAttrName, required, this.isChangeOverTime(), embeddedClassType));
  ...
  protected void dropDbAttribute(DeleteContext context)
  {
    ...
    GraphDDLCommandAction undoItAction = GraphDBService.getInstance().createEmbeddedAttribute(graphRequest, graphDDLRequest, GraphEmbeddedFieldProperties.build(dbClassName, dbAttrName, required, this.isChangeOverTime(), embeddedClassType));
