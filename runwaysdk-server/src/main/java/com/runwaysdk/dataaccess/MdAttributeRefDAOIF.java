...
/**
 * Read-Only interface for reference MdAttributes
 * 
 * @author Eric Grunzke
 */
public interface MdAttributeRefDAOIF extends MdAttributeConcreteDAOIF
{
  /**
   * Fully qualified class name
   */
  public static final String CLASS   = Constants.METADATA_PACKAGE+".MdAttributeRef";
