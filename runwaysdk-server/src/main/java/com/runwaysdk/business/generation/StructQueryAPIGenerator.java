...
public class StructQueryAPIGenerator extends EntityQueryAPIGenerator
{
  ...
  /**
   * Returns the name of the interface for the given type which extends AttributeStruct.
   * @param type protected
   * @return name of the interface for the given type which extends AttributeStruct.
   */
  ...
  /**
   * Returns the qualified name of the interface for the given type which extends AttributeStruct.
   * @param type
   * @return qualified name of the interface for the given type which extends AttributeStruct.
   */
  ...
  /**
   * Returns the qualified name of the file of the interface for the given type which extends AttributeStruct.
   * @param type
   * @return qualified name of the interface for the given type which extends AttributeStruct.
   */
  ...
  /**
   * Returns the name of the class for the given type which extends AttributeStruct.
   * @param type
  ...
  /**
   * Returns the qualified name of the class for the given type which extends AttributeStruct.
   * @param type
   * @return qualified name of the inner for the given type which extends AttributeStruct.
   */
  ...
  protected void structInnerClassDef()
  {
    ...
    // Technically Struct attributes cannot reference other objects, but I am including this method call anyway, as this
    // decision may change later and I won't have to go back and add this line back in.  As of now, it will produce nothing.
    this.createAttributeRefFactory(this.srcBuffer);
    this.createAttributeStructFactory(this.srcBuffer);
    this.createAttributeLocalFactory(this.srcBuffer);
    this.createAttributeEnumerationFactory(this.srcBuffer);
