...
public class StateEnumController extends StateEnumControllerBase implements com.runwaysdk.generation.loader.
{
  ...
  public StateEnumController(jakarta.servlet.http.HttpServletRequest req, jakarta.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  {
    com.runwaysdk.jstest.StateEnumDTO dto = com.runwaysdk.jstest.StateEnumDTO.lock(super.getClientRequest(), oid);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", com.runwaysdk.jstest.StateEnumDTO.get(clientRequest, oid));
