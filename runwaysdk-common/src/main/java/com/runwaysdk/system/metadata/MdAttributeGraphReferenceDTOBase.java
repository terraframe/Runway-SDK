...
@com.runwaysdk.business.ClassSignature(hash = -1577702953)
public abstract class MdAttributeGraphReferenceDTOBase extends com.runwaysdk.system.metadata.MdAttributeConcreteDTO
{
  ...
  private static final long serialVersionUID = -1577702953;
  ...
  */
  ...
  public com.runwaysdk.system.metadata.MdVertexDTO getReferenceMdVertex()
  {
    ...
    {
      return com.runwaysdk.system.metadata.MdVertexDTO.get(getRequest(), getValue(REFERENCEMDVERTEX));
    }
  }
  ...
  {
    return isWritable(REFERENCEMDVERTEX);
  }
  
  public boolean isReferenceMdVertexReadable()
  {
    return isReadable(REFERENCEMDVERTEX);
  }
  
  public boolean isReferenceMdVertexModified()
  {
    return isModified(REFERENCEMDVERTEX);
  }
  
  public final com.runwaysdk.transport.metadata.AttributeReferenceMdDTO getReferenceMdVertexMd()
  {
    return (com.runwaysdk.transport.metadata.AttributeReferenceMdDTO) getAttributeDTO(REFERENCEMDVERTEX).getAttributeMdDTO();
  }
