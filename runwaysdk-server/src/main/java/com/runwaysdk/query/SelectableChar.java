...
public interface SelectableChar extends SelectablePrimitive
{
  // Equals
   ...
   * @return Condition object
   */
  public Condition LIKE(String statement);
   ...
   * @return Condition object
   */
  public Condition LIKEi(String statement);
   ...
   * @return Condition object
   */
  public Condition NLIKE(String statement);
   ...
   * @return Condition object
   */
  public Condition NLIKEi(String statement);
