...
import com.runwaysdk.query.sql.MdAttributeText_SQL;

public class SelectableSQLText extends SelectableSQLChar
{

  protected SelectableSQLText(boolean isAggregate, ValueQuery rootQuery, String attributeName, String sql)
  {
    super(isAggregate, rootQuery, attributeName, sql);
    this.init(attributeName, null);
  }

  protected SelectableSQLText(boolean isAggregate, ValueQuery rootQuery, String attributeName, String sql, String userDefinedAlias, String userDefinedDisplayLabel)
  {
  ...
  private void init(String attributeName, String userDefinedDisplayLabel)
  {
    ...
    this.mdAttributeConcrete_SQL = new MdAttributeText_SQL(attributeName, displayLabel);
  }
