...
public class VisibleDependencyController extends VisibleDependencyControllerBase
{
  public static final String JSP_DIR = "/WEB-INF/com/runwaysdk/system/metadata/VisibleDependency/";
  public static final String LAYOUT = "WEB-INF/templates/layout.jsp";
  

  public VisibleDependencyController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  public void childQuery(java.lang.String childId) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    com.runwaysdk.system.metadata.VisibleDependencyQueryDTO query = com.runwaysdk.system.metadata.VisibleDependencyDTO.childQuery(clientRequest, childId);
  ...
  {
    req.setAttribute("_condition", com.runwaysdk.system.metadata.FieldConditionDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
  ...
  {
    com.runwaysdk.system.metadata.VisibleDependencyDTO dto = com.runwaysdk.system.metadata.VisibleDependencyDTO.lock(super.getClientRequest(), id);
    req.setAttribute("_condition", com.runwaysdk.system.metadata.FieldConditionDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.metadata.VisibleDependencyDTO dto = new com.runwaysdk.system.metadata.VisibleDependencyDTO(clientRequest, parentId, childId);
    req.setAttribute("_condition", com.runwaysdk.system.metadata.FieldConditionDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  {
    req.setAttribute("parentList", com.runwaysdk.system.metadata.MdFieldDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("childList", com.runwaysdk.system.metadata.MdFieldDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.metadata.VisibleDependencyQueryDTO query = com.runwaysdk.system.metadata.VisibleDependencyDTO.parentQuery(clientRequest, parentId);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("_condition", com.runwaysdk.system.metadata.FieldConditionDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", com.runwaysdk.system.metadata.VisibleDependencyDTO.get(clientRequest, id));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.metadata.VisibleDependencyQueryDTO query = com.runwaysdk.system.metadata.VisibleDependencyDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.metadata.VisibleDependencyQueryDTO query = com.runwaysdk.system.metadata.VisibleDependencyDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
