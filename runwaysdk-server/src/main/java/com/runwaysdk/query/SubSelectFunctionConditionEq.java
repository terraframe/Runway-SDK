...
public class SubSelectFunctionConditionEq extends SubSelectFunctionCondition
{
  /**
   ...
   */
  public SubSelectFunctionConditionEq(Selectable attributeLeft, SelectableAggregate selectableAggregate)
  {
   ...
   */
  public SubSelectFunctionConditionEq(Selectable attributeLeft, SelectableAggregate selectableAggregate, boolean ignoreCase)
  {
