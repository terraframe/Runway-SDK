...
public abstract class MessageDTOToBasicJSON extends NotificationDTOToBasicJSON
{

  protected MessageDTOToBasicJSON(MessageDTO messageDTO, JsonConfiguration configuration)
  {
    super(messageDTO, configuration);
  }
