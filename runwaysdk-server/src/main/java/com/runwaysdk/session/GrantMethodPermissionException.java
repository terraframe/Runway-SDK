...
public class GrantMethodPermissionException extends PermissionException
{
  /**
   *
   */
  private static final long serialVersionUID = -8926140808824250310L;
   ...
   * @param mdMethodIF
   *          Method that the user does not have permission to grant permissions on.
   * @param user
  ...
  {
    return ServerExceptionMessageLocalizer.grantMethodPermissionException(this.getLocale(), this.mdTypeIF, this.getMdMethod());
  }
}
