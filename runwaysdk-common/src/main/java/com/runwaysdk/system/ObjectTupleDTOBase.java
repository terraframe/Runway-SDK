...
public abstract class ObjectTupleDTOBase extends com.runwaysdk.business.BusinessDTO
{
  ...
  */
  protected ObjectTupleDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  public final static java.lang.String DATAOBJECT = "dataObject";
  ...
  public com.runwaysdk.business.BusinessDTO getDataObject()
  {
    if(getValue(DATAOBJECT) == null || getValue(DATAOBJECT).trim().equals(""))
    {
      return null;
    }
    else
    {
      com.runwaysdk.business.BusinessDTO dto = (com.runwaysdk.business.BusinessDTO) getRequest().get(getValue(DATAOBJECT));
  ...
  public void setDataObject(com.runwaysdk.business.BusinessDTO value)
  {
    if(value == null)
    {
      setValue(DATAOBJECT, "");
  ...
  public boolean isDataObjectWritable()
  {
    return isWritable(DATAOBJECT);
  }
  
  public boolean isDataObjectReadable()
  {
    return isReadable(DATAOBJECT);
  }
  
  public boolean isDataObjectModified()
  {
    return isModified(DATAOBJECT);
  }
  
  public final com.runwaysdk.transport.metadata.AttributeReferenceMdDTO getDataObjectMd()
  {
    return (com.runwaysdk.transport.metadata.AttributeReferenceMdDTO) getAttributeDTO(DATAOBJECT).getAttributeMdDTO();
  }
  ...
  {
    return (com.runwaysdk.system.ObjectTupleQueryDTO) clientRequest.getAllInstances(com.runwaysdk.system.ObjectTupleDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
