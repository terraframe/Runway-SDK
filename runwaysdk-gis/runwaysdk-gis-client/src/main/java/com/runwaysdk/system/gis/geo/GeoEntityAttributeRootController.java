...
public class GeoEntityAttributeRootController extends GeoEntityAttributeRootControllerBase
{
  public static final String JSP_DIR = "/WEB-INF/com/runwaysdk/system/gis/geo/GeoEntityAttributeRoot/";
  public static final String LAYOUT = "WEB-INF/templates/layout.jsp";
  
  public GeoEntityAttributeRootController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  public void childQuery(java.lang.String childId) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    com.runwaysdk.system.gis.geo.GeoEntityAttributeRootQueryDTO query = com.runwaysdk.system.gis.geo.GeoEntityAttributeRootDTO.childQuery(clientRequest, childId);
  ...
  {
    com.runwaysdk.system.gis.geo.GeoEntityAttributeRootDTO dto = com.runwaysdk.system.gis.geo.GeoEntityAttributeRootDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.gis.geo.GeoEntityAttributeRootDTO dto = new com.runwaysdk.system.gis.geo.GeoEntityAttributeRootDTO(clientRequest, parentId, childId);
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.gis.geo.GeoEntityAttributeRootQueryDTO query = com.runwaysdk.system.gis.geo.GeoEntityAttributeRootDTO.parentQuery(clientRequest, parentId);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", com.runwaysdk.system.gis.geo.GeoEntityAttributeRootDTO.get(clientRequest, id));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.gis.geo.GeoEntityAttributeRootQueryDTO query = com.runwaysdk.system.gis.geo.GeoEntityAttributeRootDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.gis.geo.GeoEntityAttributeRootQueryDTO query = com.runwaysdk.system.gis.geo.GeoEntityAttributeRootDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
