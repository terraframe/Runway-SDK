...
public class TermRelationshipBaseGenerator extends RelationshipBaseGenerator
{
  public TermRelationshipBaseGenerator(MdRelationshipDAOIF mdRelatIF)
  {
    super(mdRelatIF);
  }
  ...
  protected String getExtends(MdClassDAOIF parent)
  {
    if (parent == null)
    {
      return TermRelationship.class.getName();
    }
    else
    {
