...
public class GrantAttributePermissionException extends PermissionException
{
  ...
  {
    return ServerExceptionMessageLocalizer.grantAttributePermissionException(this.getLocale(), this.getMdClass(), this.mdAttributeIF);
  }
}
