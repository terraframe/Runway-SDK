...
define(["./log4js", "./ClassFramework", "./RunwaySDK_Inspector"], function(Log4js, ClassFramework){

  var Base = ClassFramework.Base;
...
var Util = Mojo.Meta.newClass('Mojo.Util', {
  ...
  ISO8601_REGEX : "^([0-9]{4})-([0-9]{2})-([0-9]{2})T([0-9]{2}):([0-9]{2}):([0-9]{2})([-+])([0-9]{2})([0-9]{2})$",
    ...
    isObject : ClassFramework.isObject,

    isArray : ClassFramework.isArray,

    isFunction : ClassFramework.isFunction,

    isDate : ClassFramework.isDate,

    isString : ClassFramework.isString,

    isNumber : ClassFramework.isNumber,
    
    isBoolean : ClassFramework.isBoolean,
    
    isUndefined : ClassFramework.isUndefined,
    
    isElement : ClassFramework.isElement,
    
    isValid : ClassFramework.isValid,
