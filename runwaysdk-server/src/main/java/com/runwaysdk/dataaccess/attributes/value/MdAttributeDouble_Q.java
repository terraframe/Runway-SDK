...
public class MdAttributeDouble_Q extends MdAttributeDec_Q implements MdAttributeDoubleDAOIF
{
  /**
   *
   */
  private static final long serialVersionUID = 3588949210798928520L;
   ...
   */
  public MdAttributeDouble_Q(MdAttributeConcreteDAOIF mdAttributeIF)
  {
    super(mdAttributeIF);
  }
