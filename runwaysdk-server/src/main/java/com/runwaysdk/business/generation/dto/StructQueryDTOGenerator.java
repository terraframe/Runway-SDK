...
public class StructQueryDTOGenerator extends EntityQueryDTOGenerator
{
   ...
   * @param mdEntityIF
   */
  public StructQueryDTOGenerator(MdStructDAOIF mdStructIF)
  {
    super(mdStructIF);
  }
  ...
  protected void addExtends(MdClassDAOIF parentMdClassIF)
  {
    ...
    {
      writeLine(srcBuffer, StructQueryDTO.class.getName());
    }
    else
    {
