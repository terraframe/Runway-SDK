...
public java.util.List<? extends com.runwaysdk.system.gis.geo.LocatedInDTO> getResultSet()
{
  return (java.util.List<? extends com.runwaysdk.system.gis.geo.LocatedInDTO>)super.getResultSet();
}
}
