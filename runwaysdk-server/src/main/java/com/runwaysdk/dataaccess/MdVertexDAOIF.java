...
public interface MdVertexDAOIF extends MdGraphClassDAOIF
{
  ...
  /**
   * Returns the {@link MdVertexDAOIF} that is the root of the hierarchy that this type belongs to.
   * returns a reference to itself if it is the root.
   *
   * @return {@link MdVertexDAOIF} that is the root of the hierarchy that this type belongs to.
   * returns a reference to itself if it is the root.
   */
  public abstract MdVertexDAOIF getRootMdClassDAO();
  
  /**
   * Returns an array of {@link MdVertexDAOIF} that defines immediate subclasses of this class.
   * @return an array of {@link MdVertexDAOIF} that defines immediate subclasses of this class.
   */
  public List<? extends MdVertexDAOIF> getSubClasses();
  
  /**
   * Returns a list of {@link MdVertexDAOIF} objects that are subclasses of the given
   * entity. Only non abstract entities are returned (i.e. entities that can be
   * instantiated)
   * 
   * @return list of {@link MdVertexDAOIF} objects that are subclasses of the given entity.
   ...
   *
   * @return list of {@link MdVertexDAOIF} objects that represent entities 
   * that are subclasses of the given entity, including all recursive entities.
   */
  public List<? extends MdVertexDAOIF> getAllSubClasses();
  
  /**
   * Returns an {@link MdVertexDAOIF} representing the super class of this class, or null if
   * it does not have one.
   * 
   * @return an {@link MdVertexDAOIF} representing the super class of this class, or null if
   * it does not have one.
   */
  public MdVertexDAOIF getSuperClass();
  
  /**
   * Returns a list of {@link MdVertexDAOIF} instances representing every
   * parent of this {@link MdVertexDAOIF} partaking in an inheritance relationship.
   * 
   * @return a list of {@link MdVertexDAOIF} instances that are parents of this class.
   */
