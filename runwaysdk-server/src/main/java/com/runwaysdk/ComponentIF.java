...
/**
 * Root interface for all objects in the dataaccess layer that represent units
 * of data with a collection of attributes, where each attribute is a
 * name->value pair.
 * 
 * @author nathan
 *
...
public interface ComponentIF
{
   ...
   * <b>Postcondition:</b> The state of the Component does not change <br/>
   ...
   * this Component: <br/>
   * <b>Postcondition:</b> Returns the value of the given attribute value !=
   * null
   *
   * @param name
  ...
  /**
   * Returns a LinkedList of MdAttributeIFs that define each attribute defined
   * for this object's class.
   * 
   * <br/>
   * <b>Precondition:</b> true
   *
   * @return LinkedList of MdAttributeIFs that define each attribute defined for
   *         this object's class.
   */
   ...
   * @param name
   *          of the attribute.
   * @return MdAttributeIF that defines the attribute with the given name.
   */
