...
public  class TypePermissionQuery extends com.runwaysdk.query.GeneratedRelationshipQuery
{
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getComponentQuery().get(com.runwaysdk.system.TypePermission.OID, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getOid(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getComponentQuery().get(com.runwaysdk.system.TypePermission.OID, alias, displayLabel);
