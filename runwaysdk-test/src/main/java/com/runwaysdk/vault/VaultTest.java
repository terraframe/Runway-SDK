...
//
  ...
  // */
  // public void testPutFile() throws SecurityException, NoSuchFieldException,
  ...
  // BufferedReader bytes1 = new BufferedReader(new
  // InputStreamReader(file.getFileStream()));
  // BufferedReader bytes2 = new BufferedReader(new InputStreamReader(new
  // ByteArrayInputStream(testFile)));
  // int i = 0;
  //
  // try
  // {
  ...
  // }
  //
  // assertEquals(i, Long.parseLong(vault.getValue(VaultInfo.BYTE_COUNT)) -
  // byteCount);
  // }
  //
  // /**
  ...
  // String path = vault.getVaultPath() + "/" + file.getVaultFilePath() +
  // file.getVaultFileName();
  // String tempPath = vault.getVaultPath() + "/" + file.getVaultFilePath() +
  // file.getVaultFileName() + ".temp";
  //
  ...
  // assertFalse(new File(tempPath).exists());
  // assertEquals(byteCount,
  // Long.parseLong(vault.getValue(VaultInfo.BYTE_COUNT)));
  // }
  //
  // /**
  ...
  // BufferedReader bytes1 = new BufferedReader(new
  // InputStreamReader(file.getFileStream()));
  // BufferedReader bytes2 = new BufferedReader(new
  // InputStreamReader(file2.getFileStream()));
  //
  // try
  // {
  // while (bytes1.ready() || bytes2.ready())
