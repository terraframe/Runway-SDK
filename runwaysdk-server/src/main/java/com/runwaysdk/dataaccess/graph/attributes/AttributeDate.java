...
public class AttributeDate extends Attribute
{
   ...
   */
  protected AttributeDate(MdAttributeConcreteDAOIF mdAttributeDAOIF, String definingGraphClass)
  {
  ...
  {
    MdAttributeDateDAOIF mdAttributeIF = this.getMdAttributeConcrete();
