...
public class LeftJoinLt extends LeftJoin
{
   ...
   */
  protected LeftJoinLt(String columnName1, String tableName1, String tableAlias1, String columnName2, String tableName2, String tableAlias2)
  {
   ...
   */
  protected LeftJoinLt(Selectable selectable1, Selectable... selectableArray2)
  {
   ...
   * @param selectable2
   */
  protected LeftJoinLt(Selectable selectable1, Selectable selectable2)
  {
