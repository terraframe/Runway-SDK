...
public class JobDisplayLabelController extends JobDisplayLabelControllerBase
{
  public static final String JSP_DIR = "/WEB-INF/com/runwaysdk/system/scheduler/JobDisplayLabel/";
  public static final String LAYOUT = "WEB-INF/templates/layout.jsp";
  
  public JobDisplayLabelController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  {
    com.runwaysdk.system.scheduler.JobDisplayLabelDTO dto = com.runwaysdk.system.scheduler.JobDisplayLabelDTO.get(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    com.runwaysdk.system.scheduler.JobDisplayLabelDTO dto = new com.runwaysdk.system.scheduler.JobDisplayLabelDTO(clientRequest);
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", com.runwaysdk.system.scheduler.JobDisplayLabelDTO.get(clientRequest, id));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.scheduler.JobDisplayLabelQueryDTO query = com.runwaysdk.system.scheduler.JobDisplayLabelDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.scheduler.JobDisplayLabelQueryDTO query = com.runwaysdk.system.scheduler.JobDisplayLabelDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
