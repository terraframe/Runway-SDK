...
public class AttributeDateTime extends AttributeMoment
{
   ...
   * 
   * @param name
   *          The name of this datetime attribute.
   * @param mdAttributeKey
   *          key of the defining attribute metadata
   * @param definingEntityType
   *          the name of the class that defines this attribute.
   * @param value
   *          The value of this datetime. "<code>true</code>" or
   *          "<code>false</code>"
   */
  ...
  public void setValue(Object value)
  {
    ...
    {
      this.setValue(MdAttributeDateTimeUtil.getTypeUnsafeValue((Date) value));
    }
    else
    {
  ...
  public Object getObjectValue()
  {
    ...
    {
      return MdAttributeDateTimeUtil.getTypeSafeValue(this.getValue());
    }
  ...
  {
    // regex check
    if (!valueToValidate.trim().equals("") && ( !datetimePattern.matcher(valueToValidate).matches() || !AttributeMoment.checkDateBounds(valueToValidate.split(" ")[0]) || !AttributeMoment.checkTimeBounds(valueToValidate.split(" ")[1]) ))
    {
      return false;
    }
    return true;
