...
/**
 * Contains static properties for operation of the core with mysql. Login info is
 * specified in database.properties. Typical default values for logging in to mysql are:
 * <pre>
 * port=3306
