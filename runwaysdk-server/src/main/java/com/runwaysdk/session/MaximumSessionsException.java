...
public class MaximumSessionsException extends LoginException
{
   ...
   */
  public MaximumSessionsException(String devMessage, UserDAOIF user)
  {
    super(devMessage);
    this.user = user;
  }
   ...
   */
  public MaximumSessionsException(String devMessage, Throwable cause, UserDAOIF user)
  {
   ...
   *          is nonexistent or unknown.)
   */
  public MaximumSessionsException(Throwable cause, UserDAOIF user)
  {
    super(cause);
    this.user = user;
  }
