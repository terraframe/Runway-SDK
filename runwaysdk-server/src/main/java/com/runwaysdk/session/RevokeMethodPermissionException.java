...
public class RevokeMethodPermissionException extends PermissionException
{
   ...
   */
  public RevokeMethodPermissionException(String devMessage, MdTypeDAOIF mdTypeIF, MdMethodDAOIF mdMethodIF, SingleActorDAOIF user)
  {
   ...
   *          The user attempting the operation.
   */
  public RevokeMethodPermissionException(String devMessage, Throwable cause, MdTypeDAOIF mdTypeIF, MdMethodDAOIF mdMethodIF, SingleActorDAOIF user)
  {
   ...
   *          The user attempting the operation.
   */
  public RevokeMethodPermissionException(Throwable cause, MdTypeDAOIF mdTypeIF, MdMethodDAOIF mdMethodIF, SingleActorDAOIF user)
  {
