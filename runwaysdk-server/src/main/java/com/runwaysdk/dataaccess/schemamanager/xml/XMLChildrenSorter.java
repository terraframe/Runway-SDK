...
public class XMLChildrenSorter extends XMLElementSorter<SchemaElementIF> implements Serializable
{
  ...
  {
    int difference = priorities.childElementPriority(firstElement.getTag()) - priorities.childElementPriority(secondElement.getTag());
