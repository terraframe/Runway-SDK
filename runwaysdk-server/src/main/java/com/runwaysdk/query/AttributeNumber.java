...
public abstract class AttributeNumber extends AttributePrimitive implements SelectableNumber
{

  protected AttributeNumber(MdAttributeNumberDAOIF mdAttributeIF, String attributeNamespace,
