...
public class TransactionItemStrategyAction extends TransactionItemAction
{
  private CacheStrategy cacheStrategy;
  
  protected TransactionItemStrategyAction(ActionEnumDAO action, CacheStrategy _cacheStrategy)
  {
    super(action);
