...
public class ChildAttributeRelationshipQueryTest extends TestCase
{
  @Override
  ...
  {
    junit.textui.TestRunner.run(new EntityMasterTestSetup(ChildAttributeRelationshipQueryTest.suite()));
  }

  public static Test suite()
  {
    TestSuite suite = new TestSuite();
    suite.addTestSuite(ChildAttributeRelationshipQueryTest.class);
