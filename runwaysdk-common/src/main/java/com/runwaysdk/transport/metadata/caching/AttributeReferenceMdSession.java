...
public class AttributeReferenceMdSession extends AttributeMdSession {
  ...
  public AttributeReferenceMdSession(String referencedMdBusiness, String referencedDisplayLabel) {
