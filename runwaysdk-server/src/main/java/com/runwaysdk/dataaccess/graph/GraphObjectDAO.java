...
public abstract class GraphObjectDAO extends ComponentDAO implements GraphObjectDAOIF
{
  ...
  {
    this.setValue(name, value, startDate, true);
  }

  public void setValue(String name, Object value, Date startDate, boolean updateOnCollision)
  {
    ...
    attribute.setValue(value, startDate, updateOnCollision);
  }
  ...
  public void clearEntries(String name, Date startDate, Date endDate)
  {
    ...
    attribute.clearEntries(startDate, endDate);
  }
