...
/**
 * A common util class for MdAttributeInteger objects
 * @author jsmethie
 *
 */
public class MdAttributeIntegerUtil extends MdAttributeUtil
{
  /**
   ...
   */
  public static Integer getTypeSafeValue(String toParse)
  {
