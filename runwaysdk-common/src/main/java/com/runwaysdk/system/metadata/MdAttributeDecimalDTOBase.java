...
@com.runwaysdk.business.ClassSignature(hash = 136534736)
public abstract class MdAttributeDecimalDTOBase extends com.runwaysdk.system.metadata.MdAttributeDecDTO
{
  public final static String CLASS = "com.runwaysdk.system.metadata.MdAttributeDecimal";
  private static final long serialVersionUID = 136534736;
  
  protected MdAttributeDecimalDTOBase(com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
    super(clientRequest);
  }
  ...
  */
  protected MdAttributeDecimalDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  public static com.runwaysdk.system.metadata.MdAttributeDecimalDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String oid)
  {
    com.runwaysdk.business.EntityDTO dto = (com.runwaysdk.business.EntityDTO)clientRequest.get(oid);
    
    return (com.runwaysdk.system.metadata.MdAttributeDecimalDTO) dto;
  }
  ...
  public static com.runwaysdk.system.metadata.MdAttributeDecimalQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (com.runwaysdk.system.metadata.MdAttributeDecimalQueryDTO) clientRequest.getAllInstances(com.runwaysdk.system.metadata.MdAttributeDecimalDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static com.runwaysdk.system.metadata.MdAttributeDecimalDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String oid)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{oid};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwaysdk.system.metadata.MdAttributeDecimalDTO.CLASS, "lock", _declaredTypes);
    return (com.runwaysdk.system.metadata.MdAttributeDecimalDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static com.runwaysdk.system.metadata.MdAttributeDecimalDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String oid)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{oid};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwaysdk.system.metadata.MdAttributeDecimalDTO.CLASS, "unlock", _declaredTypes);
    return (com.runwaysdk.system.metadata.MdAttributeDecimalDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
