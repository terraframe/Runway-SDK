...
/**
 * Contains static properties for operation of the core with postgres. Login info is
 * specified in database.properties. Typical default values for logging in to postgres are:
 * <pre>
 * port=5432
...
public class PostgreSQL extends ListResourceBundle
{
  ...
  static final Object[][] contents =
  {
    ...
    { "databaseClass", com.runwaysdk.dataaccess.database.general.PostgreSQL.class.getName() },
  };
