 ...
 *
 */
public class MdAttributeJson_E extends MdAttributeConcrete_E
{
  /**
   ...
   * @param mdAttribute
   */
  public MdAttributeJson_E(MdAttributeConcreteDAO mdAttribute)
  {
    super(mdAttribute);
  }
  ...
  protected String getDbColumnType()
  {
    ...
    return Database.formatJsonField(dbType);
  }
