...
public class MdAttributeText_Q extends MdAttributePrimitive_Q implements MdAttributeTextDAOIF
{
  /**
   *
   */
   ...
   */
  public MdAttributeText_Q(MdAttributeConcreteDAOIF mdAttributeIF)
  {
    super(mdAttributeIF);
  }
