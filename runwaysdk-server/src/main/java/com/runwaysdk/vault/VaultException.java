...
/**
 * Indicates a problem with a file vault
 * 
 * @author Eric Grunzke
 */
public class VaultException extends RunwayException
{
  /**
   * Generated by Eclipse
   */
  private static final long serialVersionUID = 659728255468318764L;

  /**
   * Constructs a new VaultException with the specified developer message and a default
   ...
   */
  public VaultException(String devMessage)
  {
    super(devMessage);
  }
   ...
   * automatically incorporated in this VaultException's detail message.
   * 
   * @param devMessage
   *          The non-localized developer error message. Contains specific data access
   *          layer information useful for application debugging. The developer message is
   ...
   */
  public VaultException(String devMessage, Throwable cause)
  {
    super(devMessage, cause);
  }

  /**
   * Constructs a new VaultException with the specified cause and a developer message
   * taken from the cause. This constructor is useful if the VaultException is a wrapper
  ...
  {
    return ServerExceptionMessageLocalizer.vaultException(this.getLocale());
  }
}
