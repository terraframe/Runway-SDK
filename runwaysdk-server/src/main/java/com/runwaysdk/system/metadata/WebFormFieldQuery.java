...
@com.runwaysdk.business.ClassSignature(hash = -1174962116)
/**
 ...
 */
public  class WebFormFieldQuery extends com.runwaysdk.system.metadata.FormFieldQuery
{

  public WebFormFieldQuery(com.runwaysdk.query.QueryFactory componentQueryFactory)
  {
  ...
  public WebFormFieldQuery(com.runwaysdk.query.ValueQuery valueQuery)
  {
    super(valueQuery);
    if (this.getComponentQuery() == null)
    {
  ...
  {
    return com.runwaysdk.system.metadata.WebFormField.CLASS;
  }
  /**
   ...
   * @param mdWebFormQuery
   * @return Condition restricting objects that are parents in this relationship.
   */
   public com.runwaysdk.query.Condition hasParent(com.runwaysdk.system.metadata.MdWebFormQuery mdWebFormQuery)
   {
     return this.getRelationshipQuery().hasParent(mdWebFormQuery);
   }
  /**
   * Restricts the query to include objects that are parents in this relationship.
   * @param mdWebFormQuery
   * @return Condition restricting objects that are parents in this relationship.
   */
   public com.runwaysdk.query.Condition doesNotHaveParent(com.runwaysdk.system.metadata.MdWebFormQuery mdWebFormQuery)
   {
     return this.getRelationshipQuery().doesNotHaveParent(mdWebFormQuery);
   }
  /**  
   ...
   * on this query object.
   */
  public com.runwaysdk.query.OIterator<? extends WebFormField> getIterator()
  {
    ...
    return new com.runwaysdk.business.RelationshipIterator<WebFormField>(this.getComponentQuery().getMdEntityIF(), this.getRelationshipQuery(), columnInfoMap, results);
  }
