...
public class UtilDTO extends SessionDTO
{
  public static final String CLASS = UtilDTOInfo.CLASS;
  
  /**
   * Constructor used when the object is instantiated on the front-end.
   */
  protected UtilDTO(ClientRequestIF clientRequest, String type)
  {
   ...
   * Constructor used when the object is instantiated on the front-end.
   */
  protected UtilDTO(ClientRequestIF clientRequest)
  {
    super(clientRequest);
    ...
    if(!_type.equals(UtilDTO.CLASS) && clientRequest != null)
    {      
   ...
   */
  protected UtilDTO(ClientRequestIF clientRequest, String type, Map<String, AttributeDTO> attributeMap)
  {
   ...
   * If the clientRequest is null, then it is instantiated on the front-end, otherwise on the back-end.
   */
  protected UtilDTO(ClientRequestIF clientRequest, Map<String, AttributeDTO> attributeMap)
  {
