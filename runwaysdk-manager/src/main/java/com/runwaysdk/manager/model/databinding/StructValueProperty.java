...
public class StructValueProperty extends SimpleValueProperty
{
  private String attributeName;

  public StructValueProperty(String attributeName)
  {
  ...
  protected Object doGetValue(Object source)
  {
    if (source instanceof IComponentObject)
    {
      ...
      return decorator.getStruct(attributeName);
    }
  ...
  protected void doSetValue(Object source, Object value)
  {
    if (source instanceof IComponentObject)
    {
      ...
      decorator.copyAttributes((IComponentObject) value);
    }
