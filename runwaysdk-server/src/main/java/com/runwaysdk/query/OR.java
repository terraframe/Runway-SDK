...
public class OR extends CompositeCondition
{
  ...
  {
    super(condition1, ConditionOperator.OR, condition2);
  }

  /**
   * Performs an OR to all given conditions.
   * @param conditions conditions to OR.
  ...
  {   
    ...
    else
    {
      ...
      for (int i=1; i<conditions.length; i++)
      {
        ...
        {
          loopCondition  = new OR(loopCondition, conditions[i]);
        }
      }
