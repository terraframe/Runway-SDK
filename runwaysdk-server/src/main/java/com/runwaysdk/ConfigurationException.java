 ...
 * @author Eric Grunzke
 */
public class ConfigurationException extends RunwayException
{
  /**
  ...
  /**
   * Constructs a new ConfigurationException with the specified developer message and a default
   ...
   */
  public ConfigurationException(String devMessage)
  {
    super(devMessage);
  }
   ...
   * automatically incorporated in this ConfigurationException's detail message.
   *
   * @param devMessage
   *          The non-localized developer error message. Contains specific data access
   *          layer information useful for application debugging. The developer message is
   ...
   */
  public ConfigurationException(String devMessage, Throwable cause)
  {
    super(devMessage, cause);
  }

  /**
   * Constructs a new ConfigurationException with the specified cause and a developer message
   * taken from the cause. This constructor is useful if the ConfigurationException is a wrapper
  ...
  {
    return CommonExceptionMessageLocalizer.configurationException(this.getLocale());
  }
}
