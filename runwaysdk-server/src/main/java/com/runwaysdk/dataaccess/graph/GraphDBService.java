...
//    this.graphDB = Optional.of(null);
  ...
  /**
   * This has a different method signature compared to {@link GraphDBService#getGraphDBRequest}
   * even though it does the same thing so that aspects will not intercept this call and provide
   * a different {@link GraphRequest} object.
   * @return
   */
