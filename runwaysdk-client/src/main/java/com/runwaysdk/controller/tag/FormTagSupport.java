...
public class FormTagSupport extends StandardTagSupport
{
  ...
  private void closeFormTag(JspWriter out) throws IOException
  {
    ...
    for (CommandTagSupport command : commands)
    {
      ...
      out.println("// Generated by FormTagSupport.closeFormTag");
      ...
      if (isAsynchronous())
      {
        ...
        out.println("  return false;"); // Returning false prevents the default, which is a form submit behavior (refreshes the page)
      }
      else
      {
