...
public class AttributeClobDTO extends AttributeDTO
{
  /**
   *
   */
  private static final long serialVersionUID = 7024456995188361643L;
   ...
   * @param modified
   */
  protected AttributeClobDTO(String name, String value, boolean readable, boolean writable, boolean modified)
  {
  ...
  public AttributeDTO clone()
  {
    ...
    AttributeClobDTO clone = (AttributeClobDTO) super.clone();
  ...
  @Override
  public AttributeClobMdDTO getAttributeMdDTO()
  {
    return (AttributeClobMdDTO) super.getAttributeMdDTO();
  }
