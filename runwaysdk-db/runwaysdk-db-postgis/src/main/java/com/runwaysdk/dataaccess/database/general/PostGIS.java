...
public class PostGIS extends PostgreSQL
{
  ...
  public Object convertDatabaseValue(Object value)
  {
    if (value != null && value instanceof JtsGeometry)
    {
      return ((JtsGeometry)value).getGeometry();
    }
    
    return super.convertDatabaseValue(value);
  }
}
