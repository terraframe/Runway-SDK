...
public abstract class ImportLogDTOBase extends com.runwaysdk.business.BusinessDTO
{
  ...
  */
  protected ImportLogDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  {
    return (com.runwaysdk.system.transaction.ImportLogQueryDTO) clientRequest.getAllInstances(com.runwaysdk.system.transaction.ImportLogDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
