...
@com.runwaysdk.business.ClassSignature(hash = -1746766115)
/**
...
public abstract class OntologyStrategyBase extends com.runwaysdk.business.Business
{
  ...
  private static final long serialVersionUID = -1746766115;
  ...
  public java.util.List<com.runwaysdk.system.metadata.ontology.StrategyState> getStrategyState()
  {
    return (java.util.List<com.runwaysdk.system.metadata.ontology.StrategyState>) getEnumValues(STRATEGYSTATE);
  }
  
  public void addStrategyState(com.runwaysdk.system.metadata.ontology.StrategyState value)
  {
    if(value != null)
    {
  ...
  public void removeStrategyState(com.runwaysdk.system.metadata.ontology.StrategyState value)
  {
    if(value != null)
    {
  ...
  public void validateStrategyState()
  {
    this.validateAttribute(STRATEGYSTATE);
  }
  
  public static com.runwaysdk.dataaccess.MdAttributeDAOIF getStrategyStateMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(com.runwaysdk.system.metadata.ontology.OntologyStrategy.CLASS);
    return mdClassIF.definesAttribute(STRATEGYSTATE);
  }
