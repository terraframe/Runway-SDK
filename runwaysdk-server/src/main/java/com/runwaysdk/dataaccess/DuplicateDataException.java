...
{
  private Logger logger = LoggerFactory.getLogger(DuplicateDataException.class);
  ...
  public String getLocalizedMessage()
  {
    ...
    {
      logger.error("Error while building localized message for DuplicateDataException.", t);
      
      String msg = "DuplicateDataException ";
      ...
      if (this.localizedAttrLabels != null)
      {
        msg += " attributes are [" + StringUtils.join(this.localizedAttrLabels, ", ") + "]";
      }
      
      if (this.valueList != null)
      {
        msg += " values are [" + StringUtils.join(this.valueList, ", ") + "]";
      }
