...
@com.runwaysdk.business.ClassSignature(hash = 664700429)
public abstract class RefClassDTOBase extends com.runwaysdk.business.BusinessDTO implements com.runwaysdk.generation.loader.Reloadable
{
  public final static String CLASS = "com.runwaysdk.jstest.RefClass";
  private static final long serialVersionUID = 664700429;
  
  protected RefClassDTOBase(com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
    super(clientRequest);
  }
  ...
  */
  protected RefClassDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  public static java.lang.String REFCHAR = "refChar";
  ...
  {
    return getValue(REFCHAR);
  }
  
  public void setRefChar(String value)
  {
    if(value == null)
    {
      setValue(REFCHAR, "");
    ...
    {
      setValue(REFCHAR, value);
    }
  }
  
  public boolean isRefCharWritable()
  {
    return isWritable(REFCHAR);
  }
  
  public boolean isRefCharReadable()
  {
    return isReadable(REFCHAR);
  }
  
  public boolean isRefCharModified()
  {
    return isModified(REFCHAR);
  }
  
  public final com.runwaysdk.transport.metadata.AttributeCharacterMdDTO getRefCharMd()
  {
    return (com.runwaysdk.transport.metadata.AttributeCharacterMdDTO) getAttributeDTO(REFCHAR).getAttributeMdDTO();
  }
  ...
  {
    return (com.runwaysdk.jstest.RefClassQueryDTO) clientRequest.getAllInstances(com.runwaysdk.jstest.RefClassDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
