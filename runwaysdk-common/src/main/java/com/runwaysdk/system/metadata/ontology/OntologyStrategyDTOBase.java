...
@com.runwaysdk.business.ClassSignature(hash = 571804323)
public abstract class OntologyStrategyDTOBase extends com.runwaysdk.business.BusinessDTO
{
  ...
  private static final long serialVersionUID = 571804323;
  ...
  */
  ...
  public final static java.lang.String STRATEGYSTATE = "strategyState";
  public final static java.lang.String TERMCLASS = "termClass";
  ...
  public java.util.List<com.runwaysdk.system.metadata.ontology.StrategyStateDTO> getStrategyState()
  {
    return (java.util.List<com.runwaysdk.system.metadata.ontology.StrategyStateDTO>) com.runwaysdk.transport.conversion.ConversionFacade.convertEnumDTOsFromEnumNames(getRequest(), com.runwaysdk.system.metadata.ontology.StrategyStateDTO.CLASS, getEnumNames(STRATEGYSTATE));
  }
  
  public java.util.List<String> getStrategyStateEnumNames()
  {
    return getEnumNames(STRATEGYSTATE);
  }
  
  public void addStrategyState(com.runwaysdk.system.metadata.ontology.StrategyStateDTO enumDTO)
  {
    addEnumItem(STRATEGYSTATE, enumDTO.toString());
  }
  
  public void removeStrategyState(com.runwaysdk.system.metadata.ontology.StrategyStateDTO enumDTO)
  {
    removeEnumItem(STRATEGYSTATE, enumDTO.toString());
  }
  
  public void clearStrategyState()
  {
    clearEnum(STRATEGYSTATE);
  }
  
  public boolean isStrategyStateWritable()
  {
    return isWritable(STRATEGYSTATE);
  }
  
  public boolean isStrategyStateReadable()
  {
    return isReadable(STRATEGYSTATE);
  }
  
  public boolean isStrategyStateModified()
  {
    return isModified(STRATEGYSTATE);
  }
  ...
  {
    return (com.runwaysdk.system.metadata.ontology.OntologyStrategyQueryDTO) clientRequest.getAllInstances(com.runwaysdk.system.metadata.ontology.OntologyStrategyDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
