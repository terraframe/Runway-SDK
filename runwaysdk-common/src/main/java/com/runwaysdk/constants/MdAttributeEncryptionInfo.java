...
public interface MdAttributeEncryptionInfo extends MdAttributeConcreteInfo
{

  /**
   * Class.
   */
  public static final String CLASS   = Constants.METADATA_PACKAGE+".MdAttributeEncryption";
