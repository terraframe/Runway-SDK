...
/**
 * A common util class for MdAttributeLong objects
 * @author jsmethie
 *
 */
public class MdAttributeLongUtil extends MdAttributeUtil
{
  /**
   ...
   */
  public static Long getTypeSafeValue(String toParse)
  {
