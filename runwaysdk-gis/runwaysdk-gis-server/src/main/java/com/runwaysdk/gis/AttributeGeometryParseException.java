...
import com.runwaysdk.AttributeParseException;
...
public abstract class AttributeGeometryParseException extends AttributeParseException
{
   ...
   * @param invalidValue
   */
  public AttributeGeometryParseException(String devMessage, String attributeDisplayLabel, String invalidValue)
  {
    super(devMessage, attributeDisplayLabel, invalidValue);
  }

  /**
   * Constructs a new <code>AttributeGeometryParseException</code> with the specified detail message and
   * cause.
   * <p>
   ...
   * @param invalidValue
   */
  public AttributeGeometryParseException(String devMessage, Throwable cause, String attributeDisplayLabel, String invalidValue)
  {
    super(devMessage, cause, attributeDisplayLabel, invalidValue);
  }

  /**
   * Constructs a new <code>AttributeGeometryParseException</code> with the specified cause and a
   ...
   * @param invalidValue
   */
  public AttributeGeometryParseException(Throwable cause, String attributeDisplayLabel, String invalidValue)
  {
