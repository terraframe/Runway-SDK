...
/**
 * Writes the json definition for a relationship.
 */
public class RelationshipJSGenerator  extends ElementJSGenerator
{
  /**
   * Constructor
   */
  public RelationshipJSGenerator(String sessionId, MdRelationshipDAOIF mdRelationshipIF)
  {
