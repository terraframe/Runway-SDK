...
public class SeleniumJUnitTestAutomator extends SeleneseTestCase
{
    private static int MAXIMUM_TOTAL_TEST_DURATION = 60; // in seconds
    private static String supportedBrowsers[] = { "*firefox", "*firefox3", "*firefox2" }; // todo: IE7, IE8, IE9, Opera 10, Opera 9, Safari 3, Safari 2, Chrome
    ...
    public static Test suite() throws Exception
    {
      ...
      for (String browser : supportedBrowsers)
      {
        try
        {
          ...
          selenium = new DefaultSelenium("localhost", 4444, browser, "http://localhost:8080/runwaysdk_js/runwaysdk/test/");
          selenium.start();
          isSeleniumStarted = true;
          selenium.open("MasterTestLauncher.jsp");
          selenium.waitForCondition("selenium.browserbot.getCurrentWindow().document.getElementById('all');", "5000");
