...
/**
 * Converts a Document to a struct (AttributeStructDTO)
 */
public class DocToStructDTO extends DocToEntityDTO
{
  /**
   * Constructor
   *
   ...
   * @param root
   */
  public DocToStructDTO(ClientRequestIF clientRequest, Element parentElement)
  {
    super(clientRequest, parentElement);
  }
   ...
   */
  protected StructDTO factoryMethod(String type, Map<String, AttributeDTO> attributeMap,
      boolean newInstance, boolean readable, boolean writable, boolean modified)
  {
    try
    {
      ...
      return ComponentDTOFacade.buildStructDTO(this.clientRequest, type, attributeMap,
