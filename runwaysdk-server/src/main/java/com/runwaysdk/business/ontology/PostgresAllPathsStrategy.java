...
// * License along with Runway SDK(tm).  If not, see <http://www.gnu.org/licenses/>.
// ******************************************************************************/
//public class PostgresAllPathsStrategy implements OntologyOptimizationStrategyIF
//{
//
...
//
//  public static PostgresAllPathsStrategy INSTANCE;
//  
//  public synchronized static PostgresAllPathsStrategy getInstance() {
//    if (INSTANCE == null) {
//      INSTANCE = new PostgresAllPathsStrategy(null); // FIXME
//    }
//    
//    return INSTANCE;
//  }
...
//
//  public PostgresAllPathsStrategy(OntologyProvider provider)
//  {
