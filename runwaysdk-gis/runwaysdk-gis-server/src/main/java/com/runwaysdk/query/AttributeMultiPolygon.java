...
public class AttributeMultiPolygon extends AttributeGeometry
{
  protected AttributeMultiPolygon(MdAttributeMultiPolygonDAOIF mdAttributeIF, String attributeNamespace, String definingTableName,
