...
public class InnerJoinGt extends InnerJoin
{
   ...
   */
  public InnerJoinGt(String columnName1, String tableName1, String tableAlias1, String columnName2, String tableName2, String tableAlias2)
  {
   ...
   * @param selectable2
   */
  public InnerJoinGt(Selectable selectable1, Selectable selectable2)
  {
