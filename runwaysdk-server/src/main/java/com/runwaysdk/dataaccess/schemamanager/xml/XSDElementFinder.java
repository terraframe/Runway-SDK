...
public class XSDElementFinder extends DefaultXSVisitor
{
  ...
  {
    Iterator<XSElementDecl> elementIterator = schema.iterateElementDecls();
    
    while (elementIterator.hasNext())
    {
      XSElementDecl elementDecl = elementIterator.next();
      elementDecl.visit(this);
    }
  }

  public XSDElementFinder(String elementName)
  {
    searchName = elementName;
  }
