...
{
  public static final String JSP_DIR = "/WEB-INF/com/runwaysdk/system/scheduler/Job/";
  public static final String LAYOUT = "WEB-INF/templates/layout.jsp";
  
  public JobController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  {
    com.runwaysdk.system.scheduler.JobDTO dto = com.runwaysdk.system.scheduler.JobDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    req.setAttribute("item", com.runwaysdk.system.scheduler.JobDTO.get(clientRequest, id));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.scheduler.JobQueryDTO query = com.runwaysdk.system.scheduler.JobDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.scheduler.JobQueryDTO query = com.runwaysdk.system.scheduler.JobDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
