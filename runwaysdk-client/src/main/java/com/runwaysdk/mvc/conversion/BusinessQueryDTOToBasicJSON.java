...
public class BusinessQueryDTOToBasicJSON extends ElementQueryDTOToBasicJSON
{

  protected BusinessQueryDTOToBasicJSON(BusinessQueryDTO queryDTO, JsonConfiguration configuration)
  {
