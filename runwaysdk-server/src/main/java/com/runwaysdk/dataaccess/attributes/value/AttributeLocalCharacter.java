...
public class AttributeLocalCharacter extends AttributeLocal implements AttributeLocalCharacterIF
{
   ...
   *
   */
  private static final long serialVersionUID = -3490846383072177409L;
   ...
   */
  protected AttributeLocalCharacter(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
