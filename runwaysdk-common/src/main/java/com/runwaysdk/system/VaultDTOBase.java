...
@com.runwaysdk.business.ClassSignature(hash = 2115084835)
public abstract class VaultDTOBase extends com.runwaysdk.business.BusinessDTO
{
  ...
  private static final long serialVersionUID = 2115084835;
  ...
  */
  protected VaultDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  public final static java.lang.String BYTECOUNT = "byteCount";
  ...
  public void setByteCount(Long value)
  {
    ...
    {
      setValue(BYTECOUNT, java.lang.Long.toString(value));
    }
  }
  
  public boolean isByteCountWritable()
  {
    return isWritable(BYTECOUNT);
  }
  
  public boolean isByteCountReadable()
  {
    return isReadable(BYTECOUNT);
  }
  
  public boolean isByteCountModified()
  {
    return isModified(BYTECOUNT);
  }
  
  public final com.runwaysdk.transport.metadata.AttributeNumberMdDTO getByteCountMd()
  {
    return (com.runwaysdk.transport.metadata.AttributeNumberMdDTO) getAttributeDTO(BYTECOUNT).getAttributeMdDTO();
  }
  ...
  {
    return (com.runwaysdk.system.VaultQueryDTO) clientRequest.getAllInstances(com.runwaysdk.system.VaultDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
