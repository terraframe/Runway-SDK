...
public class LoaderDecoratorExceptionDTO extends RunwayExceptionDTO implements LoaderDecoratorExceptionIF
{
  ...
  /**
   * Constructs a new {@link LoaderDecoratorExceptionDTO} with the specified localized message from the server.
   *
   * @param type of the runway exception.
   * @param localizedMessage end user error message.
   * @param developerMessage developer error message.
   */
  public LoaderDecoratorExceptionDTO(String type, String localizedMessage, String developerMessage)
  {
   ...
   * @param throwable
   */
  public LoaderDecoratorExceptionDTO(String type, String localizedMessage, String developerMessage, Throwable throwable)
  {
  ...
  public String getLocalizedMessage()
  {
    ...
    {
      return CommonExceptionMessageLocalizer.loaderDecoratorException(CommonProperties.getDefaultLocale());
    }
    else
    {
