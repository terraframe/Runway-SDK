...
@com.runwaysdk.business.ClassSignature(hash = -474320344)
public abstract class SDutyDTOBase extends com.runwaysdk.business.BusinessDTO
{
  public final static String CLASS = "com.runwaysdk.system.SDuty";
  @SuppressWarnings("unused")
  private static final long serialVersionUID = -474320344;
  
  protected SDutyDTOBase(com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
    super(clientRequest);
  }
  ...
  */
  protected SDutyDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  public final static java.lang.String SDCARDINALITY = "sdCardinality";
  public final static java.lang.String SDNAME = "sdName";
  ...
  public Integer getSdCardinality()
  {
    return com.runwaysdk.constants.MdAttributeIntegerUtil.getTypeSafeValue(getValue(SDCARDINALITY));
  }
  
  public void setSdCardinality(Integer value)
  {
    if(value == null)
    {
      setValue(SDCARDINALITY, "");
    }
    else
    {
      setValue(SDCARDINALITY, java.lang.Integer.toString(value));
    }
  }
  
  public boolean isSdCardinalityWritable()
  {
    return isWritable(SDCARDINALITY);
  }
  
  public boolean isSdCardinalityReadable()
  {
    return isReadable(SDCARDINALITY);
  }
  
  public boolean isSdCardinalityModified()
  {
    return isModified(SDCARDINALITY);
  }
  
  public final com.runwaysdk.transport.metadata.AttributeNumberMdDTO getSdCardinalityMd()
  {
    return (com.runwaysdk.transport.metadata.AttributeNumberMdDTO) getAttributeDTO(SDCARDINALITY).getAttributeMdDTO();
  }
  
  public String getSdName()
  {
    return getValue(SDNAME);
  }
  
  public void setSdName(String value)
  {
    if(value == null)
    {
      setValue(SDNAME, "");
    ...
    {
      setValue(SDNAME, value);
    }
  }
  
  public boolean isSdNameWritable()
  {
    return isWritable(SDNAME);
  }
  
  public boolean isSdNameReadable()
  {
    return isReadable(SDNAME);
  }
  
  public boolean isSdNameModified()
  {
    return isModified(SDNAME);
  }
  
  public final com.runwaysdk.transport.metadata.AttributeCharacterMdDTO getSdNameMd()
  {
    return (com.runwaysdk.transport.metadata.AttributeCharacterMdDTO) getAttributeDTO(SDNAME).getAttributeMdDTO();
  }
  ...
  {
    return (com.runwaysdk.system.SDutyQueryDTO) clientRequest.getAllInstances(com.runwaysdk.system.SDutyDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
