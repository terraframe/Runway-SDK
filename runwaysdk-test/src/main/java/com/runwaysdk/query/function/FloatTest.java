...
public class FloatTest  extends TestCase
{
  ...
  {
    junit.textui.TestRunner.run(new AggregateFunctionMasterSetup(FloatTest.suite()));
  }
  ...
  { 
    ...
    assertEquals(errMsg, AggregateFunctionMasterSetup.floatMinGtList.size(), count);
  ...
  { 
    ...
    assertEquals(errMsg, AggregateFunctionMasterSetup.floatMinNotEqList.size(), count);
  ...
  { 
    ...
    assertEquals(errMsg,  AggregateFunctionMasterSetup.floatMaxLtList.size(), count);
  ...
  { 
    ...
    assertEquals(errMsg,  AggregateFunctionMasterSetup.floatMaxLtEqList.size(), count);
  ...
  { 
    ...
    String errMsg = "Not Equal MIN() check returned wrong result.";
    assertEquals(errMsg, AggregateFunctionMasterSetup.floatMaxNotEqList.size(), count);
  ...
  { 
    ...
    assertEquals(errMsg, AggregateFunctionMasterSetup.floatEqAvgList.size(), count);
  ...
  { 
    ...
    assertEquals(errMsg, AggregateFunctionMasterSetup.floatGtAvgList.size(), count);
  ...
  { 
    ...
    assertEquals(errMsg, AggregateFunctionMasterSetup.floatGtEqAvgList.size(), count);
  ...
  { 
    ...
    assertEquals(errMsg, AggregateFunctionMasterSetup.floatLtAvgList.size(), count);
  ...
  { 
    ...
    assertEquals(errMsg, AggregateFunctionMasterSetup.floatLtEqAvgList.size(), count);
  ...
  { 
    ...
    assertEquals(errMsg, AggregateFunctionMasterSetup.floatNotEqAvgList.size(), count);
  ...
  { 
    ...
    assertEquals(errMsg, AggregateFunctionMasterSetup.floatEqCountList.size(), count);
  ...
  { 
    ...
    assertEquals(errMsg, AggregateFunctionMasterSetup.floatGtCountList.size(), count);
  ...
  { 
    ...
    assertEquals(errMsg, AggregateFunctionMasterSetup.floatGtEqCountList.size(), count);
  ...
  { 
    ...
    assertEquals(errMsg, AggregateFunctionMasterSetup.floatLtCountList.size(), count);
  ...
  { 
    ...
    assertEquals(errMsg, AggregateFunctionMasterSetup.floatLtEqCountList.size(), count);
  ...
  { 
    ...
    assertEquals(errMsg, AggregateFunctionMasterSetup.floatNotEqCountList.size(), count);
...
//
//  public void testFloatEqStdDevAttribute()
//  { 
//    QueryFactory factory = new QueryFactory();
//    BusinessDAOQuery query = factory.businessDAOQuery(AggregateFunctionMasterSetup.classQueryInfo.getType());
//    BusinessDAOQuery query2 = factory.businessDAOQuery(AggregateFunctionMasterSetup.comQueryInfo.getType());
//    query.WHERE(query.aFloat("funcFloat").EQ(new StdDev(query2.aFloat("comFuncFloat"))));
//    query.ORDER_BY(query.aFloat("funcFloat"), OrderBy.SortOrder.ASC);
//    
//    long count = query.getCount();
//
//    String errMsg = "Eq than STDDEV() check returned wrong result.";
//    assertEquals(errMsg, AggregateFunctionMasterSetup.floatEqStdDevList.size(), count);
//    
...
//    for (BusinessDAOIF businessDAO : iterator)
//    {
//      if (AggregateFunctionMasterSetup.floatEqStdDevList.get(loopCount) != Float.parseFloat(businessDAO.getValue("funcFloat")))
//      {
//        fail("Query did not return the expected object.");
//      }
//      loopCount += 1;
...
//      Object queryObject = queryClass.getConstructor(QueryFactory.class).newInstance(factory);
//      Object comQueryObject = comQueryClass.getConstructor(QueryFactory.class).newInstance(factory);
//      AttributeFloatIF attributeFloat = (AttributeFloatIF)queryClass.getMethod("getFuncFloat").invoke(queryObject);
//      AttributeFloatIF comAttributeFloat = (AttributeFloatIF)comQueryClass.getMethod("getComFuncFloat").invoke(comQueryObject);
//      queryClass.getMethod("WHERE", Condition.class).invoke(queryObject, attributeFloat.EQ(new StdDev(comAttributeFloat)));
//      queryClass.getMethod("ORDER_BY", AttributePrimitiveIF.class, OrderBy.SortOrder.class).invoke(queryObject, attributeFloat, OrderBy.SortOrder.ASC);
//      
//      long count = ((Long)(queryClass.getMethod("getCount").invoke(queryObject))).longValue();
//   
//      String errMsg = "Eq than STDDEV() check returned wrong result.";
...
//        objectClass.cast(object);
//        Float floatValue = (Float)objectClass.getMethod("getFuncFloat").invoke(object);
//        if (AggregateFunctionMasterSetup.floatEqStdDevList.get(loopCount) != floatValue.floatValue())
//        {
//          fail("Query did not return the expected object.");
//        }
//        loopCount += 1;
...
//  }
//
//  public void testFloatGtStdDevAttribute()
//  { 
//    QueryFactory factory = new QueryFactory();
//    BusinessDAOQuery query = factory.businessDAOQuery(AggregateFunctionMasterSetup.classQueryInfo.getType());
//    BusinessDAOQuery query2 = factory.businessDAOQuery(AggregateFunctionMasterSetup.comQueryInfo.getType());
//    query.WHERE(query.aFloat("funcFloat").gt(new StdDev(query2.aFloat("comFuncFloat"))));
//    query.ORDER_BY(query.aFloat("funcFloat"), OrderBy.SortOrder.ASC);
//    
//    long count = query.getCount();
//    
//    String errMsg = "Greater than StdDev() check returned wrong result.";
//    assertEquals(errMsg, AggregateFunctionMasterSetup.floatGtStdDevList.size(), count);
//
//    ComponentIterator<BusinessDAOIF> iterator = query.getIterator();
//    
//    int loopCount = 0;
//    for (BusinessDAOIF businessDAO : iterator)
//    {
//      if (AggregateFunctionMasterSetup.floatGtStdDevList.get(loopCount) != Float.parseFloat(businessDAO.getValue("funcFloat")))
//      {
//        fail("Query did not return the expected object.");
//      }
//      loopCount += 1;
...
//      AttributeFloatIF attributeFloat = (AttributeFloatIF)queryClass.getMethod("getFuncFloat").invoke(queryObject);
//      AttributeFloatIF comAttributeFloat = (AttributeFloatIF)comQueryClass.getMethod("getComFuncFloat").invoke(comQueryObject);
//      queryClass.getMethod("WHERE", Condition.class).invoke(queryObject, attributeFloat.gt(new StdDev(comAttributeFloat)));
//      queryClass.getMethod("ORDER_BY", AttributePrimitiveIF.class, OrderBy.SortOrder.class).invoke(queryObject, attributeFloat, OrderBy.SortOrder.ASC);
//      
//      long count = ((Long)(queryClass.getMethod("getCount").invoke(queryObject))).longValue();
//   
...
//        objectClass.cast(object);
//        Float floatValue = (Float)objectClass.getMethod("getFuncFloat").invoke(object);
//        if (AggregateFunctionMasterSetup.floatGtStdDevList.get(loopCount) != floatValue.floatValue())
//        {
//          fail("Query did not return the expected object.");
//        }
//        loopCount += 1;
...
//  }
//
//  public void testFloatGtEqStdDevAttribute()
//  { 
//    QueryFactory factory = new QueryFactory();
//    BusinessDAOQuery query = factory.businessDAOQuery(AggregateFunctionMasterSetup.classQueryInfo.getType());
//    BusinessDAOQuery query2 = factory.businessDAOQuery(AggregateFunctionMasterSetup.comQueryInfo.getType());
//    query.WHERE(query.aFloat("funcFloat").gtEq(new StdDev(query2.aFloat("comFuncFloat"))));
//    query.ORDER_BY(query.aFloat("funcFloat"), OrderBy.SortOrder.ASC);
//    
//    long count = query.getCount();
//
//    String errMsg = "Greater equals than STDDEV() check returned wrong result.";
//    assertEquals(errMsg, AggregateFunctionMasterSetup.floatGtEqStdDevList.size(), count);
//
//    ComponentIterator<BusinessDAOIF> iterator = query.getIterator();
//    
//    int loopCount = 0;
//    for (BusinessDAOIF businessDAO : iterator)
//    {
//      if (AggregateFunctionMasterSetup.floatGtEqStdDevList.get(loopCount) != Float.parseFloat(businessDAO.getValue("funcFloat")))
//      {
//        fail("Query did not return the expected object.");
//      }
//      loopCount += 1;
...
//      AttributeFloatIF attributeFloat = (AttributeFloatIF)queryClass.getMethod("getFuncFloat").invoke(queryObject);
//      AttributeFloatIF comAttributeFloat = (AttributeFloatIF)comQueryClass.getMethod("getComFuncFloat").invoke(comQueryObject);
//      queryClass.getMethod("WHERE", Condition.class).invoke(queryObject, attributeFloat.gtEq(new StdDev(comAttributeFloat)));
//      queryClass.getMethod("ORDER_BY", AttributePrimitiveIF.class, OrderBy.SortOrder.class).invoke(queryObject, attributeFloat, OrderBy.SortOrder.ASC);
//      
//      long count = ((Long)(queryClass.getMethod("getCount").invoke(queryObject))).longValue();
//   
...
//        objectClass.cast(object);
//        Float floatValue = (Float)objectClass.getMethod("getFuncFloat").invoke(object);
//        if (AggregateFunctionMasterSetup.floatGtEqStdDevList.get(loopCount) != floatValue.floatValue())
//        {
//          fail("Query did not return the expected object.");
//        }
//        loopCount += 1;
...
//  }
//
//  public void testFloatLtStdDevAttribute()
//  { 
//    QueryFactory factory = new QueryFactory();
//    BusinessDAOQuery query = factory.businessDAOQuery(AggregateFunctionMasterSetup.classQueryInfo.getType());
//    BusinessDAOQuery query2 = factory.businessDAOQuery(AggregateFunctionMasterSetup.comQueryInfo.getType());
//    query.WHERE(query.aFloat("funcFloat").lt(new StdDev(query2.aFloat("comFuncFloat"))));
//    query.ORDER_BY(query.aFloat("funcFloat"), OrderBy.SortOrder.ASC);
//    
//    long count = query.getCount();
//
//    String errMsg = "Less than STDDEV() check returned wrong result.";
//    assertEquals(errMsg, AggregateFunctionMasterSetup.floatLtStdDevList.size(), count);
//
//    ComponentIterator<BusinessDAOIF> iterator = query.getIterator();
//    
//    int loopCount = 0;
//    for (BusinessDAOIF businessDAO : iterator)
//    {
//      if (AggregateFunctionMasterSetup.floatLtStdDevList.get(loopCount) != Float.parseFloat(businessDAO.getValue("funcFloat")))
//      {
//        fail("Query did not return the expected object.");
//      }
//      loopCount += 1;
...
//      AttributeFloatIF attributeFloat = (AttributeFloatIF)queryClass.getMethod("getFuncFloat").invoke(queryObject);
//      AttributeFloatIF comAttributeFloat = (AttributeFloatIF)comQueryClass.getMethod("getComFuncFloat").invoke(comQueryObject);
//      queryClass.getMethod("WHERE", Condition.class).invoke(queryObject, attributeFloat.lt(new StdDev(comAttributeFloat)));
//      queryClass.getMethod("ORDER_BY", AttributePrimitiveIF.class, OrderBy.SortOrder.class).invoke(queryObject, attributeFloat, OrderBy.SortOrder.ASC);
//      
//      long count = ((Long)(queryClass.getMethod("getCount").invoke(queryObject))).longValue();
//   
...
//        objectClass.cast(object);
//        Float floatValue = (Float)objectClass.getMethod("getFuncFloat").invoke(object);
//        if (AggregateFunctionMasterSetup.floatLtStdDevList.get(loopCount) != floatValue.floatValue())
//        {
//          fail("Query did not return the expected object.");
//        }
//        loopCount += 1;
...
//  }
//
//  public void testFloatLtEqStdDevAttribute()
//  { 
//    QueryFactory factory = new QueryFactory();
//    BusinessDAOQuery query = factory.businessDAOQuery(AggregateFunctionMasterSetup.classQueryInfo.getType());
//    BusinessDAOQuery query2 = factory.businessDAOQuery(AggregateFunctionMasterSetup.comQueryInfo.getType());
//    query.WHERE(query.aFloat("funcFloat").ltEq(new StdDev(query2.aFloat("comFuncFloat"))));
//    query.ORDER_BY(query.aFloat("funcFloat"), OrderBy.SortOrder.ASC);
//    
//    long count = query.getCount();
//
//    String errMsg = "Less than Eq STDDEV() check returned wrong result.";
//    assertEquals(errMsg, AggregateFunctionMasterSetup.floatLtEqStdDevList.size(), count);
//
//    ComponentIterator<BusinessDAOIF> iterator = query.getIterator();
//    
//    int loopCount = 0;
//    for (BusinessDAOIF businessDAO : iterator)
//    {
//      if (AggregateFunctionMasterSetup.floatLtEqStdDevList.get(loopCount) != Float.parseFloat(businessDAO.getValue("funcFloat")))
//      {
//        fail("Query did not return the expected object.");
//      }
//      loopCount += 1;
...
//      AttributeFloatIF attributeFloat = (AttributeFloatIF)queryClass.getMethod("getFuncFloat").invoke(queryObject);
//      AttributeFloatIF comAttributeFloat = (AttributeFloatIF)comQueryClass.getMethod("getComFuncFloat").invoke(comQueryObject);
//      queryClass.getMethod("WHERE", Condition.class).invoke(queryObject, attributeFloat.ltEq(new StdDev(comAttributeFloat)));
//      queryClass.getMethod("ORDER_BY", AttributePrimitiveIF.class, OrderBy.SortOrder.class).invoke(queryObject, attributeFloat, OrderBy.SortOrder.ASC);
//      
//      long count = ((Long)(queryClass.getMethod("getCount").invoke(queryObject))).longValue();
//   
...
//        objectClass.cast(object);
//        Float floatValue = (Float)objectClass.getMethod("getFuncFloat").invoke(object);
//        if (AggregateFunctionMasterSetup.floatLtEqStdDevList.get(loopCount) != floatValue.floatValue())
//        {
//          fail("Query did not return the expected object.");
//        }
//        loopCount += 1;
...
//  }
//  
//  public void testFloatNotEqStdDevAttribute()
//  { 
//    QueryFactory factory = new QueryFactory();
//    BusinessDAOQuery query = factory.businessDAOQuery(AggregateFunctionMasterSetup.classQueryInfo.getType());
//    BusinessDAOQuery query2 = factory.businessDAOQuery(AggregateFunctionMasterSetup.comQueryInfo.getType());
//    query.WHERE(query.aFloat("funcFloat").NE(new StdDev(query2.aFloat("comFuncFloat"))));
//    query.ORDER_BY(query.aFloat("funcFloat"), OrderBy.SortOrder.ASC);
//    
//    long count = query.getCount();
//
//    String errMsg = "Not Eq STDDEV() check returned wrong result.";
//    assertEquals(errMsg, AggregateFunctionMasterSetup.floatNotEqStdDevList.size(), count);
//
//    ComponentIterator<BusinessDAOIF> iterator = query.getIterator();
//    
//    int loopCount = 0;
//    for (BusinessDAOIF businessDAO : iterator)
//    {
//      if (AggregateFunctionMasterSetup.floatNotEqStdDevList.get(loopCount) != Float.parseFloat(businessDAO.getValue("funcFloat")))
//      {
//        fail("Query did not return the expected object.");
//      }
//      loopCount += 1;
...
//      AttributeFloatIF attributeFloat = (AttributeFloatIF)queryClass.getMethod("getFuncFloat").invoke(queryObject);
//      AttributeFloatIF comAttributeFloat = (AttributeFloatIF)comQueryClass.getMethod("getComFuncFloat").invoke(comQueryObject);
//      queryClass.getMethod("WHERE", Condition.class).invoke(queryObject, attributeFloat.NE(new StdDev(comAttributeFloat)));
//      queryClass.getMethod("ORDER_BY", AttributePrimitiveIF.class, OrderBy.SortOrder.class).invoke(queryObject, attributeFloat, OrderBy.SortOrder.ASC);
//      
//      long count = ((Long)(queryClass.getMethod("getCount").invoke(queryObject))).longValue();
//   
...
//        objectClass.cast(object);
//        Float floatValue = (Float)objectClass.getMethod("getFuncFloat").invoke(object);
//        if (AggregateFunctionMasterSetup.floatNotEqStdDevList.get(loopCount) != floatValue.floatValue())
//        {
//          fail("Query did not return the expected object.");
//        }
//        loopCount += 1;
...
//  }
//
//  public void testFloatEqVarianceAttribute()
//  { 
//    QueryFactory factory = new QueryFactory();
//    BusinessDAOQuery query = factory.businessDAOQuery(AggregateFunctionMasterSetup.classQueryInfo.getType());
//    BusinessDAOQuery query2 = factory.businessDAOQuery(AggregateFunctionMasterSetup.comQueryInfo.getType());
//    query.WHERE(query.aFloat("funcFloat").EQ(new Variance(query2.aFloat("comFuncFloat"))));
//    query.ORDER_BY(query.aFloat("funcFloat"), OrderBy.SortOrder.ASC);
//    
//    long count = query.getCount();
//
//    String errMsg = "Eq than VARIANCE() check returned wrong result.";
//    assertEquals(errMsg, AggregateFunctionMasterSetup.floatEqVarianceList.size(), count);
//    
//    ComponentIterator<BusinessDAOIF> iterator = query.getIterator();
//    
//    int loopCount = 0;
//    for (BusinessDAOIF businessDAO : iterator)
//    {
//      if (AggregateFunctionMasterSetup.floatEqVarianceList.get(loopCount) != Float.parseFloat(businessDAO.getValue("funcFloat")))
//      {
//        fail("Query did not return the expected object.");
//      }
//      loopCount += 1;
...
//      AttributeFloatIF attributeFloat = (AttributeFloatIF)queryClass.getMethod("getFuncFloat").invoke(queryObject);
//      AttributeFloatIF comAttributeFloat = (AttributeFloatIF)comQueryClass.getMethod("getComFuncFloat").invoke(comQueryObject);
//      queryClass.getMethod("WHERE", Condition.class).invoke(queryObject, attributeFloat.EQ(new Variance(comAttributeFloat)));
//      queryClass.getMethod("ORDER_BY", AttributePrimitiveIF.class, OrderBy.SortOrder.class).invoke(queryObject, attributeFloat, OrderBy.SortOrder.ASC);
//      
//      long count = ((Long)(queryClass.getMethod("getCount").invoke(queryObject))).longValue();
//   
...
//        objectClass.cast(object);
//        Float floatValue = (Float)objectClass.getMethod("getFuncFloat").invoke(object);
//        if (AggregateFunctionMasterSetup.floatEqVarianceList.get(loopCount) != floatValue.floatValue())
//        {
//          fail("Query did not return the expected object.");
//        }
//        loopCount += 1;
...
//  }
//
//  public void testFloatGtVarianceAttribute()
//  { 
//    QueryFactory factory = new QueryFactory();
//    BusinessDAOQuery query = factory.businessDAOQuery(AggregateFunctionMasterSetup.classQueryInfo.getType());
//    BusinessDAOQuery query2 = factory.businessDAOQuery(AggregateFunctionMasterSetup.comQueryInfo.getType());
//    query.WHERE(query.aFloat("funcFloat").gt(new Variance(query2.aFloat("comFuncFloat"))));
//    query.ORDER_BY(query.aFloat("funcFloat"), OrderBy.SortOrder.ASC);
//    
//    long count = query.getCount();
//    
//    String errMsg = "Greater than Variance() check returned wrong result.";
//    assertEquals(errMsg, AggregateFunctionMasterSetup.floatGtVarianceList.size(), count);
//
//    ComponentIterator<BusinessDAOIF> iterator = query.getIterator();
//    
//    int loopCount = 0;
//    for (BusinessDAOIF businessDAO : iterator)
//    {
//      if (AggregateFunctionMasterSetup.floatGtVarianceList.get(loopCount) != Float.parseFloat(businessDAO.getValue("funcFloat")))
//      {
//        fail("Query did not return the expected object.");
//      }
//      loopCount += 1;
...
//      AttributeFloatIF attributeFloat = (AttributeFloatIF)queryClass.getMethod("getFuncFloat").invoke(queryObject);
//      AttributeFloatIF comAttributeFloat = (AttributeFloatIF)comQueryClass.getMethod("getComFuncFloat").invoke(comQueryObject);
//      queryClass.getMethod("WHERE", Condition.class).invoke(queryObject, attributeFloat.gt(new Variance(comAttributeFloat)));
//      queryClass.getMethod("ORDER_BY", AttributePrimitiveIF.class, OrderBy.SortOrder.class).invoke(queryObject, attributeFloat, OrderBy.SortOrder.ASC);
//      
//      long count = ((Long)(queryClass.getMethod("getCount").invoke(queryObject))).longValue();
//   
...
//        objectClass.cast(object);
//        Float floatValue = (Float)objectClass.getMethod("getFuncFloat").invoke(object);
//        if (AggregateFunctionMasterSetup.floatGtVarianceList.get(loopCount) != floatValue.floatValue())
//        {
//          fail("Query did not return the expected object.");
//        }
//        loopCount += 1;
...
//  }
//
//  public void testFloatGtEqVarianceAttribute()
//  { 
//    QueryFactory factory = new QueryFactory();
//    BusinessDAOQuery query = factory.businessDAOQuery(AggregateFunctionMasterSetup.classQueryInfo.getType());
//    BusinessDAOQuery query2 = factory.businessDAOQuery(AggregateFunctionMasterSetup.comQueryInfo.getType());
//    query.WHERE(query.aFloat("funcFloat").gtEq(new Variance(query2.aFloat("comFuncFloat"))));
//    query.ORDER_BY(query.aFloat("funcFloat"), OrderBy.SortOrder.ASC);
//    
//    long count = query.getCount();
//
//    String errMsg = "Greater equals than VARIANCE() check returned wrong result.";
//    assertEquals(errMsg, AggregateFunctionMasterSetup.floatGtEqVarianceList.size(), count);
//
//    ComponentIterator<BusinessDAOIF> iterator = query.getIterator();
//    
//    int loopCount = 0;
//    for (BusinessDAOIF businessDAO : iterator)
//    {
//      if (AggregateFunctionMasterSetup.floatGtEqVarianceList.get(loopCount) != Float.parseFloat(businessDAO.getValue("funcFloat")))
//      {
//        fail("Query did not return the expected object.");
//      }
//      loopCount += 1;
...
//      AttributeFloatIF attributeFloat = (AttributeFloatIF)queryClass.getMethod("getFuncFloat").invoke(queryObject);
//      AttributeFloatIF comAttributeFloat = (AttributeFloatIF)comQueryClass.getMethod("getComFuncFloat").invoke(comQueryObject);
//      queryClass.getMethod("WHERE", Condition.class).invoke(queryObject, attributeFloat.gtEq(new Variance(comAttributeFloat)));
//      queryClass.getMethod("ORDER_BY", AttributePrimitiveIF.class, OrderBy.SortOrder.class).invoke(queryObject, attributeFloat, OrderBy.SortOrder.ASC);
//      
//      long count = ((Long)(queryClass.getMethod("getCount").invoke(queryObject))).longValue();
//   
...
//        objectClass.cast(object);
//        Float floatValue = (Float)objectClass.getMethod("getFuncFloat").invoke(object);
//        if (AggregateFunctionMasterSetup.floatGtEqVarianceList.get(loopCount) != floatValue.floatValue())
//        {
//          fail("Query did not return the expected object.");
//        }
//        loopCount += 1;
...
//  }
//
//  public void testFloatLtVarianceAttribute()
//  { 
//    QueryFactory factory = new QueryFactory();
//    BusinessDAOQuery query = factory.businessDAOQuery(AggregateFunctionMasterSetup.classQueryInfo.getType());
//    BusinessDAOQuery query2 = factory.businessDAOQuery(AggregateFunctionMasterSetup.comQueryInfo.getType());
//    query.WHERE(query.aFloat("funcFloat").lt(new Variance(query2.aFloat("comFuncFloat"))));
//    query.ORDER_BY(query.aFloat("funcFloat"), OrderBy.SortOrder.ASC);
//    
//    long count = query.getCount();
//
//    String errMsg = "Less than VARIANCE() check returned wrong result.";
//    assertEquals(errMsg, AggregateFunctionMasterSetup.floatLtVarianceList.size(), count);
//
//    ComponentIterator<BusinessDAOIF> iterator = query.getIterator();
//    
//    int loopCount = 0;
//    for (BusinessDAOIF businessDAO : iterator)
//    {
//      if (AggregateFunctionMasterSetup.floatLtVarianceList.get(loopCount) != Float.parseFloat(businessDAO.getValue("funcFloat")))
//      {
//        fail("Query did not return the expected object.");
//      }
//      loopCount += 1;
...
//      AttributeFloatIF attributeFloat = (AttributeFloatIF)queryClass.getMethod("getFuncFloat").invoke(queryObject);
//      AttributeFloatIF comAttributeFloat = (AttributeFloatIF)comQueryClass.getMethod("getComFuncFloat").invoke(comQueryObject);
//      queryClass.getMethod("WHERE", Condition.class).invoke(queryObject, attributeFloat.lt(new Variance(comAttributeFloat)));
//      queryClass.getMethod("ORDER_BY", AttributePrimitiveIF.class, OrderBy.SortOrder.class).invoke(queryObject, attributeFloat, OrderBy.SortOrder.ASC);
//      
//      long count = ((Long)(queryClass.getMethod("getCount").invoke(queryObject))).longValue();
//   
...
//        objectClass.cast(object);
//        Float floatValue = (Float)objectClass.getMethod("getFuncFloat").invoke(object);
//        if (AggregateFunctionMasterSetup.floatLtVarianceList.get(loopCount) != floatValue.floatValue())
//        {
//          fail("Query did not return the expected object.");
//        }
//        loopCount += 1;
...
//  }
//
//  public void testFloatLtEqVarianceAttribute()
//  { 
//    QueryFactory factory = new QueryFactory();
//    BusinessDAOQuery query = factory.businessDAOQuery(AggregateFunctionMasterSetup.classQueryInfo.getType());
//    BusinessDAOQuery query2 = factory.businessDAOQuery(AggregateFunctionMasterSetup.comQueryInfo.getType());
//    query.WHERE(query.aFloat("funcFloat").ltEq(new Variance(query2.aFloat("comFuncFloat"))));
//    query.ORDER_BY(query.aFloat("funcFloat"), OrderBy.SortOrder.ASC);
//    
//    long count = query.getCount();
//
//    String errMsg = "Less than Eq VARIANCE() check returned wrong result.";
//    assertEquals(errMsg, AggregateFunctionMasterSetup.floatLtEqVarianceList.size(), count);
//
//    ComponentIterator<BusinessDAOIF> iterator = query.getIterator();
//    
//    int loopCount = 0;
//    for (BusinessDAOIF businessDAO : iterator)
//    {
//      if (AggregateFunctionMasterSetup.floatLtEqVarianceList.get(loopCount) != Float.parseFloat(businessDAO.getValue("funcFloat")))
//      {
//        fail("Query did not return the expected object.");
//      }
//      loopCount += 1;
...
//      AttributeFloatIF attributeFloat = (AttributeFloatIF)queryClass.getMethod("getFuncFloat").invoke(queryObject);
//      AttributeFloatIF comAttributeFloat = (AttributeFloatIF)comQueryClass.getMethod("getComFuncFloat").invoke(comQueryObject);
//      queryClass.getMethod("WHERE", Condition.class).invoke(queryObject, attributeFloat.ltEq(new Variance(comAttributeFloat)));
//      queryClass.getMethod("ORDER_BY", AttributePrimitiveIF.class, OrderBy.SortOrder.class).invoke(queryObject, attributeFloat, OrderBy.SortOrder.ASC);
//      
//      long count = ((Long)(queryClass.getMethod("getCount").invoke(queryObject))).longValue();
//   
...
//        objectClass.cast(object);
//        Float floatValue = (Float)objectClass.getMethod("getFuncFloat").invoke(object);
//        if (AggregateFunctionMasterSetup.floatLtEqVarianceList.get(loopCount) != floatValue.floatValue())
//        {
//          fail("Query did not return the expected object.");
//        }
//        loopCount += 1;
...
//  }
//  
//  public void testFloatNotEqVarianceAttribute()
//  { 
//    QueryFactory factory = new QueryFactory();
//    BusinessDAOQuery query = factory.businessDAOQuery(AggregateFunctionMasterSetup.classQueryInfo.getType());
//    BusinessDAOQuery query2 = factory.businessDAOQuery(AggregateFunctionMasterSetup.comQueryInfo.getType());
//    query.WHERE(query.aFloat("funcFloat").NE(new Variance(query2.aFloat("comFuncFloat"))));
//    query.ORDER_BY(query.aFloat("funcFloat"), OrderBy.SortOrder.ASC);
//    
//    long count = query.getCount();
//
//    String errMsg = "Not Eq VARIANCE() check returned wrong result.";
//    assertEquals(errMsg, AggregateFunctionMasterSetup.floatNotEqVarianceList.size(), count);
//
//    ComponentIterator<BusinessDAOIF> iterator = query.getIterator();
//    
//    int loopCount = 0;
//    for (BusinessDAOIF businessDAO : iterator)
//    {
//      if (AggregateFunctionMasterSetup.floatNotEqVarianceList.get(loopCount) != Float.parseFloat(businessDAO.getValue("funcFloat")))
//      {
//        fail("Query did not return the expected object.");
//      }
//      loopCount += 1;
...
//      AttributeFloatIF attributeFloat = (AttributeFloatIF)queryClass.getMethod("getFuncFloat").invoke(queryObject);
//      AttributeFloatIF comAttributeFloat = (AttributeFloatIF)comQueryClass.getMethod("getComFuncFloat").invoke(comQueryObject);
//      queryClass.getMethod("WHERE", Condition.class).invoke(queryObject, attributeFloat.NE(new Variance(comAttributeFloat)));
//      queryClass.getMethod("ORDER_BY", AttributePrimitiveIF.class, OrderBy.SortOrder.class).invoke(queryObject, attributeFloat, OrderBy.SortOrder.ASC);
//      
//      long count = ((Long)(queryClass.getMethod("getCount").invoke(queryObject))).longValue();
//   
...
//        objectClass.cast(object);
//        Float floatValue = (Float)objectClass.getMethod("getFuncFloat").invoke(object);
//        if (AggregateFunctionMasterSetup.floatNotEqVarianceList.get(loopCount) != floatValue.floatValue())
//        {
//          fail("Query did not return the expected object.");
//        }
//        loopCount += 1;
