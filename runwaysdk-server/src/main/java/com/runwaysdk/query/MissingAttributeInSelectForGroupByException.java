...
public class MissingAttributeInSelectForGroupByException extends InvalidSelectableException
{
  /**
   *
   */
  private static final long serialVersionUID = 5169879180966513492L;

  /**
   * Constructs a new <code>MissingAttributeInSelectForGroupByException</code> with the specified developer message
   ...
   * @param _selectable
   */
  public MissingAttributeInSelectForGroupByException(String devMessage, Selectable _selectable)
  {
   ...
   * @param _selectable
   */
  public MissingAttributeInSelectForGroupByException(String devMessage, Throwable cause, Selectable _selectable)
  {
   ...
   * @param _selectable
   */
  public MissingAttributeInSelectForGroupByException(Throwable cause, Selectable _selectable)
  {
  ...
  {
    return ServerExceptionMessageLocalizer.missingAttributeInSelectForGroupByException(this.getLocale(), this.getMdAttributeConcreteDAOIF().getDisplayLabel(this.getLocale()));
  }
}
