 ...
 *
 */
public class MdAttributeStruct_E extends MdAttributeConcrete_E
{
  /**
   * Generated by Eclipse
   */
  private static final long serialVersionUID = 5594967774390319772L;

  /**
   * @param mdAttribute
   */
  public MdAttributeStruct_E(MdAttributeConcreteDAO mdAttribute)
  {
    super(mdAttribute);
  }
  ...
  /**
   * struct attributes must reference only standalone classes.
   *
   */
  private void validateNew()
  {
    MdEntityDAOIF definingEntity = this.definedByClass();
    if (definingEntity instanceof MdStructDAOIF)
    {
      String errMsg = "Struct [" + definingEntity.definesType()
          + "] cannot have a struct attribute.";
      throw new AttributeOfWrongTypeForClassException(errMsg, this.getMdAttribute(), definingEntity);
    }
  }
