...
import com.runwaysdk.form.web.JSONFormVisitor.WebAttributeToJSON;
...
public class GISJSONVisitorBuilders implements JSONFormVisitor.PluginIF
{
  ...
  private static class WebPointToJSON extends WebAttributeToJSON
  {
    ...
    public WebPointToJSON(WebPoint webAttribute, JSONFormVisitor visitor)
    {
