...
/**
 * Describes an Attribute UUID.
 */
public class AttributeUUIDDTO extends AttributeDTO
{
   ...
   * @param modified
   */
  protected AttributeUUIDDTO(String name, String value, boolean readable, boolean writable, boolean modified)
  {
  ...
  {
	AttributeUUIDDTO clone = (AttributeUUIDDTO) super.clone();
  ...
  @Override
  public AttributeUUIDMdDTO getAttributeMdDTO()
  {
    return (AttributeUUIDMdDTO) super.getAttributeMdDTO();
  }
}
