...
public class RMIInvokeMethodTest extends InvokeMethodTest
{
  ...
  {
    junit.textui.TestRunner.run(RMIInvokeMethodTest.suite());
  }
  ...
  public static Test suite()
  {
    ...
    TestSetup wrapper = new TestSetup(suite)
    {
      protected void setUp()
      {
        ...
        classSetUp();
        noPermissionSession =
          ClientSession.createUserSession("rmiDefault", "smethie", "aaa", new Locale[]{CommonProperties.getDefaultLocale()});
