...
public class ParameterDefinitionException_InvalidType extends ParameterDefinitionException
{
  /**
   * 
   */
  private static final long serialVersionUID = 8195524949159722952L;
   ...
   */
  public ParameterDefinitionException_InvalidType(String devMessage, MdParameterDAOIF mdParameter, ParameterMarker marker)
  {
   ...
   *          Metadata containing the invalid parameter definition.
   * @param marker
   *          Metadata containing the invalid method or action definition.
   */
  public ParameterDefinitionException_InvalidType(String devMessage, Throwable cause, MdParameterDAOIF mdParameter, ParameterMarker marker)
  {
   ...
   *          Metadata containing the invalid method or action definition.
   */
  public ParameterDefinitionException_InvalidType(Throwable cause, MdParameterDAOIF mdParameter, ParameterMarker marker)
  {
