...
@com.runwaysdk.business.ClassSignature(hash = -1811741188)
public abstract class HasLayerDTOBase extends com.runwaysdk.business.RelationshipDTO
{
  ...
  */
  protected HasLayerDTOBase(com.runwaysdk.business.RelationshipDTO relationshipDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  public final static java.lang.String LAYERINDEX = "layerIndex";
  ...
  {
    return com.runwaysdk.constants.MdAttributeIntegerUtil.getTypeSafeValue(getValue(LAYERINDEX));
  }
  
  public void setLayerIndex(Integer value)
  {
    if(value == null)
    {
      setValue(LAYERINDEX, "");
    ...
    {
      setValue(LAYERINDEX, java.lang.Integer.toString(value));
    }
  }
  
  public boolean isLayerIndexWritable()
  {
    return isWritable(LAYERINDEX);
  }
  
  public boolean isLayerIndexReadable()
  {
    return isReadable(LAYERINDEX);
  }
  
  public boolean isLayerIndexModified()
  {
    return isModified(LAYERINDEX);
  }
  
  public final com.runwaysdk.transport.metadata.AttributeNumberMdDTO getLayerIndexMd()
  {
    return (com.runwaysdk.transport.metadata.AttributeNumberMdDTO) getAttributeDTO(LAYERINDEX).getAttributeMdDTO();
  }
  ...
  {
    return (com.runwaysdk.system.gis.mapping.HasLayerQueryDTO) clientRequest.getAllInstances(com.runwaysdk.system.gis.mapping.HasLayerDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
