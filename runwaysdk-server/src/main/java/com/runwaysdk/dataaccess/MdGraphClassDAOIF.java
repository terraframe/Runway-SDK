...
public interface MdGraphClassDAOIF extends MdClassDAOIF
{
  ...
  /**
   * Returns the {@link MdGraphClassDAOIF} that is the root of the hierarchy
   * that this type belongs to. returns a reference to itself if it is the root.
   *
   * @return {@link MdGraphClassDAOIF} that is the root of the hierarchy that
   *         this type belongs to. returns a reference to itself if it is the
   *         root.
   */
  public abstract MdGraphClassDAOIF getRootMdClassDAO();

  /**
   * Returns an array of {@link MdGraphClassDAOIF} that defines immediate
   * subclasses of this class.
   * 
   * @return an array of {@link MdGraphClassDAOIF} that defines immediate
   *         subclasses of this class.
   */
  public List<? extends MdGraphClassDAOIF> getSubClasses();

  /**
   * Returns a list of {@link MdGraphClassDAOIF} objects that are subclasses of
   * the given entity. Only non abstract entities are returned (i.e. entities
   * that can be instantiated)
   * 
   * @return list of {@link MdGraphClassDAOIF} objects that are subclasses of
   *         the given entity. Only non abstract entities are returned (i.e.
   ...
   *         that are subclasses of the given entity, including all recursive
   *         entities.
   */
  public List<? extends MdGraphClassDAOIF> getAllSubClasses();

  /**
   * Returns an {@link MdGraphClassDAOIF} representing the super class of this
   * class, or null if it does not have one.
   * 
   * @return an {@link MdGraphClassDAOIF} representing the super class of this
   *         class, or null if it does not have one.
   */
   ...
   * parent of this {@link MdGraphClassDAOIF} partaking in an inheritance
   * relationship.
   * 
   * @return a list of {@link MdGraphClassDAOIF} instances that are parents of
   *         this class.
   */
