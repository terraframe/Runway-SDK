...
public class InnerJoinLtEq extends InnerJoin
{
   ...
   */
  public InnerJoinLtEq(String columnName1, String tableName1, String tableAlias1, String columnName2, String tableName2, String tableAlias2)
  {
   ...
   * @param selectable2
   */
  public InnerJoinLtEq(Selectable selectable1, Selectable selectable2)
  {
