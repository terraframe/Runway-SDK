...
public class DocToViewDTO extends DocToSessionComponentDTO
{
   ...
   */
  public DocToViewDTO(ClientRequestIF clientRequest, Element rootElement)
  {
  ...
  /**
   * Instantiates the proper viewDTO class (not type safe)
   * @param type
   * @param attributeMap
   * @param newInstance
   * @param readable
   * @param writable
   * @param modified
   * @return proper viewDTO class (not type safe)
   */
  protected ViewDTO factoryMethod(String type, Map<String, AttributeDTO> attributeMap,
      boolean newInstance, boolean readable, boolean writable, boolean modified)
  {
    try
    {
      ...
      return ComponentDTOFacade.buildViewDTO(this.clientRequest, type, attributeMap,
