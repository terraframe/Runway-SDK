...
public class RelationshipQueryDTOGenerator extends EntityQueryDTOGenerator
{
  /**
   * 
   * @param mdEntityIF
   */
  public RelationshipQueryDTOGenerator(MdRelationshipDAOIF mdRelationshipIF)
  {
  ...
  protected void addExtends(MdClassDAOIF parentMdClassIF)
  {
    ...
    {
      writeLine(srcBuffer, RelationshipQueryDTO.class.getName());
    }
    else
    {
