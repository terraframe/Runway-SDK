...
import com.runwaysdk.constants.TermRelationshipDTOInfo;
 ...
 * License along with Runway SDK(tm).  If not, see <http://www.gnu.org/licenses/>.
 ******************************************************************************/
public class TermRelationshipJSGenerator extends RelationshipJSGenerator
{
  public TermRelationshipJSGenerator(String sessionId, MdRelationshipDAOIF mdRelationshipIF)
  {
  ...
  protected String getParent()
  {
    ...
    if(superEntity == null)
    {
      return TermRelationshipDTOInfo.CLASS;
    }
    else
    {
