...
/**
 * Contains static properties for operation of the core with Oracle. Login info is
 * specified in database.properties. Typical default values for logging in to Oracle are:
 * <pre>
 * port=1521
 * databaseName=orcl
 * user=runway
...
public class Oracle extends ListResourceBundle
{
  ...
  static final Object[][] contents =
  {
    ...
    { "dbErrorCodes", "" },
    { "seriousDBErrorCodes", "" },
    { "databaseClass", com.runwaysdk.dataaccess.database.general.Oracle.class.getName() },
  };
