...
public class AttributeFactory
{
   ...
   *
   * <br/><b>Precondition:</b>  mdAttributeIF != null
   * <br/><b>Precondition:</b>  !mdAttributeIF.trim().equals("")
   ...
   *
   * @param useCache true if when this is called the cache has been initialized.
   ...
   */
  public static Attribute createAttribute(MdAttributeConcreteDAOIF mdAttributeIF, String attributeName,
  ...
  public static interface PluginIF
  {
    ...
    public Attribute createAttribute(MdAttributeConcreteDAOIF mdAttributeIF, String attributeName,
        String definingType, Object attributeValue,
        Set<MdAttributeConcreteDAOIF> entityMdAttributeIFlist);
  }
}
