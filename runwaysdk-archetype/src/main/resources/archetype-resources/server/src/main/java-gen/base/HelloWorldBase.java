...
@com.runwaysdk.business.ClassSignature(hash = -1438390608)
/**
 ...
 */
public abstract class HelloWorldBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.
{
  ...
  private static final long serialVersionUID = -1438390608;
  ...
  {
    this.validateAttribute(GREETING);
  }
  
  public static com.runwaysdk.dataaccess.MdAttributeDAOIF getGreetingMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(${package}.HelloWorld.CLASS);
    return mdClassIF.definesAttribute(GREETING);
  }
  ...
  public static HelloWorldQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    HelloWorldQuery query = new HelloWorldQuery(new com.runwaysdk.query.QueryFactory());
  ...
  {
    return (HelloWorld) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static ${package}.HelloWorld generateRandom()
  {
    String msg = "This method should never be invoked.  It should be overwritten in ${package}.HelloWorld.java";
