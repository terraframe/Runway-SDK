...
public class HasPrimitiveRuleController extends HasPrimitiveRuleControllerBase
{
  public static final String JSP_DIR = "/WEB-INF/com/runwaysdk/system/gis/mapping/HasPrimitiveRule/";
  public static final String LAYOUT = "WEB-INF/templates/layout.jsp";
  
  public HasPrimitiveRuleController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  public void childQuery(java.lang.String childId) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    com.runwaysdk.system.gis.mapping.HasPrimitiveRuleQueryDTO query = com.runwaysdk.system.gis.mapping.HasPrimitiveRuleDTO.childQuery(clientRequest, childId);
  ...
  {
    com.runwaysdk.system.gis.mapping.HasPrimitiveRuleDTO dto = com.runwaysdk.system.gis.mapping.HasPrimitiveRuleDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.gis.mapping.HasPrimitiveRuleDTO dto = new com.runwaysdk.system.gis.mapping.HasPrimitiveRuleDTO(clientRequest, parentId, childId);
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  {
    req.setAttribute("parentList", com.runwaysdk.system.gis.mapping.CompositeRuleDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("childList", com.runwaysdk.system.gis.mapping.PrimitiveRuleDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.gis.mapping.HasPrimitiveRuleQueryDTO query = com.runwaysdk.system.gis.mapping.HasPrimitiveRuleDTO.parentQuery(clientRequest, parentId);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", com.runwaysdk.system.gis.mapping.HasPrimitiveRuleDTO.get(clientRequest, id));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.gis.mapping.HasPrimitiveRuleQueryDTO query = com.runwaysdk.system.gis.mapping.HasPrimitiveRuleDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.gis.mapping.HasPrimitiveRuleQueryDTO query = com.runwaysdk.system.gis.mapping.HasPrimitiveRuleDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
