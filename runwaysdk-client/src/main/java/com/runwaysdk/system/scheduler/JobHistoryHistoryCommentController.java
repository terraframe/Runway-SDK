...
public class JobHistoryHistoryCommentController extends JobHistoryHistoryCommentControllerBase
{
  public static final String JSP_DIR = "/WEB-INF/com/runwaysdk/system/scheduler/JobHistoryHistoryComment/";
  public static final String LAYOUT = "WEB-INF/templates/layout.jsp";
  
  public JobHistoryHistoryCommentController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  {
    com.runwaysdk.system.scheduler.JobHistoryHistoryCommentDTO dto = com.runwaysdk.system.scheduler.JobHistoryHistoryCommentDTO.get(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    com.runwaysdk.system.scheduler.JobHistoryHistoryCommentDTO dto = new com.runwaysdk.system.scheduler.JobHistoryHistoryCommentDTO(clientRequest);
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", com.runwaysdk.system.scheduler.JobHistoryHistoryCommentDTO.get(clientRequest, id));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.scheduler.JobHistoryHistoryCommentQueryDTO query = com.runwaysdk.system.scheduler.JobHistoryHistoryCommentDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.system.scheduler.JobHistoryHistoryCommentQueryDTO query = com.runwaysdk.system.scheduler.JobHistoryHistoryCommentDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
