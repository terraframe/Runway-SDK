...
@com.runwaysdk.business.ClassSignature(hash = 2021191395)
public abstract class JobHistoryHistoryCommentDTOBase extends com.runwaysdk.business.LocalStructDTO
{
  ...
  private static final long serialVersionUID = 2021191395;
  ...
  */
  protected JobHistoryHistoryCommentDTOBase(com.runwaysdk.business.LocalStructDTO structDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  {
    return (com.runwaysdk.system.scheduler.JobHistoryHistoryCommentQueryDTO) clientRequest.getAllInstances(com.runwaysdk.system.scheduler.JobHistoryHistoryCommentDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
