...
public class MdAttributeClob_SQL extends MdAttributePrimitive_SQL implements MdAttributeClobDAOIF
{

  /**
   *
   */
  private static final long serialVersionUID = 8479569967651567630L;
   ...
   * @param displayLabel
   */
  public MdAttributeClob_SQL(String attributeName, String displayLabel)
  {
