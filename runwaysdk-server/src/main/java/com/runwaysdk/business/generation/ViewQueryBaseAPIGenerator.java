...
public class ViewQueryBaseAPIGenerator extends ComponentQueryAPIGenerator
{
  ...
  /**
   * Returns the name of the class that implements the custom query base API for the given type.
   * @param mdViewIF
   * @return name of the class that implements the custom query base API for the given type.
   */
  ...
  /**
   * Returns the qualified name of the class that implements the custom query base API for the given type.
   * @param mdViewIF
   * @return qualified name of the class that implements the custom query base API for the given type.
   */
  ...
  /**
   * Returns the qualified name of the class that implements the custom Iterator for the given type.
   * @param type
   * @return qualified name of the class that implements the custom Iterator for the given type.
    */
  ...
  public void go(boolean forceRegeneration)
  {
    ...
    if (LocalProperties.isKeepBaseSource() &&
        AbstractGenerator.hashEquals(this.getSerialVersionUID(), TypeGenerator.getBaseQueryAPIsourceFilePath(this.getMdClassIF())))
    {
      return;
    }
