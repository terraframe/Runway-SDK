...
//    RUNWAY_DTO_EXCEPTION(RUNWAY_DTO.getLabel()+".Exception"),
    ...
    /**
     * property denoting what type of DTO this is. We require this because
     * the JSON strings come into the controllers type-unsafe. Therefore, we
     * require a string to perform a comparison against to detect what kind of DTO
     * we're dealing with (i.e., BUSINESS_DTO, RELATIONSHIP_DTO, ENUM_DTO)
     */
    DTO_TYPE("dto_type"),
