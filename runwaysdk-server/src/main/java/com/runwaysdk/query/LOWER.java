...
public class LOWER extends StringFunction
{
   ...
   */
  protected LOWER(Selectable selectable)
  {
   ...
   */
  protected LOWER(Selectable selectable, String userDefinedAlias, String userDefinedDisplayLabel)
  {
  ...
  {
    return Database.buildLowerCaseFunctionCall(this.selectable.getSQL());
  }
  ...
  public LOWER clone() throws CloneNotSupportedException
  {
    return (LOWER)super.clone();
  }
}
