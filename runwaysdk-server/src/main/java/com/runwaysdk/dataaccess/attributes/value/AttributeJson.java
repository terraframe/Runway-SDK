...
public class AttributeJson extends Attribute
{
   ...
   */
  protected AttributeJson(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
    super(name, value, definingEntityType, mdAttributeIF, entityMdAttributeIFset);
  }

  /**
   * Returns the {@link MdAttributeJsonDAOIF} that defines the this attribute.
   *
   * <br>
   ...
   */
  public MdAttributeJsonDAOIF getMdAttribute()
  {
    return (MdAttributeJsonDAOIF)super.getMdAttribute();
  }
}
