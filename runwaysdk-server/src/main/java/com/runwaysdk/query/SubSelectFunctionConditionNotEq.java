...
public class SubSelectFunctionConditionNotEq extends SubSelectFunctionCondition
{
  /**
   ...
   */
  public SubSelectFunctionConditionNotEq(Selectable attributeLeft, SelectableAggregate selectableAggregate)
  {
   ...
   */
  public SubSelectFunctionConditionNotEq(Selectable attributeLeft, SelectableAggregate selectableAggregate, boolean ignoreCase)
  {
