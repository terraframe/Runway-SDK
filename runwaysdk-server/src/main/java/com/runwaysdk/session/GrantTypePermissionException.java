...
public class GrantTypePermissionException extends PermissionException
{
   ...
   *
   */
  private static final long serialVersionUID = 5453358567478529855L;
   ...
   * @param mdTypeIF
   *          Type that the user does not have permission to grant permissions on.
   * @param user
  ...
  {
    return ServerExceptionMessageLocalizer.grantTypePermissionException(this.getLocale(), this.getMdType());
  }
}
