...
public abstract class MdActionDTOBase extends com.runwaysdk.system.metadata.MetadataDTO
{
  ...
  */
  ...
  public void setEnclosingMdController(com.runwaysdk.system.metadata.MdControllerDTO value)
  {
    ...
    {
      setValue(ENCLOSINGMDCONTROLLER, value.getOid());
    }
  }
  ...
  {
    return (java.util.List<? extends com.runwaysdk.system.metadata.MdControllerDTO>) getRequest().getParents(this.getOid(), com.runwaysdk.system.ControllerActionDTO.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public static java.util.List<? extends com.runwaysdk.system.metadata.MdControllerDTO> getAllMdContoller(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String oid)
  {
    return (java.util.List<? extends com.runwaysdk.system.metadata.MdControllerDTO>) clientRequestIF.getParents(oid, com.runwaysdk.system.ControllerActionDTO.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public java.util.List<? extends com.runwaysdk.system.ControllerActionDTO> getAllMdContollerRelationships()
  {
    return (java.util.List<? extends com.runwaysdk.system.ControllerActionDTO>) getRequest().getParentRelationships(this.getOid(), com.runwaysdk.system.ControllerActionDTO.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public static java.util.List<? extends com.runwaysdk.system.ControllerActionDTO> getAllMdContollerRelationships(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String oid)
  {
    return (java.util.List<? extends com.runwaysdk.system.ControllerActionDTO>) clientRequestIF.getParentRelationships(oid, com.runwaysdk.system.ControllerActionDTO.CLASS);
  }
  
  public com.runwaysdk.system.ControllerActionDTO addMdContoller(com.runwaysdk.system.metadata.MdControllerDTO parent)
  {
    return (com.runwaysdk.system.ControllerActionDTO) getRequest().addParent(parent.getOid(), this.getOid(), com.runwaysdk.system.ControllerActionDTO.CLASS);
  }
  
  public static com.runwaysdk.system.ControllerActionDTO addMdContoller(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String oid, com.runwaysdk.system.metadata.MdControllerDTO parent)
  {
    return (com.runwaysdk.system.ControllerActionDTO) clientRequestIF.addParent(parent.getOid(), oid, com.runwaysdk.system.ControllerActionDTO.CLASS);
  }
  ...
  {
    getRequest().deleteParents(this.getOid(), com.runwaysdk.system.ControllerActionDTO.CLASS);
  }
  
  public static void removeAllMdContoller(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String oid)
  {
    clientRequestIF.deleteParents(oid, com.runwaysdk.system.ControllerActionDTO.CLASS);
  }
  
  public static com.runwaysdk.system.metadata.MdActionDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String oid)
  {
  ...
  public static com.runwaysdk.system.metadata.MdActionDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String oid)
  {
  ...
  public static com.runwaysdk.system.metadata.MdActionDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String oid)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{oid};
