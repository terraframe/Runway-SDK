...
public class AttributeDateTime extends AttributeMoment
{
   ...
   * 
   */
  private static final long serialVersionUID = -7482088002302827309L;
   ...
   */
  protected AttributeDateTime(String name, String mdAttributeKey, String definingTransientType)
  {
   ...
   */
  protected AttributeDateTime(String name, String mdAttributeKey, String definingTransientType, String value)
  {
    super(name, mdAttributeKey, definingTransientType, value);
    
    this.value = com.runwaysdk.dataaccess.attributes.entity.AttributeTime.removeMillisecondDelimiter(value);
  }
   ...
   * 
   * @return MdAttributeDateTimeDAOIF that defines the this attribute
   */
  ...
  protected void validate(String valueToValidate, MdAttributeDAOIF mdAttribute)
  {
    ...
    if (!com.runwaysdk.dataaccess.attributes.entity.AttributeDateTime.isValid(valueToValidate))
    {
