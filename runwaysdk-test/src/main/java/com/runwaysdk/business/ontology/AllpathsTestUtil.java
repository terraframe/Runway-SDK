...
//          Assert.fail("Test AllPaths data exists between parent [" + parentName + "] and child [" + childName + "].");
        }
      }
    }
    else
...
//          "inner join alphabet_display_label child_dl on child_dl.id = child.display_label\n" + 
//          "inner join alphabet parent on ap.parent_term = parent.id\n" + 
//          "inner join alphabet_display_label parent_dl on parent_dl.id = parent.display_label\n" + 
//          "where\n" + 
