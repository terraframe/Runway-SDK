...
public abstract class SelectableSQLMoment extends SelectableSQLPrimitive implements SelectableMoment
{

  protected SelectableSQLMoment(boolean isAggregate, ValueQuery rootQuery, String attributeName, String sql)
  {
    super(isAggregate, rootQuery, attributeName, sql);
  }

  protected SelectableSQLMoment(boolean isAggregate, ValueQuery rootQuery, String attributeName, String sql, String userDefinedAlias, String userDefinedDisplayLabel)
  {
