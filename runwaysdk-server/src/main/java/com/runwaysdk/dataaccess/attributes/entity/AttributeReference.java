...
public class AttributeReference extends Attribute implements AttributeReferenceIF
{
  ...
  public static void validateReference(String valueToValidate, MdAttributeReferenceDAOIF mdAttributeReference)
  {
    ...
    // if the attribute is configured to reference another BusinessDAO, make sure
    ...
    if (refMdBusinessIF != null)
    {
      ...
      if (doQ.getCount() == 0)
      {
        String errMsg = "Attribute [" + mdAttributeReference.definesAttribute() + "] on type ["
            + mdAttributeReference.definedByClass().definesType() + "] does not reference a valid ["
            + refMdBusinessIF.definesType() + "]";
    ...
    else if (valueToValidate.trim().equals(""))
    {
      ...
      String errMsg = "Attribute [" + mdAttributeReference.getDisplayLabel(CommonProperties.getDefaultLocale()) + "] on type ["
          + definingMdClassIF.definesType() + "] is a reference but "
          + "is not configured to reference anything. It cannot contain a value.";
