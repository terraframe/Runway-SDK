...
@com.runwaysdk.business.ClassSignature(hash = 907349085)
public abstract class MdMobileCommentCommentTextDTOBase extends com.runwaysdk.business.LocalStructDTO
{
  ...
  private static final long serialVersionUID = 907349085;
  ...
  */
  protected MdMobileCommentCommentTextDTOBase(com.runwaysdk.business.LocalStructDTO structDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  {
    return (com.runwaysdk.system.metadata.MdMobileCommentCommentTextQueryDTO) clientRequest.getAllInstances(com.runwaysdk.system.metadata.MdMobileCommentCommentTextDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
