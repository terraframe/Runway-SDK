...
public class LeftJoinGt extends LeftJoin
{
   ...
   */
  protected LeftJoinGt(String columnName1, String tableName1, String tableAlias1, String columnName2, String tableName2, String tableAlias2)
  {
   ...
   */
  protected LeftJoinGt(Selectable selectable1, Selectable... selectableArray2)
  {
   ...
   * @param selectable2
   */
  protected LeftJoinGt(Selectable selectable1, Selectable selectable2)
  {
