...
public interface MdWebAttributeInfo extends MdWebFieldInfo
{
  public static final String CLASS                 = Constants.METADATA_PACKAGE + ".MdWebAttribute";
  ...
  public static final String DEFINING_ATTRIBUTE    = "definingAttribute";
