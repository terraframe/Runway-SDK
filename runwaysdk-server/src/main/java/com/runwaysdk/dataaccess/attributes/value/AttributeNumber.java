...
public abstract class AttributeNumber extends Attribute implements AttributeNumericalIF
{
   ...
   * 
   */
  private static final long serialVersionUID = -2559729390800341604L;
   ...
   */
  protected AttributeNumber(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
