...
public class SystemAttributeProblem extends AttributeProblem
{
  /**
  ...
  {
    return ServerExceptionMessageLocalizer.systemAttributeProblem(this.getLocale(), this.getAttributeDisplayLabel());
  }
}
