...
public class MdAttributeFloat_Q extends MdAttributeDec_Q implements MdAttributeFloatDAOIF
{
  /**
   *
   */
  private static final long serialVersionUID = 7216628257339644841L;
   ...
   */
  public MdAttributeFloat_Q(MdAttributeConcreteDAOIF mdAttributeIF)
  {
    super(mdAttributeIF);
  }
