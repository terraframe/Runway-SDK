...
public abstract class OrientDBDDLAction implements GraphDDLCommandAction
{
  ...
  public OrientDBRequest getGraphRequest()
  {
    return (OrientDBRequest) graphRequest;
  }

  public OrientDBRequest getDdlGraphDBRequest()
  {
    return (OrientDBRequest) ddlGraphDBRequest;
  }
