...
public class JSONProblemExceptionDTO extends JSONExceptionDTO
{  
  /**
   * 
   */
  private static final long serialVersionUID = -257006379275078924L;

  public JSONProblemExceptionDTO(ProblemExceptionDTO e)
  {
    super();

    ProblemExceptionDTOToJSON converter = new ProblemExceptionDTOToJSON(e);
