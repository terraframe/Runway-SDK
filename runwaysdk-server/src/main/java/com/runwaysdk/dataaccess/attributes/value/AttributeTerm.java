...
public class AttributeTerm extends AttributeReference implements AttributeTermIF
{
   ...
   * 
   */
  private static final long serialVersionUID = 1751614454866223827L;
   ...
   */
  protected AttributeTerm(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
   ...
   *
   * @return MdAttributeTermDAOIF that defines the this attribute
   */
  ...
  {
    MdAttributeTermDAOIF mdAttribute = this.getMdAttribute();

    return com.runwaysdk.dataaccess.attributes.entity.AttributeTerm.dereference(this.getValue(), mdAttribute);
  }
