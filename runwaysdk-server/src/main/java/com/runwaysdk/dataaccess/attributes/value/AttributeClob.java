...
public class AttributeClob extends AttributeChar
{
   ...
   *
   */
  private static final long serialVersionUID = 791402011450193706L;
   ...
   */
  protected AttributeClob(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
    super(name, value, definingEntityType, mdAttributeIF, entityMdAttributeIFset);
  }

  /**
   * Returns the {@link MdAttributeClobDAOIF} that defines the this attribute.
   *
   * <br>
   ...
   */
  public MdAttributeClobDAOIF getMdAttribute()
  {
    return (MdAttributeClobDAOIF)super.getMdAttribute();
  }
}
