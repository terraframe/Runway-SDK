...
public class MdAttributeLong_SQL extends MdAttributeInt_SQL implements MdAttributeLongDAOIF
{

  /**
   *
   */
  private static final long serialVersionUID = -6010067160726332675L;
   ...
   * @param displayLabel
   */
  public MdAttributeLong_SQL(String attributeName, String displayLabel)
  {
