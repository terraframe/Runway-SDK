...
public class WebMultipleTerm extends WebAttribute
{
  public WebMultipleTerm(WebMultipleTermMd fMd)
  {
    super(fMd);
  }
  ...
  @Override
  public WebMultipleTermMd getFieldMd()
  {
    return (WebMultipleTermMd) super.getFieldMd();
  }
}
