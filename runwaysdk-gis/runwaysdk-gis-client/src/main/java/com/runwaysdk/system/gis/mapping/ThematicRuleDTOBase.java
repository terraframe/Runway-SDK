...
@com.runwaysdk.business.ClassSignature(hash = 1188944462)
public abstract class ThematicRuleDTOBase extends com.runwaysdk.business.BusinessDTO
{
  public final static String CLASS = "com.runwaysdk.system.gis.mapping.ThematicRule";
  private static final long serialVersionUID = 1188944462;
  
  protected ThematicRuleDTOBase(com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
    super(clientRequest);
  }
  ...
  */
  protected ThematicRuleDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  public final static java.lang.String RULESTYLE = "ruleStyle";
  ...
  public com.runwaysdk.system.gis.mapping.LayerStyleDTO getRuleStyle()
  {
    if(getValue(RULESTYLE) == null || getValue(RULESTYLE).trim().equals(""))
    {
      return null;
    }
    else
    {
      return com.runwaysdk.system.gis.mapping.LayerStyleDTO.get(getRequest(), getValue(RULESTYLE));
    }
  }
  
  public String getRuleStyleId()
  {
    return getValue(RULESTYLE);
  }
  
  public void setRuleStyle(com.runwaysdk.system.gis.mapping.LayerStyleDTO value)
  {
    if(value == null)
    {
      setValue(RULESTYLE, "");
  ...
  public boolean isRuleStyleWritable()
  {
    return isWritable(RULESTYLE);
  }
  
  public boolean isRuleStyleReadable()
  {
    return isReadable(RULESTYLE);
  }
  
  public boolean isRuleStyleModified()
  {
    return isModified(RULESTYLE);
  }
  
  public final com.runwaysdk.transport.metadata.AttributeReferenceMdDTO getRuleStyleMd()
  {
    return (com.runwaysdk.transport.metadata.AttributeReferenceMdDTO) getAttributeDTO(RULESTYLE).getAttributeMdDTO();
  }
  ...
  {
    return (com.runwaysdk.system.gis.mapping.ThematicRuleQueryDTO) clientRequest.getAllInstances(com.runwaysdk.system.gis.mapping.ThematicRuleDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
