...
@com.runwaysdk.business.ClassSignature(hash = -531906261)
public abstract class EnumerationAttributeItemDTOBase extends com.runwaysdk.system.metadata.MetadataRelationshipDTO
{
  ...
  */
  protected EnumerationAttributeItemDTOBase(com.runwaysdk.business.RelationshipDTO relationshipDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  {
    return (com.runwaysdk.system.metadata.EnumerationAttributeItemQueryDTO) clientRequest.getAllInstances(com.runwaysdk.system.metadata.EnumerationAttributeItemDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
