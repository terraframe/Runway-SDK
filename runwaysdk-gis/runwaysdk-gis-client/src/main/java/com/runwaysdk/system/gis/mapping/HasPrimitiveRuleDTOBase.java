...
@com.runwaysdk.business.ClassSignature(hash = -763584412)
public abstract class HasPrimitiveRuleDTOBase extends com.runwaysdk.business.RelationshipDTO
{
  ...
  */
  protected HasPrimitiveRuleDTOBase(com.runwaysdk.business.RelationshipDTO relationshipDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  {
    return (com.runwaysdk.system.gis.mapping.HasPrimitiveRuleQueryDTO) clientRequest.getAllInstances(com.runwaysdk.system.gis.mapping.HasPrimitiveRuleDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
