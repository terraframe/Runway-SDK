...
public java.util.List<? extends com.runwaysdk.system.ControllerActionDTO> getResultSet()
{
  return (java.util.List<? extends com.runwaysdk.system.ControllerActionDTO>)super.getResultSet();
}
}
