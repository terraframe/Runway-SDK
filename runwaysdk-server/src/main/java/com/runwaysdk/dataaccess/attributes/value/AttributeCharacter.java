...
public class AttributeCharacter extends AttributeChar
{
   ...
   *
   */
  private static final long serialVersionUID = 142325493320426155L;
   ...
   */
  protected AttributeCharacter(String name, String value, String definingEntityType, MdAttributeConcreteDAOIF mdAttributeIF, Set<MdAttributeConcreteDAOIF> entityMdAttributeIFset)
  {
    super(name, value, definingEntityType, mdAttributeIF, entityMdAttributeIFset);
  }

  /**
   * Returns the {@link MdAttributeCharacterDAOIF} that defines the this attribute.
   *
   * <br>
