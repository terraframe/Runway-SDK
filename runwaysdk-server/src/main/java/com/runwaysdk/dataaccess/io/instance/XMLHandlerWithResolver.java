...
public abstract class XMLHandlerWithResolver extends XMLHandler
{
  ...
  public XMLHandlerWithResolver(File file, String schemaLocation, IConflictResolver resolver) throws SAXException
  {
  ...
  public XMLHandlerWithResolver(String source, String schemaLocation, IConflictResolver resolver) throws SAXException
  {
