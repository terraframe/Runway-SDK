...
/**
 * A common util package for MdAttributeDateTime objects
 * @author jsmethie
 *
 */
public class MdAttributeDateTimeUtil
{
  /**
  ...
  public static java.util.Date getTypeSafeValue(String toParse)
  {
    ...
    {
      return new java.text.SimpleDateFormat(Constants.DATETIME_FORMAT).parse(toParse, new java.text.ParsePosition(0));
    }
  }
  ...
  public static String getTypeUnsafeValue(Date date)
  {
    ...
    {
      SimpleDateFormat format = new java.text.SimpleDateFormat(Constants.DATETIME_FORMAT);
