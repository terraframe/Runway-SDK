...
public class WebReference extends WebAttribute
{

  public WebReference(WebReferenceMd fieldMd)
  {
    super(fieldMd);
  }
  ...
  @Override
  public WebReferenceMd getFieldMd()
  {
    return (WebReferenceMd) super.getFieldMd();
  }
